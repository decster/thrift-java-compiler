...
public class NestedMixedx2 implements org.apache.thrift.TBase<NestedMixedx2, NestedMixedx2._Fields>, java.io.Serializable, Cloneable, Comparable<NestedMixedx2> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<java.util.Set<java.lang.Integer>> int_set_list; // required
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> map_int_strset; // required
  private @org.apache.thrift.annotation.Nullable java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> map_int_strset_list; // required
  ...
  public NestedMixedx2(NestedMixedx2 other) {
    ...
    if (other.isSetMapIntStrsetList()) {
  ...
  public int getIntSetListSize() {
    return (this.int_set_list == null) ? 0 : this.int_set_list.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.Set<java.lang.Integer>> getIntSetListIterator() {
    return (this.int_set_list == null) ? null : this.int_set_list.iterator();
  }

  public void addToIntSetList(java.util.Set<java.lang.Integer> elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.Set<java.lang.Integer>> getIntSetList() {
    return this.int_set_list;
  }

  public void setIntSetList(@org.apache.thrift.annotation.Nullable java.util.List<java.util.Set<java.lang.Integer>> int_set_list) {
    this.int_set_list = int_set_list;
  }

  public void unsetIntSetList() {
    this.int_set_list = null;
  }

  /** Returns true if field int_set_list is set (has been assigned a value) and false otherwise */
  public boolean isSetIntSetList() {
    return this.int_set_list != null;
  }

  public void setIntSetListIsSet(boolean value) {
    if (!value) {
      this.int_set_list = null;
    }
  }

  public int getMapIntStrsetSize() {
    return (this.map_int_strset == null) ? 0 : this.map_int_strset.size();
  }

  public void putToMapIntStrset(int key, java.util.Set<java.lang.String> val) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> getMapIntStrset() {
    return this.map_int_strset;
  }

  public void setMapIntStrset(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> map_int_strset) {
    this.map_int_strset = map_int_strset;
  }

  public void unsetMapIntStrset() {
    this.map_int_strset = null;
  }

  /** Returns true if field map_int_strset is set (has been assigned a value) and false otherwise */
  public boolean isSetMapIntStrset() {
    return this.map_int_strset != null;
  }

  public void setMapIntStrsetIsSet(boolean value) {
    if (!value) {
      this.map_int_strset = null;
    }
  }

  public int getMapIntStrsetListSize() {
    return (this.map_int_strset_list == null) ? 0 : this.map_int_strset_list.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> getMapIntStrsetListIterator() {
    return (this.map_int_strset_list == null) ? null : this.map_int_strset_list.iterator();
  }

  public void addToMapIntStrsetList(java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> getMapIntStrsetList() {
    return this.map_int_strset_list;
  }

  public void setMapIntStrsetList(@org.apache.thrift.annotation.Nullable java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>> map_int_strset_list) {
    this.map_int_strset_list = map_int_strset_list;
  }

  public void unsetMapIntStrsetList() {
    this.map_int_strset_list = null;
  }

  /** Returns true if field map_int_strset_list is set (has been assigned a value) and false otherwise */
  public boolean isSetMapIntStrsetList() {
    return this.map_int_strset_list != null;
  }

  public void setMapIntStrsetListIsSet(boolean value) {
    if (!value) {
      this.map_int_strset_list = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case INT_SET_LIST:
      if (value == null) {
        ...
        setIntSetList((java.util.List<java.util.Set<java.lang.Integer>>)value);
      }
      break;
    ...
    case MAP_INT_STRSET:
      if (value == null) {
        ...
        setMapIntStrset((java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>)value);
      }
      break;

    case MAP_INT_STRSET_LIST:
      if (value == null) {
        unsetMapIntStrsetList();
      } else {
        setMapIntStrsetList((java.util.List<java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>>>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    switch (field) {
    case INT_SET_LIST:
      return getIntSetList();

    case MAP_INT_STRSET:
      return getMapIntStrset();

    case MAP_INT_STRSET_LIST:
      return getMapIntStrsetList();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case INT_SET_LIST:
      return isSetIntSetList();
    case MAP_INT_STRSET:
      return isSetMapIntStrset();
    case MAP_INT_STRSET_LIST:
      return isSetMapIntStrsetList();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(NestedMixedx2 that) {
    ...
    boolean this_present_int_set_list = true && this.isSetIntSetList();
    boolean that_present_int_set_list = true && that.isSetIntSetList();
    ...
    boolean this_present_map_int_strset = true && this.isSetMapIntStrset();
    boolean that_present_map_int_strset = true && that.isSetMapIntStrset();
    ...
    boolean this_present_map_int_strset_list = true && this.isSetMapIntStrsetList();
    boolean that_present_map_int_strset_list = true && that.isSetMapIntStrsetList();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIntSetList()) ? 131071 : 524287);
    if (isSetIntSetList())
      hashCode = hashCode * 8191 + int_set_list.hashCode();

    hashCode = hashCode * 8191 + ((isSetMapIntStrset()) ? 131071 : 524287);
    if (isSetMapIntStrset())
      hashCode = hashCode * 8191 + map_int_strset.hashCode();

    hashCode = hashCode * 8191 + ((isSetMapIntStrsetList()) ? 131071 : 524287);
    if (isSetMapIntStrsetList())
  ...
  public int compareTo(NestedMixedx2 other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIntSetList(), other.isSetIntSetList());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMapIntStrset(), other.isSetMapIntStrset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMapIntStrset()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMapIntStrsetList(), other.isSetMapIntStrsetList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMapIntStrsetList()) {
        ...
        switch (schemeField.id) {
          case 1: // INT_SET_LIST
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              ...
              struct.setIntSetListIsSet(true);
            } else { 
          ...
          case 2: // MAP_INT_STRSET
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              ...
              struct.setMapIntStrsetIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 3: // MAP_INT_STRSET_LIST
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              ...
              struct.setMapIntStrsetListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
  ...
  private static class NestedMixedx2TupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedMixedx2> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, NestedMixedx2 struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIntSetList()) {
        optionals.set(0);
      }
      if (struct.isSetMapIntStrset()) {
        optionals.set(1);
      }
      if (struct.isSetMapIntStrsetList()) {
        optionals.set(2);
      }
