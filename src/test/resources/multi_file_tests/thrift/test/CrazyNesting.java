...
public class CrazyNesting implements org.apache.thrift.TBase<CrazyNesting, CrazyNesting._Fields>, java.io.Serializable, Cloneable, Comparable<CrazyNesting> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.UUID uuid_field; // required
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.UUID getUuid_field() {
    return this.uuid_field;
  }

  public CrazyNesting setUuid_field(@org.apache.thrift.annotation.Nullable java.util.UUID uuid_field) {
    this.uuid_field = uuid_field;
    return this;
  }

  public void unsetUuid_field() {
    this.uuid_field = null;
  }

  /** Returns true if field uuid_field is set (has been assigned a value) and false otherwise */
  public boolean isSetUuid_field() {
    return this.uuid_field != null;
  }

  public void setUuid_fieldIsSet(boolean value) {
    if (!value) {
      this.uuid_field = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case UUID_FIELD:
      if (value == null) {
        ...
        setUuid_field((java.util.UUID)value);
      }
      break;
  ...
  public boolean equals(CrazyNesting that) {
    ...
    boolean this_present_uuid_field = true && this.isSetUuid_field();
    boolean that_present_uuid_field = true && that.isSetUuid_field();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetUuid_field()) ? 131071 : 524287);
    if (isSetUuid_field())
  ...
  public int compareTo(CrazyNesting other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUuid_field(), other.isSetUuid_field());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUuid_field()) {
        ...
        switch (schemeField.id) {
          ...
          case 5: // UUID_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.UUID) {
              ...
              struct.setUuid_fieldIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
