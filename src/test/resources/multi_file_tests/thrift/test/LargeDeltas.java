...
public class LargeDeltas implements org.apache.thrift.TBase<LargeDeltas, LargeDeltas._Fields>, java.io.Serializable, Cloneable, Comparable<LargeDeltas> {
  ...
  private @org.apache.thrift.annotation.Nullable Bools b1; // required
  private @org.apache.thrift.annotation.Nullable Bools b10; // required
  private @org.apache.thrift.annotation.Nullable Bools b100; // required
  private boolean check_true; // required
  private @org.apache.thrift.annotation.Nullable Bools b1000; // required
  private boolean check_false; // required
  private @org.apache.thrift.annotation.Nullable VersioningTestV2 vertwo2000; // required
  private @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.String> a_set2500; // required
  private @org.apache.thrift.annotation.Nullable VersioningTestV2 vertwo3000; // required
  private @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> big_numbers; // required
    ...
    java.util.List<java.lang.Integer> big_numbers)
  {
    ...
    setCheckTrueIsSet(true);
    this.b1000 = b1000;
    this.check_false = check_false;
    setCheckFalseIsSet(true);
  ...
  public void clear() {
    ...
    this.b10 = null;
    this.b100 = null;
    setCheckTrueIsSet(false);
    this.check_true = false;
    this.b1000 = null;
    setCheckFalseIsSet(false);
  ...
  public void setB1(@org.apache.thrift.annotation.Nullable Bools b1) {
    this.b1 = b1;
  }
  ...
  public void setB10(@org.apache.thrift.annotation.Nullable Bools b10) {
    this.b10 = b10;
  }
  ...
  public void setB100(@org.apache.thrift.annotation.Nullable Bools b100) {
    this.b100 = b100;
  }
  ...
  public void setCheckTrue(boolean check_true) {
    this.check_true = check_true;
    setCheckTrueIsSet(true);
  }

  public void unsetCheckTrue() {
  ...
  public void setB1000(@org.apache.thrift.annotation.Nullable Bools b1000) {
    this.b1000 = b1000;
  }
  ...
  public void setCheckFalse(boolean check_false) {
    this.check_false = check_false;
    setCheckFalseIsSet(true);
  }

  public void unsetCheckFalse() {
  ...
  public void setVertwo2000(@org.apache.thrift.annotation.Nullable VersioningTestV2 vertwo2000) {
    this.vertwo2000 = vertwo2000;
  }
  ...
  public int getASet2500Size() {
    return (this.a_set2500 == null) ? 0 : this.a_set2500.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getASet2500Iterator() {
    return (this.a_set2500 == null) ? null : this.a_set2500.iterator();
  }

  public void addToASet2500(java.lang.String elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Set<java.lang.String> getASet2500() {
    return this.a_set2500;
  }

  public void setASet2500(@org.apache.thrift.annotation.Nullable java.util.Set<java.lang.String> a_set2500) {
    this.a_set2500 = a_set2500;
  }

  public void unsetASet2500() {
    this.a_set2500 = null;
  }

  /** Returns true if field a_set2500 is set (has been assigned a value) and false otherwise */
  public boolean isSetASet2500() {
    return this.a_set2500 != null;
  }

  public void setASet2500IsSet(boolean value) {
    if (!value) {
      this.a_set2500 = null;
    }
  }
  ...
  public void setVertwo3000(@org.apache.thrift.annotation.Nullable VersioningTestV2 vertwo3000) {
    this.vertwo3000 = vertwo3000;
  }
  ...
  public int getBigNumbersSize() {
    return (this.big_numbers == null) ? 0 : this.big_numbers.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Integer> getBigNumbersIterator() {
    return (this.big_numbers == null) ? null : this.big_numbers.iterator();
  }

  public void addToBigNumbers(int elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Integer> getBigNumbers() {
    return this.big_numbers;
  }

  public void setBigNumbers(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> big_numbers) {
    this.big_numbers = big_numbers;
  }

  public void unsetBigNumbers() {
    this.big_numbers = null;
  }

  /** Returns true if field big_numbers is set (has been assigned a value) and false otherwise */
  public boolean isSetBigNumbers() {
    return this.big_numbers != null;
  }

  public void setBigNumbersIsSet(boolean value) {
    if (!value) {
      this.big_numbers = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CHECK_TRUE:
      if (value == null) {
        ...
        setCheckTrue((java.lang.Boolean)value);
      }
      break;
    ...
    case CHECK_FALSE:
      if (value == null) {
        ...
        setCheckFalse((java.lang.Boolean)value);
      }
      break;
    ...
    case A_SET2500:
      if (value == null) {
        ...
        setASet2500((java.util.Set<java.lang.String>)value);
      }
      break;
    ...
    case BIG_NUMBERS:
      if (value == null) {
        ...
        setBigNumbers((java.util.List<java.lang.Integer>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case B100:
      return isSetB100();
    case CHECK_TRUE:
      return isSetCheckTrue();
    case B1000:
      return isSetB1000();
    case CHECK_FALSE:
      return isSetCheckFalse();
    case VERTWO2000:
      return isSetVertwo2000();
    case A_SET2500:
      return isSetASet2500();
    case VERTWO3000:
      return isSetVertwo3000();
    case BIG_NUMBERS:
      return isSetBigNumbers();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(LargeDeltas that) {
    ...
    boolean this_present_a_set2500 = true && this.isSetASet2500();
    boolean that_present_a_set2500 = true && that.isSetASet2500();
    ...
    boolean this_present_big_numbers = true && this.isSetBigNumbers();
    boolean that_present_big_numbers = true && that.isSetBigNumbers();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetASet2500()) ? 131071 : 524287);
    if (isSetASet2500())
    ...
    hashCode = hashCode * 8191 + ((isSetBigNumbers()) ? 131071 : 524287);
    if (isSetBigNumbers())
  ...
  public int compareTo(LargeDeltas other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCheckTrue(), other.isSetCheckTrue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCheckTrue()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCheckFalse(), other.isSetCheckFalse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCheckFalse()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetASet2500(), other.isSetASet2500());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetASet2500()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBigNumbers(), other.isSetBigNumbers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBigNumbers()) {
        ...
        switch (schemeField.id) {
          ...
          case 1500: // CHECK_FALSE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              ...
              struct.setCheckFalseIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          ...
          case 4000: // BIG_NUMBERS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              ...
              struct.setBigNumbersIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LargeDeltas struct) throws org.apache.thrift.TException {
      ...
      if (struct.a_set2500 != null) {
        oprot.writeFieldBegin(A_SET2500_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter156 : struct.a_set2500)
          {
      ...
      if (struct.big_numbers != null) {
        oprot.writeFieldBegin(BIG_NUMBERS_FIELD_DESC);
        {
          ...
          for (int _iter157 : struct.big_numbers)
          {
  ...
  private static class LargeDeltasTupleScheme extends org.apache.thrift.scheme.TupleScheme<LargeDeltas> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LargeDeltas struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCheckTrue()) {
        optionals.set(3);
      }
      if (struct.isSetB1000()) {
        optionals.set(4);
      }
      if (struct.isSetCheckFalse()) {
        optionals.set(5);
      }
      if (struct.isSetVertwo2000()) {
        optionals.set(6);
      }
      if (struct.isSetASet2500()) {
        optionals.set(7);
      }
      if (struct.isSetVertwo3000()) {
        optionals.set(8);
      }
      if (struct.isSetBigNumbers()) {
        optionals.set(9);
      }
      ...
      if (struct.isSetASet2500()) {
        {
          ...
          for (java.lang.String _iter158 : struct.a_set2500)
          {
      ...
      if (struct.isSetBigNumbers()) {
        {
          ...
          for (int _iter159 : struct.big_numbers)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LargeDeltas struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TSet _set160 = iprot.readSetBegin(org.apache.thrift.protocol.TType.STRING);
          struct.a_set2500 = new java.util.HashSet<java.lang.String>(2*_set160.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem161;
          for (int _i162 = 0; _i162 < _set160.size; ++_i162)
          {
            _elem161 = iprot.readString();
            struct.a_set2500.add(_elem161);
          }
        }
        struct.setASet2500IsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.big_numbers = new java.util.ArrayList<java.lang.Integer>(_list163.size);
          int _elem164;
          for (int _i165 = 0; _i165 < _list163.size; ++_i165)
          {
            _elem164 = iprot.readI32();
            struct.big_numbers.add(_elem164);
          }
        }
        struct.setBigNumbersIsSet(true);
      }
