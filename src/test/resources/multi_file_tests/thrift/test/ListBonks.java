...
public class ListBonks implements org.apache.thrift.TBase<ListBonks, ListBonks._Fields>, java.io.Serializable, Cloneable, Comparable<ListBonks> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<Bonk> bonk; // required
  ...
  public void setBonk(@org.apache.thrift.annotation.Nullable java.util.List<Bonk> bonk) {
    this.bonk = bonk;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bonk = new java.util.ArrayList<Bonk>(_list266.size);
                @org.apache.thrift.annotation.Nullable Bonk _elem267;
                for (int _i268 = 0; _i268 < _list266.size; ++_i268)
                {
                  _elem267 = new Bonk();
                  _elem267.read(iprot);
                  struct.bonk.add(_elem267);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.bonk = new java.util.ArrayList<Bonk>(_list271.size);
          @org.apache.thrift.annotation.Nullable Bonk _elem272;
          for (int _i273 = 0; _i273 < _list271.size; ++_i273)
          {
            _elem272 = new Bonk();
            _elem272.read(iprot);
            struct.bonk.add(_elem272);
          }
        }
        struct.setBonkIsSet(true);
      }
