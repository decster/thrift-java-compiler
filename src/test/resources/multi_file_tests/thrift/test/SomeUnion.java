...
public class SomeUnion extends org.apache.thrift.TUnion<SomeUnion, SomeUnion._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField BINARY_THING_FIELD_DESC = new org.apache.thrift.protocol.TField("binary_thing", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BINARY_THING((short)10, "binary_thing");
  ...
  static {
    ...
    tmpMap.put(_Fields.BINARY_THING, new org.apache.thrift.meta_data.FieldMetaData("binary_thing", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public SomeUnion() {
    super(_Fields.STRING_THING, "Hello, world!");
  }
  ...
  public static SomeUnion xtruct_thing(Xtruct3 value) {
    SomeUnion x = new SomeUnion();
    x.setXtructThing(value);
    return x;
  }

  public static SomeUnion insanity_thing(Insanity value) {
    SomeUnion x = new SomeUnion();
    x.setInsanityThing(value);
    return x;
  }

  public static SomeUnion binary_thing(java.nio.ByteBuffer value) {
    SomeUnion x = new SomeUnion();
    x.setBinaryThing(value);
    return x;
  }

  public static SomeUnion binary_thing(byte[] value) {
    SomeUnion x = new SomeUnion();
    x.setBinaryThing  (java.nio.ByteBuffer.wrap(value));
    return x;
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case BINARY_THING:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type java.nio.ByteBuffer for field 'binary_thing', but got " + value.getClass().getSimpleName());
      default:
  ...
  protected java.lang.Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        case MAP_THING:
          if (field.type == MAP_THING_FIELD_DESC.type) {
            java.util.Map<Numberz,java.lang.Long> map_thing;
            {
              ...
              {
                _key89 = thrift.test.Numberz.findByValue(iprot.readI32());
        ...
        case BINARY_THING:
          if (field.type == BINARY_THING_FIELD_DESC.type) {
            java.nio.ByteBuffer binary_thing;
            binary_thing = iprot.readBinary();
            return binary_thing;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case INSANITY_THING:
        ...
        return;
      case BINARY_THING:
        java.nio.ByteBuffer binary_thing = (java.nio.ByteBuffer)value_;
        oprot.writeBinary(binary_thing);
        return;
      default:
      ...
      switch (setField) {
        case MAP_THING:
          java.util.Map<Numberz,java.lang.Long> map_thing;
          {
            ...
            {
              _key94 = thrift.test.Numberz.findByValue(iprot.readI32());
  ...
  protected org.apache.thrift.protocol.TField getFieldDesc(_Fields setField) {
    switch (setField) {
      ...
      case BINARY_THING:
        return BINARY_THING_FIELD_DESC;
      default:
        throw new java.lang.IllegalArgumentException("Unknown field id " + setField);
    }
  }
  ...
  public java.util.Map<Numberz,java.lang.Long> getMapThing() {
  ...
  public void setMapThing(java.util.Map<Numberz,java.lang.Long> value) {
    setField_ = _Fields.MAP_THING;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.MAP_THING");
  }

  public java.lang.String getStringThing() {
  ...
  public void setStringThing(java.lang.String value) {
  ...
  public void setI32Thing(int value) {
    setField_ = _Fields.I32_THING;
    value_ = value;
  }

  @Deprecated
  public Xtruct3 getXtructThing() {
  ...
  public void setInsanityThing(Insanity value) {
    setField_ = _Fields.INSANITY_THING;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.INSANITY_THING");
  }

  @Deprecated
  public byte[] getBinaryThing() {
    setBinaryThing(org.apache.thrift.TBaseHelper.rightSize(bufferForBinaryThing()));
    java.nio.ByteBuffer b = bufferForBinaryThing();
    return b == null ? null : b.array();
  }

  public java.nio.ByteBuffer bufferForBinaryThing() {
    if (getSetField() == _Fields.BINARY_THING) {
      return (java.nio.ByteBuffer)getFieldValue();
    } else {
      throw new java.lang.RuntimeException("Cannot get field 'binary_thing' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  @Deprecated
  public void setBinaryThing(byte[] value) {
    setBinaryThing  (java.nio.ByteBuffer.wrap(value));
  }

  @Deprecated
  public void setBinaryThing(java.nio.ByteBuffer value) {
    setField_ = _Fields.BINARY_THING;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.BINARY_THING");
  }

  public boolean isSetMapThing() {
    return setField_ == _Fields.MAP_THING;
  }


  public boolean isSetStringThing() {
  ...
  public boolean isSetXtructThing() {
    return setField_ == _Fields.XTRUCT_THING;
  }


  public boolean isSetInsanityThing() {
    return setField_ == _Fields.INSANITY_THING;
  }


  public boolean isSetBinaryThing() {
    return setField_ == _Fields.BINARY_THING;
  }
