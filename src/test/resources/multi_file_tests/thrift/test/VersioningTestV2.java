...
public class VersioningTestV2 implements org.apache.thrift.TBase<VersioningTestV2, VersioningTestV2._Fields>, java.io.Serializable, Cloneable, Comparable<VersioningTestV2> {
  ...
  private @org.apache.thrift.annotation.Nullable Bonk newstruct; // required
  private @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> newlist; // required
  private @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> newset; // required
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.lang.Integer> newmap; // required
  private @org.apache.thrift.annotation.Nullable java.lang.String newstring; // required
  ...
  public void clear() {
    ...
    this.newmap = null;
    this.newstring = null;
    setEndInBothIsSet(false);
    this.end_in_both = 0;
  }

  public int getBeginInBoth() {
    return this.begin_in_both;
  }

  public void setBeginInBoth(int begin_in_both) {
    this.begin_in_both = begin_in_both;
    setBeginInBothIsSet(true);
  }

  public void unsetBeginInBoth() {
  ...
  public void setNewstruct(@org.apache.thrift.annotation.Nullable Bonk newstruct) {
    this.newstruct = newstruct;
  }
  ...
  public void setNewlist(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> newlist) {
    this.newlist = newlist;
  }
  ...
  public void setNewset(@org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> newset) {
    this.newset = newset;
  }
  ...
  public void setNewmap(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.lang.Integer> newmap) {
    this.newmap = newmap;
  }
  ...
  public void setNewstring(@org.apache.thrift.annotation.Nullable java.lang.String newstring) {
    this.newstring = newstring;
  }
  ...
  public int getEndInBoth() {
    return this.end_in_both;
  }

  public void setEndInBoth(int end_in_both) {
    this.end_in_both = end_in_both;
    setEndInBothIsSet(true);
  }

  public void unsetEndInBoth() {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BEGIN_IN_BOTH:
      if (value == null) {
        ...
        setBeginInBoth((java.lang.Integer)value);
      }
      break;
    ...
    case END_IN_BOTH:
      if (value == null) {
        ...
        setEndInBoth((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(VersioningTestV2 other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBeginInBoth(), other.isSetBeginInBoth());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEndInBoth(), other.isSetEndInBoth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEndInBoth()) {
        ...
        switch (schemeField.id) {
          case 1: // BEGIN_IN_BOTH
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.setBeginInBothIsSet(true);
            } else { 
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.newlist = new java.util.ArrayList<java.lang.Integer>(_list98.size);
                int _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = iprot.readI32();
                  struct.newlist.add(_elem99);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.newset = new java.util.HashSet<java.lang.Integer>(2*_set101.size);
                int _elem102;
                for (int _i103 = 0; _i103 < _set101.size; ++_i103)
                {
                  _elem102 = iprot.readI32();
                  struct.newset.add(_elem102);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.newmap = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map104.size);
                int _key105;
                int _val106;
                for (int _i107 = 0; _i107 < _map104.size; ++_i107)
                {
                  ...
                  struct.newmap.put(_key105, _val106);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, VersioningTestV2 struct) throws org.apache.thrift.TException {
      ...
      if (struct.newlist != null) {
        oprot.writeFieldBegin(NEWLIST_FIELD_DESC);
        {
          ...
          for (int _iter108 : struct.newlist)
          {
      ...
      if (struct.newset != null) {
        oprot.writeFieldBegin(NEWSET_FIELD_DESC);
        {
          ...
          for (int _iter109 : struct.newset)
          {
      ...
      if (struct.newmap != null) {
        oprot.writeFieldBegin(NEWMAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter110 : struct.newmap.entrySet())
          {
  ...
  private static class VersioningTestV2TupleScheme extends org.apache.thrift.scheme.TupleScheme<VersioningTestV2> {
      ...
      if (struct.isSetNewlist()) {
        {
          ...
          for (int _iter111 : struct.newlist)
          {
      ...
      if (struct.isSetNewset()) {
        {
          ...
          for (int _iter112 : struct.newset)
          {
      ...
      if (struct.isSetNewmap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter113 : struct.newmap.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, VersioningTestV2 struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list114 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.newlist = new java.util.ArrayList<java.lang.Integer>(_list114.size);
          int _elem115;
          for (int _i116 = 0; _i116 < _list114.size; ++_i116)
          {
            _elem115 = iprot.readI32();
            struct.newlist.add(_elem115);
          }
        }
        struct.setNewlistIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.newset = new java.util.HashSet<java.lang.Integer>(2*_set117.size);
          int _elem118;
          for (int _i119 = 0; _i119 < _set117.size; ++_i119)
          {
            _elem118 = iprot.readI32();
            struct.newset.add(_elem118);
          }
        }
        struct.setNewsetIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.newmap = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map120.size);
          int _key121;
          int _val122;
          for (int _i123 = 0; _i123 < _map120.size; ++_i123)
          {
            ...
            struct.newmap.put(_key121, _val122);
          }
        }
        struct.setNewmapIsSet(true);
      }
