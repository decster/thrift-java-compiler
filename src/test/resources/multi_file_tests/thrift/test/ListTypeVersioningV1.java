...
public class ListTypeVersioningV1 implements org.apache.thrift.TBase<ListTypeVersioningV1, ListTypeVersioningV1._Fields>, java.io.Serializable, Cloneable, Comparable<ListTypeVersioningV1> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> myints; // required
  ...
  public void setMyints(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> myints) {
    this.myints = myints;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.myints = new java.util.ArrayList<java.lang.Integer>(_list124.size);
                int _elem125;
                for (int _i126 = 0; _i126 < _list124.size; ++_i126)
                {
                  _elem125 = iprot.readI32();
                  struct.myints.add(_elem125);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListTypeVersioningV1 struct) throws org.apache.thrift.TException {
      ...
      if (struct.myints != null) {
        oprot.writeFieldBegin(MYINTS_FIELD_DESC);
        {
          ...
          for (int _iter127 : struct.myints)
          {
  ...
  private static class ListTypeVersioningV1TupleScheme extends org.apache.thrift.scheme.TupleScheme<ListTypeVersioningV1> {
      ...
      if (struct.isSetMyints()) {
        {
          ...
          for (int _iter128 : struct.myints)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ListTypeVersioningV1 struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list129 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.myints = new java.util.ArrayList<java.lang.Integer>(_list129.size);
          int _elem130;
          for (int _i131 = 0; _i131 < _list129.size; ++_i131)
          {
            _elem130 = iprot.readI32();
            struct.myints.add(_elem130);
          }
        }
        struct.setMyintsIsSet(true);
      }
