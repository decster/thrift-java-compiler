...
public class NestedListsBonk implements org.apache.thrift.TBase<NestedListsBonk, NestedListsBonk._Fields>, java.io.Serializable, Cloneable, Comparable<NestedListsBonk> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.util.List<Bonk>>> bonk; // required
  ...
  public void setBonk(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.util.List<Bonk>>> bonk) {
    this.bonk = bonk;
  }
