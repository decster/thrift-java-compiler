...
public class Bools implements org.apache.thrift.TBase<Bools, Bools._Fields>, java.io.Serializable, Cloneable, Comparable<Bools> {
  ...
  public void setImTrue(boolean im_true) {
    this.im_true = im_true;
    setImTrueIsSet(true);
  }
  ...
  public void setImFalse(boolean im_false) {
    this.im_false = im_false;
    setImFalseIsSet(true);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IM_TRUE:
      if (value == null) {
        ...
        setImTrue((java.lang.Boolean)value);
      }
      break;
    ...
    case IM_FALSE:
      if (value == null) {
        ...
        setImFalse((java.lang.Boolean)value);
      }
      break;
  ...
  public int compareTo(Bools other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetImTrue(), other.isSetImTrue());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetImFalse(), other.isSetImFalse());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetImFalse()) {
