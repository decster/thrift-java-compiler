...
public class ColumnMetaData implements org.apache.thrift.TBase<ColumnMetaData, ColumnMetaData._Fields>, java.io.Serializable, Cloneable, Comparable<ColumnMetaData> {
  ...
  private static final _Fields optionals[] = {_Fields.KEY_VALUE_METADATA,_Fields.INDEX_PAGE_OFFSET,_Fields.DICTIONARY_PAGE_OFFSET,_Fields.STATISTICS,_Fields.ENCODING_STATS,_Fields.BLOOM_FILTER_OFFSET,_Fields.BLOOM_FILTER_LENGTH};
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BLOOM_FILTER_LENGTH:
      if (value == null) {
        ...
        setBloom_filter_length((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(ColumnMetaData that) {
    ...
    boolean this_present_bloom_filter_length = true && this.isSetBloom_filter_length();
    boolean that_present_bloom_filter_length = true && that.isSetBloom_filter_length();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBloom_filter_length()) ? 131071 : 524287);
  ...
  public int compareTo(ColumnMetaData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBloom_filter_length(), other.isSetBloom_filter_length());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBloom_filter_length()) {
