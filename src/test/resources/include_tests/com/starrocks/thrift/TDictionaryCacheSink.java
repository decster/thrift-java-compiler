...
public class TDictionaryCacheSink implements org.apache.thrift.TBase<TDictionaryCacheSink, TDictionaryCacheSink._Fields>, java.io.Serializable, Cloneable, Comparable<TDictionaryCacheSink> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TNetworkAddress> nodes; // optional
  public long dictionary_id; // optional
  public long txn_id; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TOlapTableSchemaParam schema; // optional
  ...
  public TDictionaryCacheSink(TDictionaryCacheSink other) {
    ...
    if (other.isSetNodes()) {
      java.util.List<com.starrocks.thrift.TNetworkAddress> __this__nodes = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>(other.nodes.size());
      for (com.starrocks.thrift.TNetworkAddress other_element : other.nodes) {
        __this__nodes.add(new com.starrocks.thrift.TNetworkAddress(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TNetworkAddress> getNodesIterator() {
    return (this.nodes == null) ? null : this.nodes.iterator();
  }

  public void addToNodes(com.starrocks.thrift.TNetworkAddress elem) {
    if (this.nodes == null) {
      this.nodes = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>();
    }
    this.nodes.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TNetworkAddress> getNodes() {
    return this.nodes;
  }

  public TDictionaryCacheSink setNodes(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TNetworkAddress> nodes) {
    this.nodes = nodes;
    return this;
  }
  ...
  public TDictionaryCacheSink setSchema(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TOlapTableSchemaParam schema) {
    this.schema = schema;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case NODES:
      if (value == null) {
        ...
        setNodes((java.util.List<com.starrocks.thrift.TNetworkAddress>)value);
      }
      break;
    ...
    case DICTIONARY_ID:
      if (value == null) {
        ...
        setDictionary_id((java.lang.Long)value);
      }
      break;
    ...
    case MEMORY_LIMIT:
      if (value == null) {
        ...
        setMemory_limit((java.lang.Long)value);
      }
      break;
  ...
  public int compareTo(TDictionaryCacheSink other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDictionary_id(), other.isSetDictionary_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDictionary_id()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemory_limit(), other.isSetMemory_limit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemory_limit()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDictionaryCacheSink(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>(_list76.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress _elem77;
                for (int _i78 = 0; _i78 < _list76.size; ++_i78)
                {
                  _elem77 = new com.starrocks.thrift.TNetworkAddress();
                  _elem77.read(iprot);
      ...
      if (struct.nodes != null) {
        if (struct.isSetNodes()) {
          oprot.writeFieldBegin(NODES_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TNetworkAddress _iter79 : struct.nodes)
            {
              _iter79.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetNodes()) {
        {
          ...
          for (com.starrocks.thrift.TNetworkAddress _iter80 : struct.nodes)
          {
            _iter80.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nodes = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>(_list81.size);
