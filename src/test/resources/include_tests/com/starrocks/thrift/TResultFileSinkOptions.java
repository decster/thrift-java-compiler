...
public class TResultFileSinkOptions implements org.apache.thrift.TBase<TResultFileSinkOptions, TResultFileSinkOptions._Fields>, java.io.Serializable, Cloneable, Comparable<TResultFileSinkOptions> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TFileFormatType file_format; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String column_separator; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String row_delimiter; // optional
  public long max_file_size_bytes; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TNetworkAddress> broker_addresses; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> file_column_names; // optional
  ...
  public TResultFileSinkOptions(
    ...
    com.starrocks.thrift.TFileFormatType file_format)
  {
    this();
  ...
  public TResultFileSinkOptions(TResultFileSinkOptions other) {
    ...
    if (other.isSetFile_column_names()) {
      java.util.List<java.lang.String> __this__file_column_names = new java.util.ArrayList<java.lang.String>(other.file_column_names);
  ...
  public TResultFileSinkOptions setFile_path(@org.apache.thrift.annotation.Nullable java.lang.String file_path) {
    this.file_path = file_path;
    return this;
  }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TFileFormatType getFile_format() {
   ...
   * @see com.starrocks.thrift.TFileFormatType
   */
  public TResultFileSinkOptions setFile_format(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TFileFormatType file_format) {
    this.file_format = file_format;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getColumn_separator() {
    return this.column_separator;
  }

  public TResultFileSinkOptions setColumn_separator(@org.apache.thrift.annotation.Nullable java.lang.String column_separator) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getRow_delimiter() {
    return this.row_delimiter;
  }

  public TResultFileSinkOptions setRow_delimiter(@org.apache.thrift.annotation.Nullable java.lang.String row_delimiter) {
  ...
  public TResultFileSinkOptions setBroker_addresses(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TNetworkAddress> broker_addresses) {
  ...
  public void putToBroker_properties(java.lang.String key, java.lang.String val) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.lang.String> getBroker_properties() {
    return this.broker_properties;
  }

  public TResultFileSinkOptions setBroker_properties(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> broker_properties) {
  ...
  public TResultFileSinkOptions setHdfs_properties(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.THdfsProperties hdfs_properties) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getFile_column_namesIterator() {
    return (this.file_column_names == null) ? null : this.file_column_names.iterator();
  }

  public void addToFile_column_names(java.lang.String elem) {
    if (this.file_column_names == null) {
      this.file_column_names = new java.util.ArrayList<java.lang.String>();
    }
    this.file_column_names.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.String> getFile_column_names() {
    return this.file_column_names;
  }

  public TResultFileSinkOptions setFile_column_names(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> file_column_names) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FILE_FORMAT:
      if (value == null) {
        ...
        setFile_format((com.starrocks.thrift.TFileFormatType)value);
      }
      break;
    ...
    case COLUMN_SEPARATOR:
      if (value == null) {
        ...
        setColumn_separator((java.lang.String)value);
      }
      break;
    ...
    case ROW_DELIMITER:
      if (value == null) {
        ...
        setRow_delimiter((java.lang.String)value);
      }
      break;
    ...
    case MAX_FILE_SIZE_BYTES:
      if (value == null) {
        ...
        setMax_file_size_bytes((java.lang.Long)value);
      }
      break;
    ...
    case BROKER_PROPERTIES:
      if (value == null) {
        ...
        setBroker_properties((java.util.Map<java.lang.String,java.lang.String>)value);
      }
      break;
    ...
    case FILE_COLUMN_NAMES:
      if (value == null) {
        ...
        setFile_column_names((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(TResultFileSinkOptions other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMax_file_size_bytes(), other.isSetMax_file_size_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMax_file_size_bytes()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBroker_properties(), other.isSetBroker_properties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBroker_properties()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetParquet_options(), other.isSetParquet_options());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParquet_options()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFile_column_names(), other.isSetFile_column_names());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFile_column_names()) {
        ...
        switch (schemeField.id) {
          ...
          case 2: // FILE_FORMAT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.file_format = com.starrocks.thrift.TFileFormatType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.broker_addresses = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>(_list0.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.file_column_names = new java.util.ArrayList<java.lang.String>(_list7.size);
      ...
      if (struct.broker_addresses != null) {
        if (struct.isSetBroker_addresses()) {
          oprot.writeFieldBegin(BROKER_ADDRESSES_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TNetworkAddress _iter10 : struct.broker_addresses)
            {
              _iter10.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.broker_properties != null) {
        if (struct.isSetBroker_properties()) {
          oprot.writeFieldBegin(BROKER_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter11 : struct.broker_properties.entrySet())
            {
      ...
      if (struct.file_column_names != null) {
        if (struct.isSetFile_column_names()) {
          oprot.writeFieldBegin(FILE_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter12 : struct.file_column_names)
            {
      ...
      if (struct.isSetBroker_addresses()) {
        {
          ...
          for (com.starrocks.thrift.TNetworkAddress _iter13 : struct.broker_addresses)
          {
            _iter13.write(oprot);
          }
        }
      ...
      if (struct.isSetBroker_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter14 : struct.broker_properties.entrySet())
          {
      ...
      if (struct.isSetFile_column_names()) {
        {
          ...
          for (java.lang.String _iter15 : struct.file_column_names)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.broker_addresses = new java.util.ArrayList<com.starrocks.thrift.TNetworkAddress>(_list16.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress _elem17;
          for (int _i18 = 0; _i18 < _list16.size; ++_i18)
          {
            _elem17 = new com.starrocks.thrift.TNetworkAddress();
            _elem17.read(iprot);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.broker_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map19.size);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.file_column_names = new java.util.ArrayList<java.lang.String>(_list23.size);
