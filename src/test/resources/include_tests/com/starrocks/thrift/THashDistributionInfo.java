            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.distribution_columns = new java.util.ArrayList<java.lang.String>(_list494.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem495;
                for (int _i496 = 0; _i496 < _list494.size; ++_i496)
                {
                  _elem495 = iprot.readString();
                  struct.distribution_columns.add(_elem495);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.distribution_columns != null) {
        if (struct.isSetDistribution_columns()) {
          oprot.writeFieldBegin(DISTRIBUTION_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter497 : struct.distribution_columns)
            {
      ...
      if (struct.isSetDistribution_columns()) {
        {
          ...
          for (java.lang.String _iter498 : struct.distribution_columns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.distribution_columns = new java.util.ArrayList<java.lang.String>(_list499.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem500;
          for (int _i501 = 0; _i501 < _list499.size; ++_i501)
          {
            _elem500 = iprot.readString();
            struct.distribution_columns.add(_elem500);
          }
        }
        struct.setDistribution_columnsIsSet(true);
      }
