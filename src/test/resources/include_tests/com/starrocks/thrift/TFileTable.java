            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumn>(_list254.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem255;
                for (int _i256 = 0; _i256 < _list254.size; ++_i256)
                {
                  _elem255 = new TColumn();
                  _elem255.read(iprot);
                  struct.columns.add(_elem255);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter257 : struct.columns)
            {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumn>(_list259.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem260;
          for (int _i261 = 0; _i261 < _list259.size; ++_i261)
          {
            _elem260 = new TColumn();
            _elem260.read(iprot);
            struct.columns.add(_elem260);
          }
        }
        struct.setColumnsIsSet(true);
      }
