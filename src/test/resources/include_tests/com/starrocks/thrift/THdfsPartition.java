            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list202.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem203;
                for (int _i204 = 0; _i204 < _list202.size; ++_i204)
                {
                  _elem203 = new com.starrocks.thrift.TExpr();
                  _elem203.read(iprot);
                  struct.partition_key_exprs.add(_elem203);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partition_key_exprs != null) {
        if (struct.isSetPartition_key_exprs()) {
          oprot.writeFieldBegin(PARTITION_KEY_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter205 : struct.partition_key_exprs)
            {
      ...
      if (struct.isSetPartition_key_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter206 : struct.partition_key_exprs)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list207.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem208;
          for (int _i209 = 0; _i209 < _list207.size; ++_i209)
          {
            _elem208 = new com.starrocks.thrift.TExpr();
            _elem208.read(iprot);
            struct.partition_key_exprs.add(_elem208);
          }
        }
        struct.setPartition_key_exprsIsSet(true);
      }
