...
public class TIcebergColumnStats implements org.apache.thrift.TBase<TIcebergColumnStats, TIcebergColumnStats._Fields>, java.io.Serializable, Cloneable, Comparable<TIcebergColumnStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.column_sizes = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map88.size);
                int _key89;
                long _val90;
                for (int _i91 = 0; _i91 < _map88.size; ++_i91)
                {
                  ...
                  struct.column_sizes.put(_key89, _val90);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map92.size);
                int _key93;
                long _val94;
                for (int _i95 = 0; _i95 < _map92.size; ++_i95)
                {
                  ...
                  struct.value_counts.put(_key93, _val94);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.null_value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map96.size);
                int _key97;
                long _val98;
                for (int _i99 = 0; _i99 < _map96.size; ++_i99)
                {
                  ...
                  struct.null_value_counts.put(_key97, _val98);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.nan_value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map100.size);
                int _key101;
                long _val102;
                for (int _i103 = 0; _i103 < _map100.size; ++_i103)
                {
                  ...
                  struct.nan_value_counts.put(_key101, _val102);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.lower_bounds = new java.util.HashMap<java.lang.Integer,java.nio.ByteBuffer>(2*_map104.size);
                int _key105;
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _val106;
                for (int _i107 = 0; _i107 < _map104.size; ++_i107)
                {
                  _key105 = iprot.readI32();
                  _val106 = iprot.readBinary();
                  struct.lower_bounds.put(_key105, _val106);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.upper_bounds = new java.util.HashMap<java.lang.Integer,java.nio.ByteBuffer>(2*_map108.size);
                int _key109;
                ...
                for (int _i111 = 0; _i111 < _map108.size; ++_i111)
                {
                  ...
                  struct.upper_bounds.put(_key109, _val110);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.column_sizes != null) {
        if (struct.isSetColumn_sizes()) {
          oprot.writeFieldBegin(COLUMN_SIZES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter112 : struct.column_sizes.entrySet())
            {
      ...
      if (struct.value_counts != null) {
        if (struct.isSetValue_counts()) {
          oprot.writeFieldBegin(VALUE_COUNTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter113 : struct.value_counts.entrySet())
            {
      ...
      if (struct.null_value_counts != null) {
        if (struct.isSetNull_value_counts()) {
          oprot.writeFieldBegin(NULL_VALUE_COUNTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter114 : struct.null_value_counts.entrySet())
            {
      ...
      if (struct.nan_value_counts != null) {
        if (struct.isSetNan_value_counts()) {
          oprot.writeFieldBegin(NAN_VALUE_COUNTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter115 : struct.nan_value_counts.entrySet())
            {
      ...
      if (struct.lower_bounds != null) {
        if (struct.isSetLower_bounds()) {
          oprot.writeFieldBegin(LOWER_BOUNDS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.nio.ByteBuffer> _iter116 : struct.lower_bounds.entrySet())
            {
      ...
      if (struct.upper_bounds != null) {
        if (struct.isSetUpper_bounds()) {
          oprot.writeFieldBegin(UPPER_BOUNDS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.nio.ByteBuffer> _iter117 : struct.upper_bounds.entrySet())
            {
  ...
  private static class TIcebergColumnStatsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIcebergColumnStats> {
      ...
      if (struct.isSetColumn_sizes()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter118 : struct.column_sizes.entrySet())
          {
      ...
      if (struct.isSetValue_counts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter119 : struct.value_counts.entrySet())
          {
      ...
      if (struct.isSetNull_value_counts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter120 : struct.null_value_counts.entrySet())
          {
      ...
      if (struct.isSetNan_value_counts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter121 : struct.nan_value_counts.entrySet())
          {
      ...
      if (struct.isSetLower_bounds()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.nio.ByteBuffer> _iter122 : struct.lower_bounds.entrySet())
          {
            oprot.writeI32(_iter122.getKey());
            oprot.writeBinary(_iter122.getValue());
          }
        }
      }
      if (struct.isSetUpper_bounds()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.nio.ByteBuffer> _iter123 : struct.upper_bounds.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIcebergColumnStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.column_sizes = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map124.size);
          int _key125;
          long _val126;
          for (int _i127 = 0; _i127 < _map124.size; ++_i127)
          {
            ...
            struct.column_sizes.put(_key125, _val126);
          }
        }
        struct.setColumn_sizesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map128.size);
          int _key129;
          long _val130;
          for (int _i131 = 0; _i131 < _map128.size; ++_i131)
          {
            ...
            struct.value_counts.put(_key129, _val130);
          }
        }
        struct.setValue_countsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map132 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I64); 
          struct.null_value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map132.size);
          int _key133;
          long _val134;
          for (int _i135 = 0; _i135 < _map132.size; ++_i135)
          {
            ...
            struct.null_value_counts.put(_key133, _val134);
          }
        }
        struct.setNull_value_countsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map136 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I64); 
          struct.nan_value_counts = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map136.size);
          int _key137;
          long _val138;
          for (int _i139 = 0; _i139 < _map136.size; ++_i139)
          {
            ...
            struct.nan_value_counts.put(_key137, _val138);
          }
        }
        struct.setNan_value_countsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map140 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING); 
          struct.lower_bounds = new java.util.HashMap<java.lang.Integer,java.nio.ByteBuffer>(2*_map140.size);
          int _key141;
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _val142;
          for (int _i143 = 0; _i143 < _map140.size; ++_i143)
          {
            _key141 = iprot.readI32();
            _val142 = iprot.readBinary();
            struct.lower_bounds.put(_key141, _val142);
          }
        }
        struct.setLower_boundsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map144 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING); 
          struct.upper_bounds = new java.util.HashMap<java.lang.Integer,java.nio.ByteBuffer>(2*_map144.size);
          int _key145;
          ...
          for (int _i147 = 0; _i147 < _map144.size; ++_i147)
          {
            ...
            struct.upper_bounds.put(_key145, _val146);
          }
        }
        struct.setUpper_boundsIsSet(true);
      }
