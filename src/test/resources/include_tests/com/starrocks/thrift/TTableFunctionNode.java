...
public class TTableFunctionNode implements org.apache.thrift.TBase<TTableFunctionNode, TTableFunctionNode._Fields>, java.io.Serializable, Cloneable, Comparable<TTableFunctionNode> {
  ...
  private static final org.apache.thrift.protocol.TField FN_RESULT_REQUIRED_FIELD_DESC = new org.apache.thrift.protocol.TField("fn_result_required", org.apache.thrift.protocol.TType.BOOL, (short)5);
  ...
  public boolean fn_result_required; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FN_RESULT_REQUIRED((short)5, "fn_result_required");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // FN_RESULT_REQUIRED
          return FN_RESULT_REQUIRED;
        default:
          return null;
      }
    }
  ...
  private static final int __FN_RESULT_REQUIRED_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TABLE_FUNCTION,_Fields.PARAM_COLUMNS,_Fields.OUTER_COLUMNS,_Fields.FN_RESULT_COLUMNS,_Fields.FN_RESULT_REQUIRED};
  ...
  static {
    ...
    tmpMap.put(_Fields.FN_RESULT_COLUMNS, new org.apache.thrift.meta_data.FieldMetaData("fn_result_columns", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32            , "TSlotId"))));
    tmpMap.put(_Fields.FN_RESULT_REQUIRED, new org.apache.thrift.meta_data.FieldMetaData("fn_result_required", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TTableFunctionNode(TTableFunctionNode other) {
    ...
    this.fn_result_required = other.fn_result_required;
  }
  ...
  public void clear() {
    ...
    setFn_result_requiredIsSet(false);
    this.fn_result_required = false;
  }
  ...
  public boolean isFn_result_required() {
    return this.fn_result_required;
  }

  public TTableFunctionNode setFn_result_required(boolean fn_result_required) {
    this.fn_result_required = fn_result_required;
    setFn_result_requiredIsSet(true);
    return this;
  }

  public void unsetFn_result_required() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __FN_RESULT_REQUIRED_ISSET_ID);
  }

  /** Returns true if field fn_result_required is set (has been assigned a value) and false otherwise */
  public boolean isSetFn_result_required() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __FN_RESULT_REQUIRED_ISSET_ID);
  }

  public void setFn_result_requiredIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __FN_RESULT_REQUIRED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FN_RESULT_REQUIRED:
      if (value == null) {
        unsetFn_result_required();
      } else {
        setFn_result_required((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case FN_RESULT_REQUIRED:
      return isSetFn_result_required();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TTableFunctionNode that) {
    ...
    boolean this_present_fn_result_required = true && this.isSetFn_result_required();
    boolean that_present_fn_result_required = true && that.isSetFn_result_required();
    if (this_present_fn_result_required || that_present_fn_result_required) {
      if (!(this_present_fn_result_required && that_present_fn_result_required))
        return false;
      if (this.fn_result_required != that.fn_result_required)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetFn_result_required()) ? 131071 : 524287);
    if (isSetFn_result_required())
      hashCode = hashCode * 8191 + ((fn_result_required) ? 131071 : 524287);
  ...
  public int compareTo(TTableFunctionNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFn_result_required(), other.isSetFn_result_required());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFn_result_required()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fn_result_required, other.fn_result_required);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetFn_result_required()) {
      if (!first) sb.append(", ");
      sb.append("fn_result_required:");
      sb.append(this.fn_result_required);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TTableFunctionNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTableFunctionNode> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.param_columns = new java.util.ArrayList<java.lang.Integer>(_list994.size);
                int _elem995;
                for (int _i996 = 0; _i996 < _list994.size; ++_i996)
                {
                  _elem995 = iprot.readI32();
                  struct.param_columns.add(_elem995);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outer_columns = new java.util.ArrayList<java.lang.Integer>(_list997.size);
                int _elem998;
                for (int _i999 = 0; _i999 < _list997.size; ++_i999)
                {
                  _elem998 = iprot.readI32();
                  struct.outer_columns.add(_elem998);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fn_result_columns = new java.util.ArrayList<java.lang.Integer>(_list1000.size);
                int _elem1001;
                for (int _i1002 = 0; _i1002 < _list1000.size; ++_i1002)
                {
                  _elem1001 = iprot.readI32();
                  struct.fn_result_columns.add(_elem1001);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // FN_RESULT_REQUIRED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.fn_result_required = iprot.readBool();
              struct.setFn_result_requiredIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTableFunctionNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.param_columns != null) {
        if (struct.isSetParam_columns()) {
          oprot.writeFieldBegin(PARAM_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter1003 : struct.param_columns)
            {
              oprot.writeI32(_iter1003);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.outer_columns != null) {
        if (struct.isSetOuter_columns()) {
          oprot.writeFieldBegin(OUTER_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter1004 : struct.outer_columns)
            {
              oprot.writeI32(_iter1004);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.fn_result_columns != null) {
        if (struct.isSetFn_result_columns()) {
          oprot.writeFieldBegin(FN_RESULT_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter1005 : struct.fn_result_columns)
            {
              oprot.writeI32(_iter1005);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.isSetFn_result_required()) {
        oprot.writeFieldBegin(FN_RESULT_REQUIRED_FIELD_DESC);
        oprot.writeBool(struct.fn_result_required);
        oprot.writeFieldEnd();
      }
  ...
  private static class TTableFunctionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableFunctionNode> {
      ...
      if (struct.isSetParam_columns()) {
        {
          ...
          for (int _iter1006 : struct.param_columns)
          {
            oprot.writeI32(_iter1006);
          }
        }
      }
      if (struct.isSetOuter_columns()) {
        {
          ...
          for (int _iter1007 : struct.outer_columns)
          {
            oprot.writeI32(_iter1007);
          }
        }
      }
      if (struct.isSetFn_result_columns()) {
        {
          ...
          for (int _iter1008 : struct.fn_result_columns)
          {
            oprot.writeI32(_iter1008);
          }
        }
      }
      if (struct.isSetFn_result_required()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableFunctionNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1009 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.param_columns = new java.util.ArrayList<java.lang.Integer>(_list1009.size);
          int _elem1010;
          for (int _i1011 = 0; _i1011 < _list1009.size; ++_i1011)
          {
            _elem1010 = iprot.readI32();
            struct.param_columns.add(_elem1010);
          }
        }
        struct.setParam_columnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list1012 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.outer_columns = new java.util.ArrayList<java.lang.Integer>(_list1012.size);
          int _elem1013;
          for (int _i1014 = 0; _i1014 < _list1012.size; ++_i1014)
          {
            _elem1013 = iprot.readI32();
            struct.outer_columns.add(_elem1013);
          }
        }
        struct.setOuter_columnsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.fn_result_columns = new java.util.ArrayList<java.lang.Integer>(_list1015.size);
          int _elem1016;
          for (int _i1017 = 0; _i1017 < _list1015.size; ++_i1017)
          {
            _elem1016 = iprot.readI32();
            struct.fn_result_columns.add(_elem1016);
          }
        }
        struct.setFn_result_columnsIsSet(true);
      }
