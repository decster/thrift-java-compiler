...
public class TStreamLoadPutRequest implements org.apache.thrift.TBase<TStreamLoadPutRequest, TStreamLoadPutRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TStreamLoadPutRequest> {
  ...
  private static final org.apache.thrift.protocol.TField PAYLOAD_COMPRESSION_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("payload_compression_type", org.apache.thrift.protocol.TType.STRING, (short)56);
  private static final org.apache.thrift.protocol.TField WAREHOUSE_FIELD_DESC = new org.apache.thrift.protocol.TField("warehouse", org.apache.thrift.protocol.TType.STRING, (short)101);
  private static final org.apache.thrift.protocol.TField BACKEND_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("backend_id", org.apache.thrift.protocol.TType.I64, (short)102);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String payload_compression_type; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PAYLOAD_COMPRESSION_TYPE((short)56, "payload_compression_type"),
    WAREHOUSE((short)101, "warehouse"),
    BACKEND_ID((short)102, "backend_id");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 56: // PAYLOAD_COMPRESSION_TYPE
          return PAYLOAD_COMPRESSION_TYPE;
        case 101: // WAREHOUSE
          return WAREHOUSE;
        case 102: // BACKEND_ID
          return BACKEND_ID;
  ...
  private static final int __BACKEND_ID_ISSET_ID = 17;
  private int __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER_IP,_Fields.PATH,_Fields.COLUMNS,_Fields.WHERE,_Fields.COLUMN_SEPARATOR,_Fields.PARTITIONS,_Fields.AUTH_CODE,_Fields.NEGATIVE,_Fields.TIMEOUT,_Fields.STRICT_MODE,_Fields.TIMEZONE,_Fields.LOAD_MEM_LIMIT,_Fields.IS_TEMP_PARTITION,_Fields.STRIP_OUTER_ARRAY,_Fields.JSONPATHS,_Fields.THRIFT_RPC_TIMEOUT_MS,_Fields.JSON_ROOT,_Fields.PARTIAL_UPDATE,_Fields.TRANSMISSION_COMPRESSION_TYPE,_Fields.LOAD_DOP,_Fields.ENABLE_REPLICATED_STORAGE,_Fields.MERGE_CONDITION,_Fields.LOG_REJECTED_RECORD_NUM,_Fields.ROW_DELIMITER,_Fields.SKIP_HEADER,_Fields.TRIM_SPACE,_Fields.ENCLOSE,_Fields.ESCAPE,_Fields.PARTIAL_UPDATE_MODE,_Fields.PAYLOAD_COMPRESSION_TYPE,_Fields.WAREHOUSE,_Fields.BACKEND_ID};
  ...
  static {
    ...
    tmpMap.put(_Fields.PAYLOAD_COMPRESSION_TYPE, new org.apache.thrift.meta_data.FieldMetaData("payload_compression_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public TStreamLoadPutRequest(TStreamLoadPutRequest other) {
    ...
    if (other.isSetPayload_compression_type()) {
      this.payload_compression_type = other.payload_compression_type;
    }
  ...
  public void clear() {
    ...
    this.payload_compression_type = null;
    this.warehouse = null;
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getPayload_compression_type() {
    return this.payload_compression_type;
  }

  public TStreamLoadPutRequest setPayload_compression_type(@org.apache.thrift.annotation.Nullable java.lang.String payload_compression_type) {
    this.payload_compression_type = payload_compression_type;
    return this;
  }

  public void unsetPayload_compression_type() {
    this.payload_compression_type = null;
  }

  /** Returns true if field payload_compression_type is set (has been assigned a value) and false otherwise */
  public boolean isSetPayload_compression_type() {
    return this.payload_compression_type != null;
  }

  public void setPayload_compression_typeIsSet(boolean value) {
    if (!value) {
      this.payload_compression_type = null;
    }
  }
  ...
  public TStreamLoadPutRequest setWarehouse(@org.apache.thrift.annotation.Nullable java.lang.String warehouse) {
  ...
  public TStreamLoadPutRequest setBackend_id(long backend_id) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PAYLOAD_COMPRESSION_TYPE:
      if (value == null) {
        unsetPayload_compression_type();
      } else {
        setPayload_compression_type((java.lang.String)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case PAYLOAD_COMPRESSION_TYPE:
      return getPayload_compression_type();
  ...
  public boolean isSet(_Fields field) {
    ...
    case PAYLOAD_COMPRESSION_TYPE:
      return isSetPayload_compression_type();
    case WAREHOUSE:
  ...
  public boolean equals(TStreamLoadPutRequest that) {
    ...
    boolean this_present_payload_compression_type = true && this.isSetPayload_compression_type();
    boolean that_present_payload_compression_type = true && that.isSetPayload_compression_type();
    if (this_present_payload_compression_type || that_present_payload_compression_type) {
      if (!(this_present_payload_compression_type && that_present_payload_compression_type))
        return false;
      if (!this.payload_compression_type.equals(that.payload_compression_type))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPayload_compression_type()) ? 131071 : 524287);
    if (isSetPayload_compression_type())
      hashCode = hashCode * 8191 + payload_compression_type.hashCode();
  ...
  public int compareTo(TStreamLoadPutRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPayload_compression_type(), other.isSetPayload_compression_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPayload_compression_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.payload_compression_type, other.payload_compression_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetPayload_compression_type()) {
      if (!first) sb.append(", ");
      sb.append("payload_compression_type:");
      if (this.payload_compression_type == null) {
        sb.append("null");
      } else {
        sb.append(this.payload_compression_type);
      }
      first = false;
    }
    if (isSetWarehouse()) {
  ...
  private static class TStreamLoadPutRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TStreamLoadPutRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TStreamLoadPutRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 56: // PAYLOAD_COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.payload_compression_type = iprot.readString();
              struct.setPayload_compression_typeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStreamLoadPutRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.payload_compression_type != null) {
        if (struct.isSetPayload_compression_type()) {
          oprot.writeFieldBegin(PAYLOAD_COMPRESSION_TYPE_FIELD_DESC);
          oprot.writeString(struct.payload_compression_type);
          oprot.writeFieldEnd();
        }
      }
