    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter144 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBroker_prop()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter145 : struct.broker_prop.entrySet())
            {
  ...
  private static class TDownloadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDownloadReq> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJob_idIsSet(true);
      {
        ...
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map148.size);
        ...
        for (int _i151 = 0; _i151 < _map148.size; ++_i151)
        {
          ...
          struct.src_dest_map.put(_key149, _val150);
        }
      }
      struct.setSrc_dest_mapIsSet(true);
      struct.broker_addr = new com.starrocks.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map152.size);
          ...
          for (int _i155 = 0; _i155 < _map152.size; ++_i155)
          {
            ...
            struct.broker_prop.put(_key153, _val154);
          }
        }
        struct.setBroker_propIsSet(true);
      }
