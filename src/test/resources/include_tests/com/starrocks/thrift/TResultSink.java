...
public class TResultSink implements org.apache.thrift.TBase<TResultSink, TResultSink._Fields>, java.io.Serializable, Cloneable, Comparable<TResultSink> {
  ...
  public int compareTo(TResultSink other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFile_options(), other.isSetFile_options());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFile_options()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.starrocks.thrift.TResultSinkType.findByValue(iprot.readI32());
          ...
          case 3: // FORMAT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.format = com.starrocks.thrift.TResultSinkFormatType.findByValue(iprot.readI32());
