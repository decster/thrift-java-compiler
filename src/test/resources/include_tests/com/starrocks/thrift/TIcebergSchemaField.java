            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.children = new java.util.ArrayList<TIcebergSchemaField>(_list278.size);
                @org.apache.thrift.annotation.Nullable TIcebergSchemaField _elem279;
                for (int _i280 = 0; _i280 < _list278.size; ++_i280)
                {
                  _elem279 = new TIcebergSchemaField();
                  _elem279.read(iprot);
                  struct.children.add(_elem279);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.children != null) {
        if (struct.isSetChildren()) {
          oprot.writeFieldBegin(CHILDREN_FIELD_DESC);
          {
            ...
            for (TIcebergSchemaField _iter281 : struct.children)
            {
      ...
      if (struct.isSetChildren()) {
        {
          ...
          for (TIcebergSchemaField _iter282 : struct.children)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.children = new java.util.ArrayList<TIcebergSchemaField>(_list283.size);
          @org.apache.thrift.annotation.Nullable TIcebergSchemaField _elem284;
          for (int _i285 = 0; _i285 < _list283.size; ++_i285)
          {
            _elem284 = new TIcebergSchemaField();
            _elem284.read(iprot);
            struct.children.add(_elem284);
          }
        }
        struct.setChildrenIsSet(true);
      }
