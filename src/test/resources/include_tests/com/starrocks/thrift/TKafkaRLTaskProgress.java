            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitionCmtOffset = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map320.size);
                int _key321;
                long _val322;
                for (int _i323 = 0; _i323 < _map320.size; ++_i323)
                {
                  ...
                  struct.partitionCmtOffset.put(_key321, _val322);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitionCmtOffsetTimestamp = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map324.size);
                int _key325;
                long _val326;
                for (int _i327 = 0; _i327 < _map324.size; ++_i327)
                {
                  ...
                  struct.partitionCmtOffsetTimestamp.put(_key325, _val326);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TKafkaRLTaskProgress struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionCmtOffset != null) {
        oprot.writeFieldBegin(PARTITION_CMT_OFFSET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter328 : struct.partitionCmtOffset.entrySet())
          {
      ...
      if (struct.partitionCmtOffsetTimestamp != null) {
        if (struct.isSetPartitionCmtOffsetTimestamp()) {
          oprot.writeFieldBegin(PARTITION_CMT_OFFSET_TIMESTAMP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter329 : struct.partitionCmtOffsetTimestamp.entrySet())
            {
  ...
  private static class TKafkaRLTaskProgressTupleScheme extends org.apache.thrift.scheme.TupleScheme<TKafkaRLTaskProgress> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TKafkaRLTaskProgress struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter330 : struct.partitionCmtOffset.entrySet())
        {
          oprot.writeI32(_iter330.getKey());
          oprot.writeI64(_iter330.getValue());
        }
      }
      ...
      if (struct.isSetPartitionCmtOffsetTimestamp()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Long> _iter331 : struct.partitionCmtOffsetTimestamp.entrySet())
          {
            oprot.writeI32(_iter331.getKey());
            oprot.writeI64(_iter331.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TKafkaRLTaskProgress struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map332 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I64); 
        struct.partitionCmtOffset = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map332.size);
        int _key333;
        long _val334;
        for (int _i335 = 0; _i335 < _map332.size; ++_i335)
        {
          ...
          struct.partitionCmtOffset.put(_key333, _val334);
        }
      }
      struct.setPartitionCmtOffsetIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map336 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I64); 
          struct.partitionCmtOffsetTimestamp = new java.util.HashMap<java.lang.Integer,java.lang.Long>(2*_map336.size);
          int _key337;
          long _val338;
          for (int _i339 = 0; _i339 < _map336.size; ++_i339)
          {
            ...
            struct.partitionCmtOffsetTimestamp.put(_key337, _val338);
          }
        }
        struct.setPartitionCmtOffsetTimestampIsSet(true);
      }
