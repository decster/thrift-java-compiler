            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list422.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem423;
                for (int _i424 = 0; _i424 < _list422.size; ++_i424)
                {
                  _elem423 = iprot.readString();
                  struct.columns.add(_elem423);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter425 : struct.columns)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter426 : struct.columns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.lang.String>(_list427.size);
