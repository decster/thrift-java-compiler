            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<TTabletMeta>(_list438.size);
                @org.apache.thrift.annotation.Nullable TTabletMeta _elem439;
                for (int _i440 = 0; _i440 < _list438.size; ++_i440)
                {
                  _elem439 = new TTabletMeta();
                  _elem439.read(iprot);
                  struct.tablets.add(_elem439);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tablets != null) {
        if (struct.isSetTablets()) {
          oprot.writeFieldBegin(TABLETS_FIELD_DESC);
          {
            ...
            for (TTabletMeta _iter441 : struct.tablets)
            {
      ...
      if (struct.isSetTablets()) {
        {
          ...
          for (TTabletMeta _iter442 : struct.tablets)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.tablets = new java.util.ArrayList<TTabletMeta>(_list443.size);
          @org.apache.thrift.annotation.Nullable TTabletMeta _elem444;
          for (int _i445 = 0; _i445 < _list443.size; ++_i445)
          {
            _elem444 = new TTabletMeta();
            _elem444.read(iprot);
            struct.tablets.add(_elem444);
          }
        }
        struct.setTabletsIsSet(true);
      }
