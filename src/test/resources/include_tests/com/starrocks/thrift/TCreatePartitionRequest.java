...
public class TCreatePartitionRequest implements org.apache.thrift.TBase<TCreatePartitionRequest, TCreatePartitionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TCreatePartitionRequest> {
  ...
  private static final int __IS_TEMP_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TXN_ID,_Fields.DB_ID,_Fields.TABLE_ID,_Fields.PARTITION_VALUES,_Fields.IS_TEMP};
  ...
  public TCreatePartitionRequest setIs_temp(boolean is_temp) {
      ...
      if (struct.partition_values != null) {
        if (struct.isSetPartition_values()) {
          oprot.writeFieldBegin(PARTITION_VALUES_FIELD_DESC);
          {
            ...
            for (java.util.List<java.lang.String> _iter614 : struct.partition_values)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, _iter614.size()));
                for (java.lang.String _iter615 : _iter614)
                {
  ...
  private static class TCreatePartitionRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCreatePartitionRequest> {
      ...
      if (struct.isSetPartition_values()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter616 : struct.partition_values)
          {
            {
              oprot.writeI32(_iter616.size());
              for (java.lang.String _iter617 : _iter616)
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCreatePartitionRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list618 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
          struct.partition_values = new java.util.ArrayList<java.util.List<java.lang.String>>(_list618.size);
          @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem619;
          for (int _i620 = 0; _i620 < _list618.size; ++_i620)
          {
            {
              org.apache.thrift.protocol.TList _list621 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
              _elem619 = new java.util.ArrayList<java.lang.String>(_list621.size);
              ...
              for (int _i623 = 0; _i623 < _list621.size; ++_i623)
              {
                ...
                _elem619.add(_elem622);
              }
            }
            struct.partition_values.add(_elem619);
          }
        }
        struct.setPartition_valuesIsSet(true);
      }
