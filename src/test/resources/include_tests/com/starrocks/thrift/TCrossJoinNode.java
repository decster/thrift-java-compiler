            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list986.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem987;
                for (int _i988 = 0; _i988 < _list986.size; ++_i988)
                {
                  _elem987 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem987.read(iprot);
                  struct.build_runtime_filters.add(_elem987);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter989 : struct.build_runtime_filters)
            {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter990 : struct.build_runtime_filters)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list991.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem992;
          for (int _i993 = 0; _i993 < _list991.size; ++_i993)
          {
            _elem992 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem992.read(iprot);
            struct.build_runtime_filters.add(_elem992);
          }
        }
        struct.setBuild_runtime_filtersIsSet(true);
      }
