            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list214.size);
                @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem215;
                for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                {
                  _elem215 = new TTabletMetaInfo();
                  _elem215.read(iprot);
                  struct.tabletMetaInfos.add(_elem215);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tabletMetaInfos != null) {
        if (struct.isSetTabletMetaInfos()) {
          oprot.writeFieldBegin(TABLET_META_INFOS_FIELD_DESC);
          {
            ...
            for (TTabletMetaInfo _iter217 : struct.tabletMetaInfos)
            {
      ...
      if (struct.isSetTabletMetaInfos()) {
        {
          ...
          for (TTabletMetaInfo _iter218 : struct.tabletMetaInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list219.size);
          @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem220;
          for (int _i221 = 0; _i221 < _list219.size; ++_i221)
          {
            _elem220 = new TTabletMetaInfo();
            _elem220.read(iprot);
            struct.tabletMetaInfos.add(_elem220);
          }
        }
        struct.setTabletMetaInfosIsSet(true);
      }
