...
public class TSnapshotInfo implements org.apache.thrift.TBase<TSnapshotInfo, TSnapshotInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TSnapshotInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSnapshotInfo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TSnapshotInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TSnapshotInfoTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable TBackend backend; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BACKEND, new org.apache.thrift.meta_data.FieldMetaData("backend", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TBackend.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSnapshotInfo.class, metaDataMap);
  }

  public TSnapshotInfo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TSnapshotInfo(TSnapshotInfo other) {
  ...
  @Override
  public TSnapshotInfo deepCopy() {
    return new TSnapshotInfo(this);
  }
  ...
  public TSnapshotInfo setBackend(@org.apache.thrift.annotation.Nullable TBackend backend) {
  ...
  public TSnapshotInfo setSnapshot_path(@org.apache.thrift.annotation.Nullable java.lang.String snapshot_path) {
  ...
  public TSnapshotInfo setIncremental_snapshot(boolean incremental_snapshot) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TSnapshotInfo)
      return this.equals((TSnapshotInfo)that);
    return false;
  }

  public boolean equals(TSnapshotInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TSnapshotInfo other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TSnapshotInfo(");
    boolean first = true;
  ...
  private static class TSnapshotInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TSnapshotInfoStandardScheme getScheme() {
      return new TSnapshotInfoStandardScheme();
    }
  }

  private static class TSnapshotInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TSnapshotInfo> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TSnapshotInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSnapshotInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TSnapshotInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TSnapshotInfoTupleScheme getScheme() {
      return new TSnapshotInfoTupleScheme();
    }
  }

  private static class TSnapshotInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSnapshotInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSnapshotInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSnapshotInfo struct) throws org.apache.thrift.TException {
