            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replicas = new java.util.ArrayList<TReplicaMeta>(_list414.size);
                @org.apache.thrift.annotation.Nullable TReplicaMeta _elem415;
                for (int _i416 = 0; _i416 < _list414.size; ++_i416)
                {
                  _elem415 = new TReplicaMeta();
                  _elem415.read(iprot);
                  struct.replicas.add(_elem415);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replicas != null) {
        if (struct.isSetReplicas()) {
          oprot.writeFieldBegin(REPLICAS_FIELD_DESC);
          {
            ...
            for (TReplicaMeta _iter417 : struct.replicas)
            {
      ...
      if (struct.isSetReplicas()) {
        {
          ...
          for (TReplicaMeta _iter418 : struct.replicas)
          {
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.replicas = new java.util.ArrayList<TReplicaMeta>(_list419.size);
          @org.apache.thrift.annotation.Nullable TReplicaMeta _elem420;
          for (int _i421 = 0; _i421 < _list419.size; ++_i421)
          {
            _elem420 = new TReplicaMeta();
            _elem420.read(iprot);
            struct.replicas.add(_elem420);
          }
        }
        struct.setReplicasIsSet(true);
      }
