            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.unique_param_per_instance = new java.util.ArrayList<TExecPlanFragmentParams>(_list118.size);
                @org.apache.thrift.annotation.Nullable TExecPlanFragmentParams _elem119;
                for (int _i120 = 0; _i120 < _list118.size; ++_i120)
                {
                  _elem119 = new TExecPlanFragmentParams();
                  _elem119.read(iprot);
                  struct.unique_param_per_instance.add(_elem119);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.unique_param_per_instance != null) {
        if (struct.isSetUnique_param_per_instance()) {
          oprot.writeFieldBegin(UNIQUE_PARAM_PER_INSTANCE_FIELD_DESC);
          {
            ...
            for (TExecPlanFragmentParams _iter121 : struct.unique_param_per_instance)
            {
      ...
      if (struct.isSetUnique_param_per_instance()) {
        {
          ...
          for (TExecPlanFragmentParams _iter122 : struct.unique_param_per_instance)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.unique_param_per_instance = new java.util.ArrayList<TExecPlanFragmentParams>(_list123.size);
          @org.apache.thrift.annotation.Nullable TExecPlanFragmentParams _elem124;
          for (int _i125 = 0; _i125 < _list123.size; ++_i125)
          {
            _elem124 = new TExecPlanFragmentParams();
            _elem124.read(iprot);
            struct.unique_param_per_instance.add(_elem124);
          }
        }
        struct.setUnique_param_per_instanceIsSet(true);
      }
