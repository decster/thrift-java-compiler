...
public class TStatisticData implements org.apache.thrift.TBase<TStatisticData, TStatisticData._Fields>, java.io.Serializable, Cloneable, Comparable<TStatisticData> {
  ...
  private static final org.apache.thrift.protocol.TField COLLECTION_SIZE_FIELD_DESC = new org.apache.thrift.protocol.TField("collectionSize", org.apache.thrift.protocol.TType.I64, (short)17);
  ...
  public long collectionSize; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COLLECTION_SIZE((short)17, "collectionSize");
  ...
  private static final int __COLLECTIONSIZE_ISSET_ID = 8;
  private short __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.UPDATE_TIME,_Fields.DB_ID,_Fields.TABLE_ID,_Fields.COLUMN_NAME,_Fields.ROW_COUNT,_Fields.DATA_SIZE,_Fields.COUNT_DISTINCT,_Fields.NULL_COUNT,_Fields.MAX,_Fields.MIN,_Fields.HISTOGRAM,_Fields.DICT,_Fields.META_VERSION,_Fields.PARTITION_ID,_Fields.HLL,_Fields.PARTITION_NAME,_Fields.COLLECTION_SIZE};
  ...
  static {
    ...
    tmpMap.put(_Fields.PARTITION_NAME, new org.apache.thrift.meta_data.FieldMetaData("partitionName", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.COLLECTION_SIZE, new org.apache.thrift.meta_data.FieldMetaData("collectionSize", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
  ...
  public TStatisticData setCollectionSize(long collectionSize) {
    this.collectionSize = collectionSize;
    setCollectionSizeIsSet(true);
    return this;
  }

  public void unsetCollectionSize() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __COLLECTIONSIZE_ISSET_ID);
  }

  /** Returns true if field collectionSize is set (has been assigned a value) and false otherwise */
  public boolean isSetCollectionSize() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __COLLECTIONSIZE_ISSET_ID);
  }

  public void setCollectionSizeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __COLLECTIONSIZE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COLLECTION_SIZE:
      if (value == null) {
        ...
        setCollectionSize((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(TStatisticData that) {
    ...
    boolean this_present_collectionSize = true && this.isSetCollectionSize();
    boolean that_present_collectionSize = true && that.isSetCollectionSize();
    if (this_present_collectionSize || that_present_collectionSize) {
      if (!(this_present_collectionSize && that_present_collectionSize))
        return false;
      if (this.collectionSize != that.collectionSize)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCollectionSize()) ? 131071 : 524287);
    if (isSetCollectionSize())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(collectionSize);
  ...
  public int compareTo(TStatisticData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCollectionSize(), other.isSetCollectionSize());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCollectionSize()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.collectionSize, other.collectionSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TStatisticDataStandardScheme extends org.apache.thrift.scheme.StandardScheme<TStatisticData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TStatisticData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 17: // COLLECTION_SIZE
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.collectionSize = iprot.readI64();
              struct.setCollectionSizeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStatisticData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCollectionSize()) {
        oprot.writeFieldBegin(COLLECTION_SIZE_FIELD_DESC);
        oprot.writeI64(struct.collectionSize);
        oprot.writeFieldEnd();
      }
