            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list672.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem673;
                for (int _i674 = 0; _i674 < _list672.size; ++_i674)
                {
                  _elem673 = new com.starrocks.thrift.TExpr();
                  _elem673.read(iprot);
                  struct.partition_exprs.add(_elem673);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.order_by_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list675.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem676;
                for (int _i677 = 0; _i677 < _list675.size; ++_i677)
                {
                  _elem676 = new com.starrocks.thrift.TExpr();
                  _elem676.read(iprot);
                  struct.order_by_exprs.add(_elem676);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analytic_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list678.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem679;
                for (int _i680 = 0; _i680 < _list678.size; ++_i680)
                {
                  _elem679 = new com.starrocks.thrift.TExpr();
                  _elem679.read(iprot);
                  struct.analytic_functions.add(_elem679);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_exprs != null) {
        oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter681 : struct.partition_exprs)
          {
      ...
      if (struct.order_by_exprs != null) {
        oprot.writeFieldBegin(ORDER_BY_EXPRS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter682 : struct.order_by_exprs)
          {
      ...
      if (struct.analytic_functions != null) {
        oprot.writeFieldBegin(ANALYTIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter683 : struct.analytic_functions)
          {
  ...
  private static class TAnalyticNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAnalyticNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (com.starrocks.thrift.TExpr _iter684 : struct.partition_exprs)
        {
      ...
      }
      {
        ...
        for (com.starrocks.thrift.TExpr _iter685 : struct.order_by_exprs)
        {
      ...
      }
      {
        ...
        for (com.starrocks.thrift.TExpr _iter686 : struct.analytic_functions)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list687 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list687.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem688;
        for (int _i689 = 0; _i689 < _list687.size; ++_i689)
        {
          _elem688 = new com.starrocks.thrift.TExpr();
          _elem688.read(iprot);
          struct.partition_exprs.add(_elem688);
        }
      }
      struct.setPartition_exprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list690 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.order_by_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list690.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem691;
        for (int _i692 = 0; _i692 < _list690.size; ++_i692)
        {
          _elem691 = new com.starrocks.thrift.TExpr();
          _elem691.read(iprot);
          struct.order_by_exprs.add(_elem691);
        }
      }
      struct.setOrder_by_exprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list693 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.analytic_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list693.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem694;
        for (int _i695 = 0; _i695 < _list693.size; ++_i695)
        {
          _elem694 = new com.starrocks.thrift.TExpr();
          _elem694.read(iprot);
          struct.analytic_functions.add(_elem694);
        }
      }
      struct.setAnalytic_functionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
