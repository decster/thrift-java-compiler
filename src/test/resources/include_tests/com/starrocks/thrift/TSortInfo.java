            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ordering_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list568.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem569;
                for (int _i570 = 0; _i570 < _list568.size; ++_i570)
                {
                  _elem569 = new com.starrocks.thrift.TExpr();
                  _elem569.read(iprot);
                  struct.ordering_exprs.add(_elem569);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.is_asc_order = new java.util.ArrayList<java.lang.Boolean>(_list571.size);
                boolean _elem572;
                for (int _i573 = 0; _i573 < _list571.size; ++_i573)
                {
                  _elem572 = iprot.readBool();
                  struct.is_asc_order.add(_elem572);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nulls_first = new java.util.ArrayList<java.lang.Boolean>(_list574.size);
                boolean _elem575;
                for (int _i576 = 0; _i576 < _list574.size; ++_i576)
                {
                  _elem575 = iprot.readBool();
                  struct.nulls_first.add(_elem575);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sort_tuple_slot_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list577.size);
                ...
                for (int _i579 = 0; _i579 < _list577.size; ++_i579)
                {
                  ...
                  _elem578.read(iprot);
                  struct.sort_tuple_slot_exprs.add(_elem578);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSortInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.ordering_exprs != null) {
        oprot.writeFieldBegin(ORDERING_EXPRS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter580 : struct.ordering_exprs)
          {
      ...
      if (struct.is_asc_order != null) {
        oprot.writeFieldBegin(IS_ASC_ORDER_FIELD_DESC);
        {
          ...
          for (boolean _iter581 : struct.is_asc_order)
          {
            oprot.writeBool(_iter581);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.nulls_first != null) {
        oprot.writeFieldBegin(NULLS_FIRST_FIELD_DESC);
        {
          ...
          for (boolean _iter582 : struct.nulls_first)
          {
            oprot.writeBool(_iter582);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.sort_tuple_slot_exprs != null) {
        if (struct.isSetSort_tuple_slot_exprs()) {
          oprot.writeFieldBegin(SORT_TUPLE_SLOT_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter583 : struct.sort_tuple_slot_exprs)
            {
  ...
  private static class TSortInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSortInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TSortInfo struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (com.starrocks.thrift.TExpr _iter584 : struct.ordering_exprs)
        {
      ...
      }
      {
        ...
        for (boolean _iter585 : struct.is_asc_order)
        {
      ...
      }
      {
        ...
        for (boolean _iter586 : struct.nulls_first)
        {
      ...
      if (struct.isSetSort_tuple_slot_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter587 : struct.sort_tuple_slot_exprs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSortInfo struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list588 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.ordering_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list588.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem589;
        for (int _i590 = 0; _i590 < _list588.size; ++_i590)
        {
          _elem589 = new com.starrocks.thrift.TExpr();
          _elem589.read(iprot);
          struct.ordering_exprs.add(_elem589);
        }
      }
      struct.setOrdering_exprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list591 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.is_asc_order = new java.util.ArrayList<java.lang.Boolean>(_list591.size);
        boolean _elem592;
        for (int _i593 = 0; _i593 < _list591.size; ++_i593)
        {
          _elem592 = iprot.readBool();
          struct.is_asc_order.add(_elem592);
        }
      }
      struct.setIs_asc_orderIsSet(true);
      {
        org.apache.thrift.protocol.TList _list594 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.nulls_first = new java.util.ArrayList<java.lang.Boolean>(_list594.size);
        boolean _elem595;
        for (int _i596 = 0; _i596 < _list594.size; ++_i596)
        {
          _elem595 = iprot.readBool();
          struct.nulls_first.add(_elem595);
        }
      }
      struct.setNulls_firstIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sort_tuple_slot_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list597.size);
          ...
          for (int _i599 = 0; _i599 < _list597.size; ++_i599)
          {
            ...
            _elem598.read(iprot);
            struct.sort_tuple_slot_exprs.add(_elem598);
          }
        }
        struct.setSort_tuple_slot_exprsIsSet(true);
      }
