            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumnMeta>(_list430.size);
                @org.apache.thrift.annotation.Nullable TColumnMeta _elem431;
                for (int _i432 = 0; _i432 < _list430.size; ++_i432)
                {
                  _elem431 = new TColumnMeta();
                  _elem431.read(iprot);
                  struct.columns.add(_elem431);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnMeta _iter433 : struct.columns)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumnMeta _iter434 : struct.columns)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumnMeta>(_list435.size);
          @org.apache.thrift.annotation.Nullable TColumnMeta _elem436;
          for (int _i437 = 0; _i437 < _list435.size; ++_i437)
          {
            _elem436 = new TColumnMeta();
            _elem436.read(iprot);
            struct.columns.add(_elem436);
          }
        }
        struct.setColumnsIsSet(true);
      }
