...
public class TDeltaLakeTable implements org.apache.thrift.TBase<TDeltaLakeTable, TDeltaLakeTable._Fields>, java.io.Serializable, Cloneable, Comparable<TDeltaLakeTable> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumn>(_list364.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem365;
                for (int _i366 = 0; _i366 < _list364.size; ++_i366)
                {
                  _elem365 = new TColumn();
                  _elem365.read(iprot);
                  struct.columns.add(_elem365);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_columns = new java.util.ArrayList<TColumn>(_list367.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem368;
                for (int _i369 = 0; _i369 < _list367.size; ++_i369)
                {
                  _elem368 = new TColumn();
                  _elem368.read(iprot);
                  struct.partition_columns.add(_elem368);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map370.size);
                long _key371;
                @org.apache.thrift.annotation.Nullable THdfsPartition _val372;
                for (int _i373 = 0; _i373 < _map370.size; ++_i373)
                {
                  _key371 = iprot.readI64();
                  _val372 = new THdfsPartition();
                  _val372.read(iprot);
                  struct.partitions.put(_key371, _val372);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list374.size);
                ...
                for (int _i376 = 0; _i376 < _list374.size; ++_i376)
                {
                  ...
                  struct.partition_prefixes.add(_elem375);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter377 : struct.columns)
            {
      ...
      if (struct.partition_columns != null) {
        if (struct.isSetPartition_columns()) {
          oprot.writeFieldBegin(PARTITION_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter378 : struct.partition_columns)
            {
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter379 : struct.partitions.entrySet())
            {
      ...
      if (struct.partition_prefixes != null) {
        if (struct.isSetPartition_prefixes()) {
          oprot.writeFieldBegin(PARTITION_PREFIXES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter380 : struct.partition_prefixes)
            {
  ...
  private static class TDeltaLakeTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDeltaLakeTable> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumn _iter381 : struct.columns)
          {
      ...
      if (struct.isSetPartition_columns()) {
        {
          ...
          for (TColumn _iter382 : struct.partition_columns)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter383 : struct.partitions.entrySet())
          {
            oprot.writeI64(_iter383.getKey());
      ...
      if (struct.isSetPartition_prefixes()) {
        {
          ...
          for (java.lang.String _iter384 : struct.partition_prefixes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDeltaLakeTable struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumn>(_list385.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem386;
          for (int _i387 = 0; _i387 < _list385.size; ++_i387)
          {
            _elem386 = new TColumn();
            _elem386.read(iprot);
            struct.columns.add(_elem386);
          }
        }
        struct.setColumnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.partition_columns = new java.util.ArrayList<TColumn>(_list388.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem389;
          for (int _i390 = 0; _i390 < _list388.size; ++_i390)
          {
            _elem389 = new TColumn();
            _elem389.read(iprot);
            struct.partition_columns.add(_elem389);
          }
        }
        struct.setPartition_columnsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map391 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map391.size);
          long _key392;
          @org.apache.thrift.annotation.Nullable THdfsPartition _val393;
          for (int _i394 = 0; _i394 < _map391.size; ++_i394)
          {
            _key392 = iprot.readI64();
            _val393 = new THdfsPartition();
            _val393.read(iprot);
            struct.partitions.put(_key392, _val393);
          }
        }
        struct.setPartitionsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list395.size);
          ...
          for (int _i397 = 0; _i397 < _list395.size; ++_i397)
          {
            ...
            struct.partition_prefixes.add(_elem396);
          }
        }
        struct.setPartition_prefixesIsSet(true);
      }
