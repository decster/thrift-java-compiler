            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<com.starrocks.thrift.TExpr>>(_list810.size);
                @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> _elem811;
                for (int _i812 = 0; _i812 < _list810.size; ++_i812)
                {
                  {
                    org.apache.thrift.protocol.TList _list813 = iprot.readListBegin();
                    _elem811 = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list813.size);
                  ...
                  struct.result_expr_lists.add(_elem811);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<com.starrocks.thrift.TExpr>>(_list816.size);
                @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> _elem817;
                for (int _i818 = 0; _i818 < _list816.size; ++_i818)
                {
                  {
                    org.apache.thrift.protocol.TList _list819 = iprot.readListBegin();
                    _elem817 = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list819.size);
                    @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem820;
                    for (int _i821 = 0; _i821 < _list819.size; ++_i821)
                    {
                      _elem820 = new com.starrocks.thrift.TExpr();
                      _elem820.read(iprot);
                      _elem817.add(_elem820);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem817);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<com.starrocks.thrift.TExpr> _iter822 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter822.size()));
              for (com.starrocks.thrift.TExpr _iter823 : _iter822)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<com.starrocks.thrift.TExpr> _iter824 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter824.size()));
              for (com.starrocks.thrift.TExpr _iter825 : _iter824)
              {
  ...
  private static class TExceptNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExceptNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<com.starrocks.thrift.TExpr> _iter826 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter826.size());
            for (com.starrocks.thrift.TExpr _iter827 : _iter826)
            {
      ...
      }
      {
        ...
        for (java.util.List<com.starrocks.thrift.TExpr> _iter828 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter828.size());
            for (com.starrocks.thrift.TExpr _iter829 : _iter828)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTuple_idIsSet(true);
      {
        ...
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<com.starrocks.thrift.TExpr>>(_list830.size);
        @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> _elem831;
        ...
        {
          {
            ...
            _elem831 = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list833.size);
            @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem834;
            for (int _i835 = 0; _i835 < _list833.size; ++_i835)
            {
              _elem834 = new com.starrocks.thrift.TExpr();
              _elem834.read(iprot);
              _elem831.add(_elem834);
            }
          }
          struct.result_expr_lists.add(_elem831);
        }
      }
      struct.setResult_expr_listsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list836 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<com.starrocks.thrift.TExpr>>(_list836.size);
        @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> _elem837;
        ...
        {
          {
            ...
            _elem837 = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list839.size);
            @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem840;
            for (int _i841 = 0; _i841 < _list839.size; ++_i841)
            {
              _elem840 = new com.starrocks.thrift.TExpr();
              _elem840.read(iprot);
              _elem837.add(_elem840);
            }
          }
          struct.const_expr_lists.add(_elem837);
        }
      }
      struct.setConst_expr_listsIsSet(true);
      struct.first_materialized_child_idx = iprot.readI64();
