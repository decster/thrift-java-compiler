...
public class TFileScanNode implements org.apache.thrift.TBase<TFileScanNode, TFileScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TFileScanNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list180.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem181;
                for (int _i182 = 0; _i182 < _list180.size; ++_i182)
                {
                  _elem181 = new com.starrocks.thrift.TExpr();
                  _elem181.read(iprot);
                  struct.partition_exprs.add(_elem181);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_infos = new java.util.ArrayList<com.starrocks.thrift.TRangePartition>(_list183.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRangePartition _elem184;
                for (int _i185 = 0; _i185 < _list183.size; ++_i185)
                {
                  _elem184 = new com.starrocks.thrift.TRangePartition();
                  _elem184.read(iprot);
                  struct.partition_infos.add(_elem184);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter186 : struct.partition_exprs)
            {
      ...
      if (struct.partition_infos != null) {
        if (struct.isSetPartition_infos()) {
          oprot.writeFieldBegin(PARTITION_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRangePartition _iter187 : struct.partition_infos)
            {
  ...
  private static class TFileScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFileScanNode> {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter188 : struct.partition_exprs)
          {
      ...
      if (struct.isSetPartition_infos()) {
        {
          ...
          for (com.starrocks.thrift.TRangePartition _iter189 : struct.partition_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFileScanNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list190 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list190.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem191;
          for (int _i192 = 0; _i192 < _list190.size; ++_i192)
          {
            _elem191 = new com.starrocks.thrift.TExpr();
            _elem191.read(iprot);
            struct.partition_exprs.add(_elem191);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.partition_infos = new java.util.ArrayList<com.starrocks.thrift.TRangePartition>(_list193.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRangePartition _elem194;
          for (int _i195 = 0; _i195 < _list193.size; ++_i195)
          {
            _elem194 = new com.starrocks.thrift.TRangePartition();
            _elem194.read(iprot);
            struct.partition_infos.add(_elem194);
          }
        }
        struct.setPartition_infosIsSet(true);
      }
