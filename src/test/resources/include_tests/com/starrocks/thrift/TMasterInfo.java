...
public class TMasterInfo implements org.apache.thrift.TBase<TMasterInfo, TMasterInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TMasterInfo> {
  ...
  private static final org.apache.thrift.protocol.TField ENCRYPTED_FIELD_DESC = new org.apache.thrift.protocol.TField("encrypted", org.apache.thrift.protocol.TType.BOOL, (short)13);
  private static final org.apache.thrift.protocol.TField STOP_REGULAR_TABLET_REPORT_FIELD_DESC = new org.apache.thrift.protocol.TField("stop_regular_tablet_report", org.apache.thrift.protocol.TType.BOOL, (short)14);
  private static final org.apache.thrift.protocol.TField NODE_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("node_type", org.apache.thrift.protocol.TType.I32, (short)15);
  ...
  public boolean stop_regular_tablet_report; // optional
  /**
   * 
   * @see com.starrocks.thrift.TNodeType
   */
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNodeType node_type; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ENCRYPTED((short)13, "encrypted"),
    STOP_REGULAR_TABLET_REPORT((short)14, "stop_regular_tablet_report"),
    /**
     * 
     * @see com.starrocks.thrift.TNodeType
     */
    NODE_TYPE((short)15, "node_type");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 13: // ENCRYPTED
          return ENCRYPTED;
        case 14: // STOP_REGULAR_TABLET_REPORT
          return STOP_REGULAR_TABLET_REPORT;
        case 15: // NODE_TYPE
          return NODE_TYPE;
        default:
          return null;
  ...
  private static final int __ENCRYPTED_ISSET_ID = 6;
  private static final int __STOP_REGULAR_TABLET_REPORT_ISSET_ID = 7;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.CLUSTER_ID,_Fields.TOKEN,_Fields.BACKEND_IP,_Fields.HTTP_PORT,_Fields.HEARTBEAT_FLAGS,_Fields.BACKEND_ID,_Fields.MIN_ACTIVE_TXN_ID,_Fields.RUN_MODE,_Fields.DISABLED_DISKS,_Fields.DECOMMISSIONED_DISKS,_Fields.ENCRYPTED,_Fields.STOP_REGULAR_TABLET_REPORT,_Fields.NODE_TYPE};
  ...
  static {
    ...
    tmpMap.put(_Fields.STOP_REGULAR_TABLET_REPORT, new org.apache.thrift.meta_data.FieldMetaData("stop_regular_tablet_report", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.NODE_TYPE, new org.apache.thrift.meta_data.FieldMetaData("node_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, com.starrocks.thrift.TNodeType.class)));
  ...
  public TMasterInfo(TMasterInfo other) {
    ...
    this.stop_regular_tablet_report = other.stop_regular_tablet_report;
  ...
  public void clear() {
    ...
    setStop_regular_tablet_reportIsSet(false);
    this.stop_regular_tablet_report = false;
    this.node_type = null;
  }
  ...
  public TMasterInfo setEncrypted(boolean encrypted) {
  ...
  public boolean isStop_regular_tablet_report() {
    return this.stop_regular_tablet_report;
  }

  public TMasterInfo setStop_regular_tablet_report(boolean stop_regular_tablet_report) {
    this.stop_regular_tablet_report = stop_regular_tablet_report;
    setStop_regular_tablet_reportIsSet(true);
    return this;
  }

  public void unsetStop_regular_tablet_report() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __STOP_REGULAR_TABLET_REPORT_ISSET_ID);
  }

  /** Returns true if field stop_regular_tablet_report is set (has been assigned a value) and false otherwise */
  public boolean isSetStop_regular_tablet_report() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __STOP_REGULAR_TABLET_REPORT_ISSET_ID);
  }

  public void setStop_regular_tablet_reportIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __STOP_REGULAR_TABLET_REPORT_ISSET_ID, value);
  }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TNodeType getNode_type() {
   ...
   * @see com.starrocks.thrift.TNodeType
   */
  public TMasterInfo setNode_type(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNodeType node_type) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STOP_REGULAR_TABLET_REPORT:
      if (value == null) {
        unsetStop_regular_tablet_report();
      } else {
        setStop_regular_tablet_report((java.lang.Boolean)value);
      }
      break;
    ...
    case NODE_TYPE:
      if (value == null) {
        ...
        setNode_type((com.starrocks.thrift.TNodeType)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case STOP_REGULAR_TABLET_REPORT:
      return isStop_regular_tablet_report();
  ...
  public boolean isSet(_Fields field) {
    ...
    case STOP_REGULAR_TABLET_REPORT:
      return isSetStop_regular_tablet_report();
    case NODE_TYPE:
  ...
  public boolean equals(TMasterInfo that) {
    ...
    boolean this_present_stop_regular_tablet_report = true && this.isSetStop_regular_tablet_report();
    boolean that_present_stop_regular_tablet_report = true && that.isSetStop_regular_tablet_report();
    if (this_present_stop_regular_tablet_report || that_present_stop_regular_tablet_report) {
      if (!(this_present_stop_regular_tablet_report && that_present_stop_regular_tablet_report))
        return false;
      if (this.stop_regular_tablet_report != that.stop_regular_tablet_report)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetStop_regular_tablet_report()) ? 131071 : 524287);
    if (isSetStop_regular_tablet_report())
      hashCode = hashCode * 8191 + ((stop_regular_tablet_report) ? 131071 : 524287);
  ...
  public int compareTo(TMasterInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStop_regular_tablet_report(), other.isSetStop_regular_tablet_report());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStop_regular_tablet_report()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stop_regular_tablet_report, other.stop_regular_tablet_report);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetStop_regular_tablet_report()) {
      if (!first) sb.append(", ");
      sb.append("stop_regular_tablet_report:");
      sb.append(this.stop_regular_tablet_report);
      first = false;
    }
    if (isSetNode_type()) {
      if (!first) sb.append(", ");
  ...
  private static class TMasterInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMasterInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TMasterInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 14: // STOP_REGULAR_TABLET_REPORT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.stop_regular_tablet_report = iprot.readBool();
              struct.setStop_regular_tablet_reportIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 15: // NODE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.node_type = com.starrocks.thrift.TNodeType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMasterInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetStop_regular_tablet_report()) {
        oprot.writeFieldBegin(STOP_REGULAR_TABLET_REPORT_FIELD_DESC);
        oprot.writeBool(struct.stop_regular_tablet_report);
        oprot.writeFieldEnd();
      }
