...
public class TColumnAccessPath implements org.apache.thrift.TBase<TColumnAccessPath, TColumnAccessPath._Fields>, java.io.Serializable, Cloneable, Comparable<TColumnAccessPath> {
  ...
  private static final org.apache.thrift.protocol.TField TYPE_DESC_FIELD_DESC = new org.apache.thrift.protocol.TField("type_desc", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  private static final _Fields optionals[] = {_Fields.TYPE,_Fields.PATH,_Fields.CHILDREN,_Fields.FROM_PREDICATE,_Fields.TYPE_DESC};
  ...
  public TColumnAccessPath setType_desc(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTypeDesc type_desc) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.children = new java.util.ArrayList<TColumnAccessPath>(_list234.size);
                @org.apache.thrift.annotation.Nullable TColumnAccessPath _elem235;
                for (int _i236 = 0; _i236 < _list234.size; ++_i236)
                {
                  _elem235 = new TColumnAccessPath();
                  _elem235.read(iprot);
                  struct.children.add(_elem235);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.children != null) {
        if (struct.isSetChildren()) {
          oprot.writeFieldBegin(CHILDREN_FIELD_DESC);
          {
            ...
            for (TColumnAccessPath _iter237 : struct.children)
            {
      ...
      if (struct.isSetChildren()) {
        {
          ...
          for (TColumnAccessPath _iter238 : struct.children)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.children = new java.util.ArrayList<TColumnAccessPath>(_list239.size);
          @org.apache.thrift.annotation.Nullable TColumnAccessPath _elem240;
          for (int _i241 = 0; _i241 < _list239.size; ++_i241)
          {
            _elem240 = new TColumnAccessPath();
            _elem240.read(iprot);
            struct.children.add(_elem240);
          }
        }
        struct.setChildrenIsSet(true);
      }
