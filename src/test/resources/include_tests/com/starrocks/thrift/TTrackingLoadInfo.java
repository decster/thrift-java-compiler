      ...
      if (struct.urls != null) {
        if (struct.isSetUrls()) {
          oprot.writeFieldBegin(URLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter151 : struct.urls)
            {
      ...
      if (struct.isSetUrls()) {
        {
          ...
          for (java.lang.String _iter152 : struct.urls)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.urls = new java.util.ArrayList<java.lang.String>(_list153.size);
