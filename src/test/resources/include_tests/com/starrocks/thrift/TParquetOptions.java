...
public class TParquetOptions implements org.apache.thrift.TBase<TParquetOptions, TParquetOptions._Fields>, java.io.Serializable, Cloneable, Comparable<TParquetOptions> {
   ...
   * @see com.starrocks.thrift.TCompressionType
   */
  public TParquetOptions setCompression_type(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TCompressionType compression_type) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PARQUET_MAX_GROUP_BYTES:
      if (value == null) {
        ...
        setParquet_max_group_bytes((java.lang.Long)value);
      }
      break;
    ...
    case USE_DICT:
      if (value == null) {
        ...
        setUse_dict((java.lang.Boolean)value);
      }
      break;
  ...
  public int compareTo(TParquetOptions other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetParquet_max_group_bytes(), other.isSetParquet_max_group_bytes());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUse_dict(), other.isSetUse_dict());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUse_dict()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TParquetOptions(");
    boolean first = true;
