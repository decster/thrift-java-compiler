...
public class TTabletReplicationInfo implements org.apache.thrift.TBase<TTabletReplicationInfo, TTabletReplicationInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TTabletReplicationInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replica_replication_infos = new java.util.ArrayList<TReplicaReplicationInfo>(_list816.size);
                @org.apache.thrift.annotation.Nullable TReplicaReplicationInfo _elem817;
                for (int _i818 = 0; _i818 < _list816.size; ++_i818)
                {
                  _elem817 = new TReplicaReplicationInfo();
                  _elem817.read(iprot);
                  struct.replica_replication_infos.add(_elem817);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replica_replication_infos != null) {
        if (struct.isSetReplica_replication_infos()) {
          oprot.writeFieldBegin(REPLICA_REPLICATION_INFOS_FIELD_DESC);
          {
            ...
            for (TReplicaReplicationInfo _iter819 : struct.replica_replication_infos)
            {
  ...
  private static class TTabletReplicationInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTabletReplicationInfo> {
      ...
      if (struct.isSetReplica_replication_infos()) {
        {
          ...
          for (TReplicaReplicationInfo _iter820 : struct.replica_replication_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTabletReplicationInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list821 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.replica_replication_infos = new java.util.ArrayList<TReplicaReplicationInfo>(_list821.size);
          @org.apache.thrift.annotation.Nullable TReplicaReplicationInfo _elem822;
          for (int _i823 = 0; _i823 < _list821.size; ++_i823)
          {
            _elem822 = new TReplicaReplicationInfo();
            _elem822.read(iprot);
            struct.replica_replication_infos.add(_elem822);
          }
        }
        struct.setReplica_replication_infosIsSet(true);
      }
