...
public class TRemoteSnapshotRequest implements org.apache.thrift.TBase<TRemoteSnapshotRequest, TRemoteSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TRemoteSnapshotRequest> {
  ...
  private static final int __DATA_VERSION_ISSET_ID = 10;
  private short __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TRANSACTION_ID,_Fields.TABLE_ID,_Fields.PARTITION_ID,_Fields.TABLET_ID,_Fields.TABLET_TYPE,_Fields.SCHEMA_HASH,_Fields.VISIBLE_VERSION,_Fields.SRC_TOKEN,_Fields.SRC_TABLET_ID,_Fields.SRC_TABLET_TYPE,_Fields.SRC_SCHEMA_HASH,_Fields.SRC_VISIBLE_VERSION,_Fields.SRC_BACKENDS,_Fields.TIMEOUT_SEC,_Fields.DATA_VERSION};
  ...
  public TRemoteSnapshotRequest setData_version(long data_version) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.src_backends = new java.util.ArrayList<com.starrocks.thrift.TBackend>(_list198.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TBackend _elem199;
                for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                {
                  _elem199 = new com.starrocks.thrift.TBackend();
                  _elem199.read(iprot);
                  struct.src_backends.add(_elem199);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.src_backends != null) {
        if (struct.isSetSrc_backends()) {
          oprot.writeFieldBegin(SRC_BACKENDS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TBackend _iter201 : struct.src_backends)
            {
      ...
      if (struct.isSetSrc_backends()) {
        {
          ...
          for (com.starrocks.thrift.TBackend _iter202 : struct.src_backends)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.src_backends = new java.util.ArrayList<com.starrocks.thrift.TBackend>(_list203.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TBackend _elem204;
          for (int _i205 = 0; _i205 < _list203.size; ++_i205)
          {
            _elem204 = new com.starrocks.thrift.TBackend();
            _elem204.read(iprot);
            struct.src_backends.add(_elem204);
          }
        }
        struct.setSrc_backendsIsSet(true);
      }
