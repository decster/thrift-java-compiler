...
public class TPlanFragmentDestination implements org.apache.thrift.TBase<TPlanFragmentDestination, TPlanFragmentDestination._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanFragmentDestination> {
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress deprecated_server; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress brpc_server; // optional
  ...
  public TPlanFragmentDestination(TPlanFragmentDestination other) {
    ...
    if (other.isSetDeprecated_server()) {
      this.deprecated_server = new com.starrocks.thrift.TNetworkAddress(other.deprecated_server);
    }
    if (other.isSetBrpc_server()) {
      this.brpc_server = new com.starrocks.thrift.TNetworkAddress(other.brpc_server);
    }
  ...
  public TPlanFragmentDestination setFragment_instance_id(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TUniqueId fragment_instance_id) {
    this.fragment_instance_id = fragment_instance_id;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TNetworkAddress getDeprecated_server() {
    return this.deprecated_server;
  }

  public TPlanFragmentDestination setDeprecated_server(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress deprecated_server) {
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TNetworkAddress getBrpc_server() {
    return this.brpc_server;
  }

  public TPlanFragmentDestination setBrpc_server(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress brpc_server) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DEPRECATED_SERVER:
      if (value == null) {
        ...
        setDeprecated_server((com.starrocks.thrift.TNetworkAddress)value);
      }
      break;
    ...
    case BRPC_SERVER:
      if (value == null) {
        ...
        setBrpc_server((com.starrocks.thrift.TNetworkAddress)value);
      }
      break;
    ...
    case PIPELINE_DRIVER_SEQUENCE:
      if (value == null) {
        ...
        setPipeline_driver_sequence((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(TPlanFragmentDestination other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDeprecated_server(), other.isSetDeprecated_server());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeprecated_server()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBrpc_server(), other.isSetBrpc_server());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBrpc_server()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPipeline_driver_sequence(), other.isSetPipeline_driver_sequence());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPipeline_driver_sequence()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPlanFragmentDestination struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // DEPRECATED_SERVER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.deprecated_server = new com.starrocks.thrift.TNetworkAddress();
          ...
          case 3: // BRPC_SERVER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.brpc_server = new com.starrocks.thrift.TNetworkAddress();
