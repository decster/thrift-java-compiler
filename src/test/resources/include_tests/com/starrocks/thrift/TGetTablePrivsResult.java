            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_privs = new java.util.ArrayList<TTablePrivDesc>(_list398.size);
                @org.apache.thrift.annotation.Nullable TTablePrivDesc _elem399;
                for (int _i400 = 0; _i400 < _list398.size; ++_i400)
                {
                  _elem399 = new TTablePrivDesc();
                  _elem399.read(iprot);
                  struct.table_privs.add(_elem399);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_privs != null) {
        if (struct.isSetTable_privs()) {
          oprot.writeFieldBegin(TABLE_PRIVS_FIELD_DESC);
          {
            ...
            for (TTablePrivDesc _iter401 : struct.table_privs)
            {
      ...
      if (struct.isSetTable_privs()) {
        {
          ...
          for (TTablePrivDesc _iter402 : struct.table_privs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.table_privs = new java.util.ArrayList<TTablePrivDesc>(_list403.size);
          @org.apache.thrift.annotation.Nullable TTablePrivDesc _elem404;
          for (int _i405 = 0; _i405 < _list403.size; ++_i405)
          {
            _elem404 = new TTablePrivDesc();
            _elem404.read(iprot);
            struct.table_privs.add(_elem404);
          }
        }
        struct.setTable_privsIsSet(true);
      }
