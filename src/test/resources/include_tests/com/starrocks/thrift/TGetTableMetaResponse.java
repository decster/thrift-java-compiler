            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.backends = new java.util.ArrayList<TBackendMeta>(_list544.size);
                @org.apache.thrift.annotation.Nullable TBackendMeta _elem545;
                for (int _i546 = 0; _i546 < _list544.size; ++_i546)
                {
                  _elem545 = new TBackendMeta();
                  _elem545.read(iprot);
                  struct.backends.add(_elem545);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.backends != null) {
        if (struct.isSetBackends()) {
          oprot.writeFieldBegin(BACKENDS_FIELD_DESC);
          {
            ...
            for (TBackendMeta _iter547 : struct.backends)
            {
      ...
      if (struct.isSetBackends()) {
        {
          ...
          for (TBackendMeta _iter548 : struct.backends)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.backends = new java.util.ArrayList<TBackendMeta>(_list549.size);
          @org.apache.thrift.annotation.Nullable TBackendMeta _elem550;
          for (int _i551 = 0; _i551 < _list549.size; ++_i551)
          {
            _elem550 = new TBackendMeta();
            _elem550.read(iprot);
            struct.backends.add(_elem550);
          }
        }
        struct.setBackendsIsSet(true);
      }
