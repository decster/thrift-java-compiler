...
public class THudiTable implements org.apache.thrift.TBase<THudiTable, THudiTable._Fields>, java.io.Serializable, Cloneable, Comparable<THudiTable> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumn>(_list330.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem331;
                for (int _i332 = 0; _i332 < _list330.size; ++_i332)
                {
                  _elem331 = new TColumn();
                  _elem331.read(iprot);
                  struct.columns.add(_elem331);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_columns = new java.util.ArrayList<TColumn>(_list333.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem334;
                for (int _i335 = 0; _i335 < _list333.size; ++_i335)
                {
                  _elem334 = new TColumn();
                  _elem334.read(iprot);
                  struct.partition_columns.add(_elem334);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map336.size);
                long _key337;
                @org.apache.thrift.annotation.Nullable THdfsPartition _val338;
                for (int _i339 = 0; _i339 < _map336.size; ++_i339)
                {
                  _key337 = iprot.readI64();
                  _val338 = new THdfsPartition();
                  _val338.read(iprot);
                  struct.partitions.put(_key337, _val338);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list340.size);
                ...
                for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                {
                  ...
                  struct.partition_prefixes.add(_elem341);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter343 : struct.columns)
            {
      ...
      if (struct.partition_columns != null) {
        if (struct.isSetPartition_columns()) {
          oprot.writeFieldBegin(PARTITION_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter344 : struct.partition_columns)
            {
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter345 : struct.partitions.entrySet())
            {
      ...
      if (struct.partition_prefixes != null) {
        if (struct.isSetPartition_prefixes()) {
          oprot.writeFieldBegin(PARTITION_PREFIXES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter346 : struct.partition_prefixes)
            {
  ...
  private static class THudiTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<THudiTable> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumn _iter347 : struct.columns)
          {
      ...
      if (struct.isSetPartition_columns()) {
        {
          ...
          for (TColumn _iter348 : struct.partition_columns)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter349 : struct.partitions.entrySet())
          {
      ...
      if (struct.isSetPartition_prefixes()) {
        {
          ...
          for (java.lang.String _iter350 : struct.partition_prefixes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THudiTable struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumn>(_list351.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem352;
          for (int _i353 = 0; _i353 < _list351.size; ++_i353)
          {
            _elem352 = new TColumn();
            _elem352.read(iprot);
            struct.columns.add(_elem352);
          }
        }
        struct.setColumnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list354 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.partition_columns = new java.util.ArrayList<TColumn>(_list354.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem355;
          for (int _i356 = 0; _i356 < _list354.size; ++_i356)
          {
            _elem355 = new TColumn();
            _elem355.read(iprot);
            struct.partition_columns.add(_elem355);
          }
        }
        struct.setPartition_columnsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map357 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map357.size);
          long _key358;
          @org.apache.thrift.annotation.Nullable THdfsPartition _val359;
          for (int _i360 = 0; _i360 < _map357.size; ++_i360)
          {
            _key358 = iprot.readI64();
            _val359 = new THdfsPartition();
            _val359.read(iprot);
            struct.partitions.put(_key358, _val359);
          }
        }
        struct.setPartitionsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list361 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list361.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem362;
          for (int _i363 = 0; _i363 < _list361.size; ++_i363)
          {
            _elem362 = iprot.readString();
            struct.partition_prefixes.add(_elem362);
          }
        }
        struct.setPartition_prefixesIsSet(true);
      }
