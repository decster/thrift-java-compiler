...
public class TPaimonTable implements org.apache.thrift.TBase<TPaimonTable, TPaimonTable._Fields>, java.io.Serializable, Cloneable, Comparable<TPaimonTable> {
  ...
  private static final org.apache.thrift.protocol.TField PAIMON_SCHEMA_FIELD_DESC = new org.apache.thrift.protocol.TField("paimon_schema", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable TIcebergSchema paimon_schema; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PAIMON_SCHEMA((short)4, "paimon_schema");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // TIME_ZONE
          return TIME_ZONE;
        case 4: // PAIMON_SCHEMA
          return PAIMON_SCHEMA;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.PAIMON_OPTIONS,_Fields.PAIMON_NATIVE_TABLE,_Fields.TIME_ZONE,_Fields.PAIMON_SCHEMA};
  ...
  static {
    ...
    tmpMap.put(_Fields.TIME_ZONE, new org.apache.thrift.meta_data.FieldMetaData("time_zone", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PAIMON_SCHEMA, new org.apache.thrift.meta_data.FieldMetaData("paimon_schema", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TPaimonTable(TPaimonTable other) {
    ...
    if (other.isSetPaimon_schema()) {
      this.paimon_schema = new TIcebergSchema(other.paimon_schema);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TIcebergSchema getPaimon_schema() {
    return this.paimon_schema;
  }

  public TPaimonTable setPaimon_schema(@org.apache.thrift.annotation.Nullable TIcebergSchema paimon_schema) {
    this.paimon_schema = paimon_schema;
    return this;
  }

  public void unsetPaimon_schema() {
    this.paimon_schema = null;
  }

  /** Returns true if field paimon_schema is set (has been assigned a value) and false otherwise */
  public boolean isSetPaimon_schema() {
    return this.paimon_schema != null;
  }

  public void setPaimon_schemaIsSet(boolean value) {
    if (!value) {
      this.paimon_schema = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PAIMON_SCHEMA:
      if (value == null) {
        ...
        setPaimon_schema((TIcebergSchema)value);
      }
      break;
  ...
  public boolean equals(TPaimonTable that) {
    ...
    boolean this_present_paimon_schema = true && this.isSetPaimon_schema();
    boolean that_present_paimon_schema = true && that.isSetPaimon_schema();
    if (this_present_paimon_schema || that_present_paimon_schema) {
      if (!(this_present_paimon_schema && that_present_paimon_schema))
        return false;
      if (!this.paimon_schema.equals(that.paimon_schema))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPaimon_schema()) ? 131071 : 524287);
    if (isSetPaimon_schema())
      hashCode = hashCode * 8191 + paimon_schema.hashCode();
  ...
  public int compareTo(TPaimonTable other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPaimon_schema(), other.isSetPaimon_schema());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPaimon_schema()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.paimon_schema, other.paimon_schema);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetPaimon_schema()) {
      if (!first) sb.append(", ");
      sb.append("paimon_schema:");
      if (this.paimon_schema == null) {
        sb.append("null");
      } else {
        sb.append(this.paimon_schema);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (paimon_schema != null) {
      paimon_schema.validate();
    }
  }
  ...
  private static class TPaimonTableStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPaimonTable> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // PAIMON_SCHEMA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.paimon_schema = new TIcebergSchema();
              struct.paimon_schema.read(iprot);
              struct.setPaimon_schemaIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPaimonTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.paimon_schema != null) {
        if (struct.isSetPaimon_schema()) {
          oprot.writeFieldBegin(PAIMON_SCHEMA_FIELD_DESC);
          struct.paimon_schema.write(oprot);
          oprot.writeFieldEnd();
        }
      }
