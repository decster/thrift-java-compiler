...
public class TRuntimeFilterParams implements org.apache.thrift.TBase<TRuntimeFilterParams, TRuntimeFilterParams._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeFilterParams> {
  ...
  private static final org.apache.thrift.protocol.TField SKEW_JOIN_RUNTIME_FILTERS_FIELD_DESC = new org.apache.thrift.protocol.TField("skew_join_runtime_filters", org.apache.thrift.protocol.TType.SET, (short)5);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> skew_join_runtime_filters; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SKEW_JOIN_RUNTIME_FILTERS((short)5, "skew_join_runtime_filters");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // SKEW_JOIN_RUNTIME_FILTERS
          return SKEW_JOIN_RUNTIME_FILTERS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.ID_TO_PROBER_PARAMS,_Fields.RUNTIME_FILTER_BUILDER_NUMBER,_Fields.RUNTIME_FILTER_MAX_SIZE,_Fields.SKEW_JOIN_RUNTIME_FILTERS};
  ...
  static {
    ...
    tmpMap.put(_Fields.SKEW_JOIN_RUNTIME_FILTERS, new org.apache.thrift.meta_data.FieldMetaData("skew_join_runtime_filters", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TRuntimeFilterParams(TRuntimeFilterParams other) {
    ...
    if (other.isSetSkew_join_runtime_filters()) {
      java.util.Set<java.lang.Integer> __this__skew_join_runtime_filters = new java.util.HashSet<java.lang.Integer>(other.skew_join_runtime_filters);
      this.skew_join_runtime_filters = __this__skew_join_runtime_filters;
    }
  }
  ...
  public void clear() {
    ...
    this.skew_join_runtime_filters = null;
  }
  ...
  public int getSkew_join_runtime_filtersSize() {
    return (this.skew_join_runtime_filters == null) ? 0 : this.skew_join_runtime_filters.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Integer> getSkew_join_runtime_filtersIterator() {
    return (this.skew_join_runtime_filters == null) ? null : this.skew_join_runtime_filters.iterator();
  }

  public void addToSkew_join_runtime_filters(int elem) {
    if (this.skew_join_runtime_filters == null) {
      this.skew_join_runtime_filters = new java.util.HashSet<java.lang.Integer>();
    }
    this.skew_join_runtime_filters.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Set<java.lang.Integer> getSkew_join_runtime_filters() {
    return this.skew_join_runtime_filters;
  }

  public TRuntimeFilterParams setSkew_join_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> skew_join_runtime_filters) {
    this.skew_join_runtime_filters = skew_join_runtime_filters;
    return this;
  }

  public void unsetSkew_join_runtime_filters() {
    this.skew_join_runtime_filters = null;
  }

  /** Returns true if field skew_join_runtime_filters is set (has been assigned a value) and false otherwise */
  public boolean isSetSkew_join_runtime_filters() {
    return this.skew_join_runtime_filters != null;
  }

  public void setSkew_join_runtime_filtersIsSet(boolean value) {
    if (!value) {
      this.skew_join_runtime_filters = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SKEW_JOIN_RUNTIME_FILTERS:
      if (value == null) {
        unsetSkew_join_runtime_filters();
      } else {
        setSkew_join_runtime_filters((java.util.Set<java.lang.Integer>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case SKEW_JOIN_RUNTIME_FILTERS:
      return getSkew_join_runtime_filters();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SKEW_JOIN_RUNTIME_FILTERS:
      return isSetSkew_join_runtime_filters();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TRuntimeFilterParams that) {
    ...
    boolean this_present_skew_join_runtime_filters = true && this.isSetSkew_join_runtime_filters();
    boolean that_present_skew_join_runtime_filters = true && that.isSetSkew_join_runtime_filters();
    if (this_present_skew_join_runtime_filters || that_present_skew_join_runtime_filters) {
      if (!(this_present_skew_join_runtime_filters && that_present_skew_join_runtime_filters))
        return false;
      if (!this.skew_join_runtime_filters.equals(that.skew_join_runtime_filters))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSkew_join_runtime_filters()) ? 131071 : 524287);
    if (isSetSkew_join_runtime_filters())
      hashCode = hashCode * 8191 + skew_join_runtime_filters.hashCode();
  ...
  public int compareTo(TRuntimeFilterParams other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSkew_join_runtime_filters(), other.isSetSkew_join_runtime_filters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSkew_join_runtime_filters()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.skew_join_runtime_filters, other.skew_join_runtime_filters);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSkew_join_runtime_filters()) {
      if (!first) sb.append(", ");
      sb.append("skew_join_runtime_filters:");
      if (this.skew_join_runtime_filters == null) {
        sb.append("null");
      } else {
        sb.append(this.skew_join_runtime_filters);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TRuntimeFilterParamsStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRuntimeFilterParams> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.skew_join_runtime_filters = new java.util.HashSet<java.lang.Integer>(2*_set103.size);
                int _elem104;
                for (int _i105 = 0; _i105 < _set103.size; ++_i105)
                {
                  _elem104 = iprot.readI32();
                  struct.skew_join_runtime_filters.add(_elem104);
                }
                iprot.readSetEnd();
              }
              struct.setSkew_join_runtime_filtersIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeFilterParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.skew_join_runtime_filters != null) {
        if (struct.isSetSkew_join_runtime_filters()) {
          oprot.writeFieldBegin(SKEW_JOIN_RUNTIME_FILTERS_FIELD_DESC);
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.skew_join_runtime_filters.size()));
            for (int _iter109 : struct.skew_join_runtime_filters)
            {
  ...
  private static class TRuntimeFilterParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRuntimeFilterParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeFilterParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetId_to_prober_params()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<TRuntimeFilterProberParams>> _iter110 : struct.id_to_prober_params.entrySet())
          {
            oprot.writeI32(_iter110.getKey());
            {
              oprot.writeI32(_iter110.getValue().size());
              for (TRuntimeFilterProberParams _iter111 : _iter110.getValue())
              {
      ...
      if (struct.isSetRuntime_filter_builder_number()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter112 : struct.runtime_filter_builder_number.entrySet())
          {
      ...
      if (struct.isSetSkew_join_runtime_filters()) {
        {
          oprot.writeI32(struct.skew_join_runtime_filters.size());
          for (int _iter113 : struct.skew_join_runtime_filters)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeFilterParams struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map114 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.LIST); 
          struct.id_to_prober_params = new java.util.HashMap<java.lang.Integer,java.util.List<TRuntimeFilterProberParams>>(2*_map114.size);
          int _key115;
          @org.apache.thrift.annotation.Nullable java.util.List<TRuntimeFilterProberParams> _val116;
          for (int _i117 = 0; _i117 < _map114.size; ++_i117)
          {
            _key115 = iprot.readI32();
            {
              org.apache.thrift.protocol.TList _list118 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
              _val116 = new java.util.ArrayList<TRuntimeFilterProberParams>(_list118.size);
              @org.apache.thrift.annotation.Nullable TRuntimeFilterProberParams _elem119;
              for (int _i120 = 0; _i120 < _list118.size; ++_i120)
              {
                _elem119 = new TRuntimeFilterProberParams();
                _elem119.read(iprot);
                _val116.add(_elem119);
              }
            }
            struct.id_to_prober_params.put(_key115, _val116);
          }
        }
        struct.setId_to_prober_paramsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map121 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32); 
          struct.runtime_filter_builder_number = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map121.size);
          int _key122;
          int _val123;
          for (int _i124 = 0; _i124 < _map121.size; ++_i124)
          {
            ...
            struct.runtime_filter_builder_number.put(_key122, _val123);
          }
        }
        struct.setRuntime_filter_builder_numberIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.skew_join_runtime_filters = new java.util.HashSet<java.lang.Integer>(2*_set125.size);
          int _elem126;
          for (int _i127 = 0; _i127 < _set125.size; ++_i127)
          {
            _elem126 = iprot.readI32();
            struct.skew_join_runtime_filters.add(_elem126);
          }
        }
        struct.setSkew_join_runtime_filtersIsSet(true);
      }
