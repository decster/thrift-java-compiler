...
public class TFeMemoryRes implements org.apache.thrift.TBase<TFeMemoryRes, TFeMemoryRes._Fields>, java.io.Serializable, Cloneable, Comparable<TFeMemoryRes> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new java.util.ArrayList<TFeMemoryItem>(_list768.size);
                @org.apache.thrift.annotation.Nullable TFeMemoryItem _elem769;
                for (int _i770 = 0; _i770 < _list768.size; ++_i770)
                {
                  _elem769 = new TFeMemoryItem();
                  _elem769.read(iprot);
                  struct.items.add(_elem769);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (TFeMemoryItem _iter771 : struct.items)
            {
  ...
  private static class TFeMemoryResTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFeMemoryRes> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (TFeMemoryItem _iter772 : struct.items)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFeMemoryRes struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list773 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.items = new java.util.ArrayList<TFeMemoryItem>(_list773.size);
          @org.apache.thrift.annotation.Nullable TFeMemoryItem _elem774;
          for (int _i775 = 0; _i775 < _list773.size; ++_i775)
          {
            _elem774 = new TFeMemoryItem();
            _elem774.read(iprot);
            struct.items.add(_elem774);
          }
        }
        struct.setItemsIsSet(true);
      }
