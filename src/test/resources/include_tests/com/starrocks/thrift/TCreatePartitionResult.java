...
public class TCreatePartitionResult implements org.apache.thrift.TBase<TCreatePartitionResult, TCreatePartitionResult._Fields>, java.io.Serializable, Cloneable, Comparable<TCreatePartitionResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<com.starrocks.thrift.TOlapTablePartition>(_list624.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TOlapTablePartition _elem625;
                for (int _i626 = 0; _i626 < _list624.size; ++_i626)
                {
                  _elem625 = new com.starrocks.thrift.TOlapTablePartition();
                  _elem625.read(iprot);
                  struct.partitions.add(_elem625);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<com.starrocks.thrift.TTabletLocation>(_list627.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletLocation _elem628;
                for (int _i629 = 0; _i629 < _list627.size; ++_i629)
                {
                  _elem628 = new com.starrocks.thrift.TTabletLocation();
                  _elem628.read(iprot);
                  struct.tablets.add(_elem628);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new java.util.ArrayList<com.starrocks.thrift.TNodeInfo>(_list630.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNodeInfo _elem631;
                for (int _i632 = 0; _i632 < _list630.size; ++_i632)
                {
                  _elem631 = new com.starrocks.thrift.TNodeInfo();
                  _elem631.read(iprot);
                  struct.nodes.add(_elem631);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TOlapTablePartition _iter633 : struct.partitions)
            {
      ...
      if (struct.tablets != null) {
        if (struct.isSetTablets()) {
          oprot.writeFieldBegin(TABLETS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletLocation _iter634 : struct.tablets)
            {
      ...
      if (struct.nodes != null) {
        if (struct.isSetNodes()) {
          oprot.writeFieldBegin(NODES_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TNodeInfo _iter635 : struct.nodes)
            {
  ...
  private static class TCreatePartitionResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCreatePartitionResult> {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (com.starrocks.thrift.TOlapTablePartition _iter636 : struct.partitions)
          {
      ...
      if (struct.isSetTablets()) {
        {
          ...
          for (com.starrocks.thrift.TTabletLocation _iter637 : struct.tablets)
          {
      ...
      if (struct.isSetNodes()) {
        {
          ...
          for (com.starrocks.thrift.TNodeInfo _iter638 : struct.nodes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCreatePartitionResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<com.starrocks.thrift.TOlapTablePartition>(_list639.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TOlapTablePartition _elem640;
          for (int _i641 = 0; _i641 < _list639.size; ++_i641)
          {
            _elem640 = new com.starrocks.thrift.TOlapTablePartition();
            _elem640.read(iprot);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list642 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.tablets = new java.util.ArrayList<com.starrocks.thrift.TTabletLocation>(_list642.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletLocation _elem643;
          for (int _i644 = 0; _i644 < _list642.size; ++_i644)
          {
            _elem643 = new com.starrocks.thrift.TTabletLocation();
            _elem643.read(iprot);
            struct.tablets.add(_elem643);
          }
        }
        struct.setTabletsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.nodes = new java.util.ArrayList<com.starrocks.thrift.TNodeInfo>(_list645.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNodeInfo _elem646;
          for (int _i647 = 0; _i647 < _list645.size; ++_i647)
          {
            _elem646 = new com.starrocks.thrift.TNodeInfo();
            _elem646.read(iprot);
            struct.nodes.add(_elem646);
          }
        }
        struct.setNodesIsSet(true);
      }
