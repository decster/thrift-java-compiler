...
public class TPlanNode implements org.apache.thrift.TBase<TPlanNode, TPlanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanNode> {
  ...
  private static final org.apache.thrift.protocol.TField SELECT_NODE_FIELD_DESC = new org.apache.thrift.protocol.TField("select_node", org.apache.thrift.protocol.TType.STRUCT, (short)81);
  ...
  public @org.apache.thrift.annotation.Nullable TSelectNode select_node; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SELECT_NODE((short)81, "select_node");
  ...
  static {
    ...
    tmpMap.put(_Fields.SELECT_NODE, new org.apache.thrift.meta_data.FieldMetaData("select_node", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TSelectNode.class)));
  ...
  public TPlanNode(TPlanNode other) {
    ...
    if (other.isSetSelect_node()) {
      this.select_node = new TSelectNode(other.select_node);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TSelectNode getSelect_node() {
    return this.select_node;
  }

  public TPlanNode setSelect_node(@org.apache.thrift.annotation.Nullable TSelectNode select_node) {
    this.select_node = select_node;
    return this;
  }

  public void unsetSelect_node() {
    this.select_node = null;
  }

  /** Returns true if field select_node is set (has been assigned a value) and false otherwise */
  public boolean isSetSelect_node() {
    return this.select_node != null;
  }

  public void setSelect_nodeIsSet(boolean value) {
    if (!value) {
      this.select_node = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SELECT_NODE:
      if (value == null) {
        ...
        setSelect_node((TSelectNode)value);
      }
      break;
  ...
  public boolean equals(TPlanNode that) {
    ...
    boolean this_present_select_node = true && this.isSetSelect_node();
    boolean that_present_select_node = true && that.isSetSelect_node();
    if (this_present_select_node || that_present_select_node) {
      if (!(this_present_select_node && that_present_select_node))
        return false;
      if (!this.select_node.equals(that.select_node))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSelect_node()) ? 131071 : 524287);
    if (isSetSelect_node())
      hashCode = hashCode * 8191 + select_node.hashCode();
  ...
  public int compareTo(TPlanNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSelect_node(), other.isSetSelect_node());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSelect_node()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.select_node, other.select_node);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSelect_node()) {
      if (!first) sb.append(", ");
      sb.append("select_node:");
      if (this.select_node == null) {
        sb.append("null");
      } else {
        sb.append(this.select_node);
      }
      first = false;
    }
    sb.append(")");
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list1066.size);
                int _elem1067;
                for (int _i1068 = 0; _i1068 < _list1066.size; ++_i1068)
                {
                  _elem1067 = iprot.readI32();
                  struct.row_tuples.add(_elem1067);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list1069.size);
                boolean _elem1070;
                for (int _i1071 = 0; _i1071 < _list1069.size; ++_i1071)
                {
                  _elem1070 = iprot.readBool();
                  struct.nullable_tuples.add(_elem1070);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1072.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1073;
                for (int _i1074 = 0; _i1074 < _list1072.size; ++_i1074)
                {
                  _elem1073 = new com.starrocks.thrift.TExpr();
                  _elem1073.read(iprot);
                  struct.conjuncts.add(_elem1073);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.probe_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list1075.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem1076;
                for (int _i1077 = 0; _i1077 < _list1075.size; ++_i1077)
                {
                  _elem1076 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem1076.read(iprot);
                  struct.probe_runtime_filters.add(_elem1076);
                }
                iprot.readListEnd();
              }
          ...
          case 57: // LOCAL_RF_WAITING_SET
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1078 = iprot.readSetBegin();
                struct.local_rf_waiting_set = new java.util.HashSet<java.lang.Integer>(2*_set1078.size);
                int _elem1079;
                for (int _i1080 = 0; _i1080 < _set1078.size; ++_i1080)
                {
                  _elem1079 = iprot.readI32();
                  struct.local_rf_waiting_set.add(_elem1079);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filter_null_value_columns = new java.util.ArrayList<java.lang.Integer>(_list1081.size);
                int _elem1082;
                for (int _i1083 = 0; _i1083 < _list1081.size; ++_i1083)
                {
                  _elem1082 = iprot.readI32();
                  struct.filter_null_value_columns.add(_elem1082);
                }
                iprot.readListEnd();
              }
          ...
          case 81: // SELECT_NODE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.select_node = new TSelectNode();
              struct.select_node.read(iprot);
              struct.setSelect_nodeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.row_tuples != null) {
        oprot.writeFieldBegin(ROW_TUPLES_FIELD_DESC);
        {
          ...
          for (int _iter1084 : struct.row_tuples)
          {
            oprot.writeI32(_iter1084);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.nullable_tuples != null) {
        oprot.writeFieldBegin(NULLABLE_TUPLES_FIELD_DESC);
        {
          ...
          for (boolean _iter1085 : struct.nullable_tuples)
          {
            oprot.writeBool(_iter1085);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.conjuncts != null) {
        if (struct.isSetConjuncts()) {
          oprot.writeFieldBegin(CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter1086 : struct.conjuncts)
            {
      ...
      if (struct.probe_runtime_filters != null) {
        if (struct.isSetProbe_runtime_filters()) {
          oprot.writeFieldBegin(PROBE_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter1087 : struct.probe_runtime_filters)
            {
      ...
      if (struct.local_rf_waiting_set != null) {
        if (struct.isSetLocal_rf_waiting_set()) {
          oprot.writeFieldBegin(LOCAL_RF_WAITING_SET_FIELD_DESC);
          {
            ...
            for (int _iter1088 : struct.local_rf_waiting_set)
            {
              oprot.writeI32(_iter1088);
            }
            oprot.writeSetEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.filter_null_value_columns != null) {
        if (struct.isSetFilter_null_value_columns()) {
          oprot.writeFieldBegin(FILTER_NULL_VALUE_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter1089 : struct.filter_null_value_columns)
            {
              oprot.writeI32(_iter1089);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.select_node != null) {
        if (struct.isSetSelect_node()) {
          oprot.writeFieldBegin(SELECT_NODE_FIELD_DESC);
          struct.select_node.write(oprot);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class TPlanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPlanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.limit);
      {
        ...
        for (int _iter1090 : struct.row_tuples)
        {
          oprot.writeI32(_iter1090);
        }
      }
      {
        oprot.writeI32(struct.nullable_tuples.size());
        for (boolean _iter1091 : struct.nullable_tuples)
        {
          oprot.writeBool(_iter1091);
        }
      }
      oprot.writeBool(struct.compact_data);
      ...
      if (struct.isSetConjuncts()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter1092 : struct.conjuncts)
          {
      ...
      if (struct.isSetProbe_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter1093 : struct.probe_runtime_filters)
          {
      ...
      if (struct.isSetLocal_rf_waiting_set()) {
        {
          ...
          for (int _iter1094 : struct.local_rf_waiting_set)
          {
            oprot.writeI32(_iter1094);
          }
        }
      }
      if (struct.isSetFilter_null_value_columns()) {
        {
          ...
          for (int _iter1095 : struct.filter_null_value_columns)
          {
            oprot.writeI32(_iter1095);
          }
        }
      }
      if (struct.isSetNeed_create_tuple_columns()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setLimitIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1096 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list1096.size);
        int _elem1097;
        for (int _i1098 = 0; _i1098 < _list1096.size; ++_i1098)
        {
          _elem1097 = iprot.readI32();
          struct.row_tuples.add(_elem1097);
        }
      }
      struct.setRow_tuplesIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1099 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list1099.size);
        boolean _elem1100;
        for (int _i1101 = 0; _i1101 < _list1099.size; ++_i1101)
        {
          _elem1100 = iprot.readBool();
          struct.nullable_tuples.add(_elem1100);
        }
      }
      struct.setNullable_tuplesIsSet(true);
      struct.compact_data = iprot.readBool();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1102 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1102.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1103;
          for (int _i1104 = 0; _i1104 < _list1102.size; ++_i1104)
          {
            _elem1103 = new com.starrocks.thrift.TExpr();
            _elem1103.read(iprot);
            struct.conjuncts.add(_elem1103);
          }
        }
        struct.setConjunctsIsSet(true);
      }
      ...
      if (incoming.get(24)) {
        {
          org.apache.thrift.protocol.TList _list1105 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.probe_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list1105.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem1106;
          for (int _i1107 = 0; _i1107 < _list1105.size; ++_i1107)
          {
            _elem1106 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem1106.read(iprot);
            struct.probe_runtime_filters.add(_elem1106);
          }
        }
        struct.setProbe_runtime_filtersIsSet(true);
      }
      ...
      if (incoming.get(26)) {
        {
          org.apache.thrift.protocol.TSet _set1108 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
          struct.local_rf_waiting_set = new java.util.HashSet<java.lang.Integer>(2*_set1108.size);
          int _elem1109;
          for (int _i1110 = 0; _i1110 < _set1108.size; ++_i1110)
          {
            _elem1109 = iprot.readI32();
            struct.local_rf_waiting_set.add(_elem1109);
          }
        }
        struct.setLocal_rf_waiting_setIsSet(true);
      }
      if (incoming.get(27)) {
        {
          org.apache.thrift.protocol.TList _list1111 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.filter_null_value_columns = new java.util.ArrayList<java.lang.Integer>(_list1111.size);
          int _elem1112;
          for (int _i1113 = 0; _i1113 < _list1111.size; ++_i1113)
          {
            _elem1112 = iprot.readI32();
            struct.filter_null_value_columns.add(_elem1112);
          }
        }
        struct.setFilter_null_value_columnsIsSet(true);
      }
