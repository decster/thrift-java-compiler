...
public class TRangePartitionDesc implements org.apache.thrift.TBase<TRangePartitionDesc, TRangePartitionDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TRangePartitionDesc> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumnMeta>(_list476.size);
                @org.apache.thrift.annotation.Nullable TColumnMeta _elem477;
                for (int _i478 = 0; _i478 < _list476.size; ++_i478)
                {
                  _elem477 = new TColumnMeta();
                  _elem477.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ranges = new java.util.HashMap<java.lang.Long,TRange>(2*_map479.size);
                long _key480;
                @org.apache.thrift.annotation.Nullable TRange _val481;
                for (int _i482 = 0; _i482 < _map479.size; ++_i482)
                {
                  _key480 = iprot.readI64();
                  _val481 = new TRange();
                  _val481.read(iprot);
                  struct.ranges.put(_key480, _val481);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnMeta _iter483 : struct.columns)
            {
      ...
      if (struct.ranges != null) {
        if (struct.isSetRanges()) {
          oprot.writeFieldBegin(RANGES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, TRange> _iter484 : struct.ranges.entrySet())
            {
              oprot.writeI64(_iter484.getKey());
              _iter484.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TRangePartitionDescTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRangePartitionDesc> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumnMeta _iter485 : struct.columns)
          {
      ...
      if (struct.isSetRanges()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TRange> _iter486 : struct.ranges.entrySet())
          {
            oprot.writeI64(_iter486.getKey());
            _iter486.getValue().write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRangePartitionDesc struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumnMeta>(_list487.size);
          @org.apache.thrift.annotation.Nullable TColumnMeta _elem488;
          for (int _i489 = 0; _i489 < _list487.size; ++_i489)
          {
            _elem488 = new TColumnMeta();
            _elem488.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map490 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.ranges = new java.util.HashMap<java.lang.Long,TRange>(2*_map490.size);
          long _key491;
          @org.apache.thrift.annotation.Nullable TRange _val492;
          for (int _i493 = 0; _i493 < _map490.size; ++_i493)
          {
            _key491 = iprot.readI64();
            _val492 = new TRange();
            _val492.read(iprot);
            struct.ranges.put(_key491, _val492);
          }
        }
        struct.setRangesIsSet(true);
      }
