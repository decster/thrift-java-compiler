...
public class TTableMeta implements org.apache.thrift.TBase<TTableMeta, TTableMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TTableMeta> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map502.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key503;
                @org.apache.thrift.annotation.Nullable java.lang.String _val504;
                for (int _i505 = 0; _i505 < _map502.size; ++_i505)
                {
                  _key503 = iprot.readString();
                  _val504 = iprot.readString();
                  struct.properties.put(_key503, _val504);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes = new java.util.ArrayList<TIndexMeta>(_list506.size);
                @org.apache.thrift.annotation.Nullable TIndexMeta _elem507;
                for (int _i508 = 0; _i508 < _list506.size; ++_i508)
                {
                  _elem507 = new TIndexMeta();
                  _elem507.read(iprot);
                  struct.indexes.add(_elem507);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<TPartitionMeta>(_list509.size);
                @org.apache.thrift.annotation.Nullable TPartitionMeta _elem510;
                for (int _i511 = 0; _i511 < _list509.size; ++_i511)
                {
                  _elem510 = new TPartitionMeta();
                  _elem510.read(iprot);
                  struct.partitions.add(_elem510);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.index_infos = new java.util.ArrayList<TIndexInfo>(_list512.size);
                @org.apache.thrift.annotation.Nullable TIndexInfo _elem513;
                for (int _i514 = 0; _i514 < _list512.size; ++_i514)
                {
                  _elem513 = new TIndexInfo();
                  _elem513.read(iprot);
                  struct.index_infos.add(_elem513);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bloomfilter_columns = new java.util.ArrayList<java.lang.String>(_list515.size);
                ...
                for (int _i517 = 0; _i517 < _list515.size; ++_i517)
                {
                  ...
                  struct.bloomfilter_columns.add(_elem516);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter518 : struct.properties.entrySet())
            {
      ...
      if (struct.indexes != null) {
        if (struct.isSetIndexes()) {
          oprot.writeFieldBegin(INDEXES_FIELD_DESC);
          {
            ...
            for (TIndexMeta _iter519 : struct.indexes)
            {
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (TPartitionMeta _iter520 : struct.partitions)
            {
      ...
      if (struct.index_infos != null) {
        if (struct.isSetIndex_infos()) {
          oprot.writeFieldBegin(INDEX_INFOS_FIELD_DESC);
          {
            ...
            for (TIndexInfo _iter521 : struct.index_infos)
            {
      ...
      if (struct.bloomfilter_columns != null) {
        if (struct.isSetBloomfilter_columns()) {
          oprot.writeFieldBegin(BLOOMFILTER_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter522 : struct.bloomfilter_columns)
            {
  ...
  private static class TTableMetaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableMeta> {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter523 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetIndexes()) {
        {
          ...
          for (TIndexMeta _iter524 : struct.indexes)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (TPartitionMeta _iter525 : struct.partitions)
          {
      ...
      if (struct.isSetIndex_infos()) {
        {
          ...
          for (TIndexInfo _iter526 : struct.index_infos)
          {
      ...
      if (struct.isSetBloomfilter_columns()) {
        {
          ...
          for (java.lang.String _iter527 : struct.bloomfilter_columns)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableMeta struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TMap _map528 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map528.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key529;
          @org.apache.thrift.annotation.Nullable java.lang.String _val530;
          for (int _i531 = 0; _i531 < _map528.size; ++_i531)
          {
            _key529 = iprot.readString();
            _val530 = iprot.readString();
            struct.properties.put(_key529, _val530);
          }
        }
        struct.setPropertiesIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.indexes = new java.util.ArrayList<TIndexMeta>(_list532.size);
          @org.apache.thrift.annotation.Nullable TIndexMeta _elem533;
          for (int _i534 = 0; _i534 < _list532.size; ++_i534)
          {
            _elem533 = new TIndexMeta();
            _elem533.read(iprot);
            struct.indexes.add(_elem533);
          }
        }
        struct.setIndexesIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<TPartitionMeta>(_list535.size);
          @org.apache.thrift.annotation.Nullable TPartitionMeta _elem536;
          for (int _i537 = 0; _i537 < _list535.size; ++_i537)
          {
            _elem536 = new TPartitionMeta();
            _elem536.read(iprot);
      ...
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list538 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.index_infos = new java.util.ArrayList<TIndexInfo>(_list538.size);
          @org.apache.thrift.annotation.Nullable TIndexInfo _elem539;
          for (int _i540 = 0; _i540 < _list538.size; ++_i540)
          {
            _elem539 = new TIndexInfo();
            _elem539.read(iprot);
            struct.index_infos.add(_elem539);
          }
        }
        struct.setIndex_infosIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.bloomfilter_columns = new java.util.ArrayList<java.lang.String>(_list541.size);
          ...
          for (int _i543 = 0; _i543 < _list541.size; ++_i543)
          {
            ...
            struct.bloomfilter_columns.add(_elem542);
          }
        }
        struct.setBloomfilter_columnsIsSet(true);
      }
