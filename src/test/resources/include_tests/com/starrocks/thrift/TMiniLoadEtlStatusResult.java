...
public class TMiniLoadEtlStatusResult implements org.apache.thrift.TBase<TMiniLoadEtlStatusResult, TMiniLoadEtlStatusResult._Fields>, java.io.Serializable, Cloneable, Comparable<TMiniLoadEtlStatusResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.file_map = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map246.size);
                ...
                for (int _i249 = 0; _i249 < _map246.size; ++_i249)
                {
                  ...
                  struct.file_map.put(_key247, _val248);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.counters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map250.size);
                ...
                for (int _i253 = 0; _i253 < _map250.size; ++_i253)
                {
                  ...
                  struct.counters.put(_key251, _val252);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.file_map != null) {
        if (struct.isSetFile_map()) {
          oprot.writeFieldBegin(FILE_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter254 : struct.file_map.entrySet())
            {
      ...
      if (struct.counters != null) {
        if (struct.isSetCounters()) {
          oprot.writeFieldBegin(COUNTERS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter255 : struct.counters.entrySet())
            {
  ...
  private static class TMiniLoadEtlStatusResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMiniLoadEtlStatusResult> {
      ...
      if (struct.isSetFile_map()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter256 : struct.file_map.entrySet())
          {
      ...
      if (struct.isSetCounters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter257 : struct.counters.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMiniLoadEtlStatusResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map258 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64); 
          struct.file_map = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map258.size);
          ...
          for (int _i261 = 0; _i261 < _map258.size; ++_i261)
          {
            ...
            struct.file_map.put(_key259, _val260);
          }
        }
        struct.setFile_mapIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map262 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.counters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map262.size);
          ...
          for (int _i265 = 0; _i265 < _map262.size; ++_i265)
          {
            ...
            struct.counters.put(_key263, _val264);
          }
        }
        struct.setCountersIsSet(true);
      }
