      ...
      if (struct.commit_infos != null) {
        if (struct.isSetCommit_infos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletCommitInfo _iter582 : struct.commit_infos)
            {
      ...
      if (struct.fail_infos != null) {
        if (struct.isSetFail_infos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletFailInfo _iter583 : struct.fail_infos)
            {
      ...
      if (struct.isSetCommit_infos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletCommitInfo _iter584 : struct.commit_infos)
          {
      ...
      if (struct.isSetFail_infos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletFailInfo _iter585 : struct.fail_infos)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.commit_infos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list586.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem587;
          for (int _i588 = 0; _i588 < _list586.size; ++_i588)
          {
            _elem587 = new com.starrocks.thrift.TTabletCommitInfo();
            _elem587.read(iprot);
            struct.commit_infos.add(_elem587);
          }
        }
        struct.setCommit_infosIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.fail_infos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list589.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem590;
          for (int _i591 = 0; _i591 < _list589.size; ++_i591)
          {
            _elem590 = new com.starrocks.thrift.TTabletFailInfo();
            _elem590.read(iprot);
            struct.fail_infos.add(_elem590);
          }
        }
        struct.setFail_infosIsSet(true);
      }
