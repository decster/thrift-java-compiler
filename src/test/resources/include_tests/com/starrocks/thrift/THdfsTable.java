...
public class THdfsTable implements org.apache.thrift.TBase<THdfsTable, THdfsTable._Fields>, java.io.Serializable, Cloneable, Comparable<THdfsTable> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumn>(_list210.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem211;
                for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                {
                  _elem211 = new TColumn();
                  _elem211.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_columns = new java.util.ArrayList<TColumn>(_list213.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem214;
                for (int _i215 = 0; _i215 < _list213.size; ++_i215)
                {
                  _elem214 = new TColumn();
                  _elem214.read(iprot);
                  struct.partition_columns.add(_elem214);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map216.size);
                long _key217;
                @org.apache.thrift.annotation.Nullable THdfsPartition _val218;
                for (int _i219 = 0; _i219 < _map216.size; ++_i219)
                {
                  _key217 = iprot.readI64();
                  _val218 = new THdfsPartition();
                  _val218.read(iprot);
                  struct.partitions.put(_key217, _val218);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list220.size);
                ...
                for (int _i222 = 0; _i222 < _list220.size; ++_i222)
                {
                  ...
                  struct.partition_prefixes.add(_elem221);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serde_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map223.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key224;
                ...
                for (int _i226 = 0; _i226 < _map223.size; ++_i226)
                {
                  ...
                  struct.serde_properties.put(_key224, _val225);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.partition_columns != null) {
        if (struct.isSetPartition_columns()) {
          oprot.writeFieldBegin(PARTITION_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter228 : struct.partition_columns)
            {
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter229 : struct.partitions.entrySet())
            {
      ...
      if (struct.partition_prefixes != null) {
        if (struct.isSetPartition_prefixes()) {
          oprot.writeFieldBegin(PARTITION_PREFIXES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter230 : struct.partition_prefixes)
            {
      ...
      if (struct.serde_properties != null) {
        if (struct.isSetSerde_properties()) {
          oprot.writeFieldBegin(SERDE_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter231 : struct.serde_properties.entrySet())
            {
  ...
  private static class THdfsTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<THdfsTable> {
      ...
      if (struct.isSetPartition_columns()) {
        {
          ...
          for (TColumn _iter233 : struct.partition_columns)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter234 : struct.partitions.entrySet())
          {
      ...
      if (struct.isSetPartition_prefixes()) {
        {
          ...
          for (java.lang.String _iter235 : struct.partition_prefixes)
          {
      ...
      if (struct.isSetSerde_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter236 : struct.serde_properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THdfsTable struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumn>(_list237.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem238;
          for (int _i239 = 0; _i239 < _list237.size; ++_i239)
          {
            _elem238 = new TColumn();
            _elem238.read(iprot);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partition_columns = new java.util.ArrayList<TColumn>(_list240.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem241;
          for (int _i242 = 0; _i242 < _list240.size; ++_i242)
          {
            _elem241 = new TColumn();
            _elem241.read(iprot);
            struct.partition_columns.add(_elem241);
          }
        }
        struct.setPartition_columnsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map243 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map243.size);
          long _key244;
          @org.apache.thrift.annotation.Nullable THdfsPartition _val245;
          for (int _i246 = 0; _i246 < _map243.size; ++_i246)
          {
            _key244 = iprot.readI64();
            _val245 = new THdfsPartition();
            _val245.read(iprot);
            struct.partitions.put(_key244, _val245);
          }
        }
        struct.setPartitionsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.partition_prefixes = new java.util.ArrayList<java.lang.String>(_list247.size);
          ...
          for (int _i249 = 0; _i249 < _list247.size; ++_i249)
          {
            ...
            struct.partition_prefixes.add(_elem248);
          }
        }
        struct.setPartition_prefixesIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.serde_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map250.size);
          ...
          for (int _i253 = 0; _i253 < _map250.size; ++_i253)
          {
            ...
            struct.serde_properties.put(_key251, _val252);
          }
        }
        struct.setSerde_propertiesIsSet(true);
      }
