...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregationNode> {
  ...
  private static final org.apache.thrift.protocol.TField ENABLE_PIPELINE_SHARE_LIMIT_FIELD_DESC = new org.apache.thrift.protocol.TField("enable_pipeline_share_limit", org.apache.thrift.protocol.TType.BOOL, (short)29);
  ...
  public boolean enable_pipeline_share_limit; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ENABLE_PIPELINE_SHARE_LIMIT((short)29, "enable_pipeline_share_limit");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 29: // ENABLE_PIPELINE_SHARE_LIMIT
          return ENABLE_PIPELINE_SHARE_LIMIT;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.USE_PER_BUCKET_OPTIMIZE, new org.apache.thrift.meta_data.FieldMetaData("use_per_bucket_optimize", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.ENABLE_PIPELINE_SHARE_LIMIT, new org.apache.thrift.meta_data.FieldMetaData("enable_pipeline_share_limit", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TAggregationNode() {
    ...
    this.enable_pipeline_share_limit = false;
  ...
  public TAggregationNode(TAggregationNode other) {
    ...
    this.enable_pipeline_share_limit = other.enable_pipeline_share_limit;
  }
  ...
  public boolean isEnable_pipeline_share_limit() {
    return this.enable_pipeline_share_limit;
  }

  public TAggregationNode setEnable_pipeline_share_limit(boolean enable_pipeline_share_limit) {
    this.enable_pipeline_share_limit = enable_pipeline_share_limit;
    setEnable_pipeline_share_limitIsSet(true);
    return this;
  }

  public void unsetEnable_pipeline_share_limit() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ENABLE_PIPELINE_SHARE_LIMIT_ISSET_ID);
  }

  /** Returns true if field enable_pipeline_share_limit is set (has been assigned a value) and false otherwise */
  public boolean isSetEnable_pipeline_share_limit() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ENABLE_PIPELINE_SHARE_LIMIT_ISSET_ID);
  }

  public void setEnable_pipeline_share_limitIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ENABLE_PIPELINE_SHARE_LIMIT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ENABLE_PIPELINE_SHARE_LIMIT:
      if (value == null) {
        unsetEnable_pipeline_share_limit();
      } else {
        setEnable_pipeline_share_limit((java.lang.Boolean)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case ENABLE_PIPELINE_SHARE_LIMIT:
      return isEnable_pipeline_share_limit();
  ...
  public boolean isSet(_Fields field) {
    ...
    case ENABLE_PIPELINE_SHARE_LIMIT:
      return isSetEnable_pipeline_share_limit();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TAggregationNode that) {
    ...
    boolean this_present_enable_pipeline_share_limit = true && this.isSetEnable_pipeline_share_limit();
    boolean that_present_enable_pipeline_share_limit = true && that.isSetEnable_pipeline_share_limit();
    if (this_present_enable_pipeline_share_limit || that_present_enable_pipeline_share_limit) {
      if (!(this_present_enable_pipeline_share_limit && that_present_enable_pipeline_share_limit))
        return false;
      if (this.enable_pipeline_share_limit != that.enable_pipeline_share_limit)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetEnable_pipeline_share_limit()) ? 131071 : 524287);
    if (isSetEnable_pipeline_share_limit())
      hashCode = hashCode * 8191 + ((enable_pipeline_share_limit) ? 131071 : 524287);
  ...
  public int compareTo(TAggregationNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEnable_pipeline_share_limit(), other.isSetEnable_pipeline_share_limit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnable_pipeline_share_limit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.enable_pipeline_share_limit, other.enable_pipeline_share_limit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetEnable_pipeline_share_limit()) {
      if (!first) sb.append(", ");
      sb.append("enable_pipeline_share_limit:");
      sb.append(this.enable_pipeline_share_limit);
      first = false;
    }
    sb.append(")");
    return sb.toString();
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list496.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem497;
                for (int _i498 = 0; _i498 < _list496.size; ++_i498)
                {
                  _elem497 = new com.starrocks.thrift.TExpr();
                  _elem497.read(iprot);
                  struct.grouping_exprs.add(_elem497);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list499.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem500;
                for (int _i501 = 0; _i501 < _list499.size; ++_i501)
                {
                  _elem500 = new com.starrocks.thrift.TExpr();
                  _elem500.read(iprot);
                  struct.aggregate_functions.add(_elem500);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list502.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem503;
                for (int _i504 = 0; _i504 < _list502.size; ++_i504)
                {
                  _elem503 = new com.starrocks.thrift.TExpr();
                  _elem503.read(iprot);
                  struct.intermediate_aggr_exprs.add(_elem503);
                }
                iprot.readListEnd();
              }
          ...
          case 29: // ENABLE_PIPELINE_SHARE_LIMIT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.enable_pipeline_share_limit = iprot.readBool();
              struct.setEnable_pipeline_share_limitIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGrouping_exprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter505 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter506 : struct.aggregate_functions)
          {
      ...
      if (struct.intermediate_aggr_exprs != null) {
        if (struct.isSetIntermediate_aggr_exprs()) {
          oprot.writeFieldBegin(INTERMEDIATE_AGGR_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter507 : struct.intermediate_aggr_exprs)
            {
      ...
      if (struct.isSetEnable_pipeline_share_limit()) {
        oprot.writeFieldBegin(ENABLE_PIPELINE_SHARE_LIMIT_FIELD_DESC);
        oprot.writeBool(struct.enable_pipeline_share_limit);
        oprot.writeFieldEnd();
      }
  ...
  private static class TAggregationNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (com.starrocks.thrift.TExpr _iter508 : struct.aggregate_functions)
        {
      ...
      if (struct.isSetGrouping_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter509 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetIntermediate_aggr_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter510 : struct.intermediate_aggr_exprs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list511.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem512;
        for (int _i513 = 0; _i513 < _list511.size; ++_i513)
        {
          _elem512 = new com.starrocks.thrift.TExpr();
          _elem512.read(iprot);
          struct.aggregate_functions.add(_elem512);
        }
      }
      struct.setAggregate_functionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list514 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list514.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem515;
          for (int _i516 = 0; _i516 < _list514.size; ++_i516)
          {
            _elem515 = new com.starrocks.thrift.TExpr();
            _elem515.read(iprot);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list517.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem518;
          for (int _i519 = 0; _i519 < _list517.size; ++_i519)
          {
            _elem518 = new com.starrocks.thrift.TExpr();
            _elem518.read(iprot);
            struct.intermediate_aggr_exprs.add(_elem518);
          }
        }
        struct.setIntermediate_aggr_exprsIsSet(true);
      }
