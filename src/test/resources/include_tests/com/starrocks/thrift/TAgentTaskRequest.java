...
public class TAgentTaskRequest implements org.apache.thrift.TBase<TAgentTaskRequest, TAgentTaskRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentTaskRequest> {
  ...
  private static final org.apache.thrift.protocol.TField COMPACTION_CONTROL_REQ_FIELD_DESC = new org.apache.thrift.protocol.TField("compaction_control_req", org.apache.thrift.protocol.TType.STRUCT, (short)32);
  ...
  public @org.apache.thrift.annotation.Nullable TCompactionControlReq compaction_control_req; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COMPACTION_CONTROL_REQ((short)32, "compaction_control_req");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 32: // COMPACTION_CONTROL_REQ
          return COMPACTION_CONTROL_REQ;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.COMPACTION_CONTROL_REQ, new org.apache.thrift.meta_data.FieldMetaData("compaction_control_req", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TCompactionControlReq.class)));
  ...
  public TAgentTaskRequest(TAgentTaskRequest other) {
    ...
    if (other.isSetCompaction_control_req()) {
      this.compaction_control_req = new TCompactionControlReq(other.compaction_control_req);
    }
  }
  ...
  public void clear() {
    ...
    this.compaction_control_req = null;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TCompactionControlReq getCompaction_control_req() {
    return this.compaction_control_req;
  }

  public TAgentTaskRequest setCompaction_control_req(@org.apache.thrift.annotation.Nullable TCompactionControlReq compaction_control_req) {
    this.compaction_control_req = compaction_control_req;
    return this;
  }

  public void unsetCompaction_control_req() {
    this.compaction_control_req = null;
  }

  /** Returns true if field compaction_control_req is set (has been assigned a value) and false otherwise */
  public boolean isSetCompaction_control_req() {
    return this.compaction_control_req != null;
  }

  public void setCompaction_control_reqIsSet(boolean value) {
    if (!value) {
      this.compaction_control_req = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COMPACTION_CONTROL_REQ:
      if (value == null) {
        unsetCompaction_control_req();
      } else {
        setCompaction_control_req((TCompactionControlReq)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case COMPACTION_CONTROL_REQ:
      return getCompaction_control_req();
  ...
  public boolean isSet(_Fields field) {
    ...
    case COMPACTION_CONTROL_REQ:
      return isSetCompaction_control_req();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TAgentTaskRequest that) {
    ...
    boolean this_present_compaction_control_req = true && this.isSetCompaction_control_req();
    boolean that_present_compaction_control_req = true && that.isSetCompaction_control_req();
    if (this_present_compaction_control_req || that_present_compaction_control_req) {
      if (!(this_present_compaction_control_req && that_present_compaction_control_req))
        return false;
      if (!this.compaction_control_req.equals(that.compaction_control_req))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCompaction_control_req()) ? 131071 : 524287);
    if (isSetCompaction_control_req())
      hashCode = hashCode * 8191 + compaction_control_req.hashCode();
  ...
  public int compareTo(TAgentTaskRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCompaction_control_req(), other.isSetCompaction_control_req());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompaction_control_req()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.compaction_control_req, other.compaction_control_req);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetCompaction_control_req()) {
      if (!first) sb.append(", ");
      sb.append("compaction_control_req:");
      if (this.compaction_control_req == null) {
        sb.append("null");
      } else {
        sb.append(this.compaction_control_req);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (compaction_control_req != null) {
      compaction_control_req.validate();
    }
  }
  ...
  private static class TAgentTaskRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TAgentTaskRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAgentTaskRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 32: // COMPACTION_CONTROL_REQ
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.compaction_control_req = new TCompactionControlReq();
              struct.compaction_control_req.read(iprot);
              struct.setCompaction_control_reqIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentTaskRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.compaction_control_req != null) {
        if (struct.isSetCompaction_control_req()) {
          oprot.writeFieldBegin(COMPACTION_CONTROL_REQ_FIELD_DESC);
          struct.compaction_control_req.write(oprot);
          oprot.writeFieldEnd();
        }
      }
