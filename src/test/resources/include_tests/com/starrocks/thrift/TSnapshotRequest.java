...
public class TSnapshotRequest implements org.apache.thrift.TBase<TSnapshotRequest, TSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TSnapshotRequest> {
      ...
      if (struct.missing_version != null) {
        if (struct.isSetMissing_version()) {
          oprot.writeFieldBegin(MISSING_VERSION_FIELD_DESC);
          {
            ...
            for (long _iter162 : struct.missing_version)
            {
      ...
      if (struct.missing_version_ranges != null) {
        if (struct.isSetMissing_version_ranges()) {
          oprot.writeFieldBegin(MISSING_VERSION_RANGES_FIELD_DESC);
          {
            ...
            for (long _iter163 : struct.missing_version_ranges)
            {
  ...
  private static class TSnapshotRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSnapshotRequest> {
      ...
      if (struct.isSetMissing_version_ranges()) {
        {
          ...
          for (long _iter165 : struct.missing_version_ranges)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSnapshotRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list166 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.missing_version = new java.util.ArrayList<java.lang.Long>(_list166.size);
          long _elem167;
          for (int _i168 = 0; _i168 < _list166.size; ++_i168)
          {
            _elem167 = iprot.readI64();
            struct.missing_version.add(_elem167);
          }
        }
        struct.setMissing_versionIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list169 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.missing_version_ranges = new java.util.ArrayList<java.lang.Long>(_list169.size);
          long _elem170;
          for (int _i171 = 0; _i171 < _list169.size; ++_i171)
          {
            _elem170 = iprot.readI64();
            struct.missing_version_ranges.add(_elem170);
          }
        }
        struct.setMissing_version_rangesIsSet(true);
      }
