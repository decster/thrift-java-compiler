...
public class TBasePartitionDesc implements org.apache.thrift.TBase<TBasePartitionDesc, TBasePartitionDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TBasePartitionDesc> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.replica_num_map = new java.util.HashMap<java.lang.Long,java.lang.Short>(2*_map446.size);
                long _key447;
                short _val448;
                for (int _i449 = 0; _i449 < _map446.size; ++_i449)
                {
                  _key447 = iprot.readI64();
                  _val448 = iprot.readI16();
                  struct.replica_num_map.put(_key447, _val448);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.in_memory_map = new java.util.HashMap<java.lang.Long,java.lang.Boolean>(2*_map450.size);
                long _key451;
                boolean _val452;
                for (int _i453 = 0; _i453 < _map450.size; ++_i453)
                {
                  _key451 = iprot.readI64();
                  _val452 = iprot.readBool();
                  struct.in_memory_map.put(_key451, _val452);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.data_property = new java.util.HashMap<java.lang.Long,TDataProperty>(2*_map454.size);
                long _key455;
                @org.apache.thrift.annotation.Nullable TDataProperty _val456;
                for (int _i457 = 0; _i457 < _map454.size; ++_i457)
                {
                  _key455 = iprot.readI64();
                  _val456 = new TDataProperty();
                  _val456.read(iprot);
                  struct.data_property.put(_key455, _val456);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.replica_num_map != null) {
        if (struct.isSetReplica_num_map()) {
          oprot.writeFieldBegin(REPLICA_NUM_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Short> _iter458 : struct.replica_num_map.entrySet())
            {
              oprot.writeI64(_iter458.getKey());
              oprot.writeI16(_iter458.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.in_memory_map != null) {
        if (struct.isSetIn_memory_map()) {
          oprot.writeFieldBegin(IN_MEMORY_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Boolean> _iter459 : struct.in_memory_map.entrySet())
            {
              oprot.writeI64(_iter459.getKey());
              oprot.writeBool(_iter459.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.data_property != null) {
        if (struct.isSetData_property()) {
          oprot.writeFieldBegin(DATA_PROPERTY_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, TDataProperty> _iter460 : struct.data_property.entrySet())
            {
              oprot.writeI64(_iter460.getKey());
  ...
  private static class TBasePartitionDescTupleScheme extends org.apache.thrift.scheme.TupleScheme<TBasePartitionDesc> {
      ...
      if (struct.isSetReplica_num_map()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Short> _iter461 : struct.replica_num_map.entrySet())
          {
            oprot.writeI64(_iter461.getKey());
            oprot.writeI16(_iter461.getValue());
          }
        }
      }
      if (struct.isSetIn_memory_map()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Boolean> _iter462 : struct.in_memory_map.entrySet())
          {
            oprot.writeI64(_iter462.getKey());
            oprot.writeBool(_iter462.getValue());
          }
        }
      }
      if (struct.isSetData_property()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TDataProperty> _iter463 : struct.data_property.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TBasePartitionDesc struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map464 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I16); 
          struct.replica_num_map = new java.util.HashMap<java.lang.Long,java.lang.Short>(2*_map464.size);
          long _key465;
          short _val466;
          for (int _i467 = 0; _i467 < _map464.size; ++_i467)
          {
            _key465 = iprot.readI64();
            _val466 = iprot.readI16();
            struct.replica_num_map.put(_key465, _val466);
          }
        }
        struct.setReplica_num_mapIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map468 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.BOOL); 
          struct.in_memory_map = new java.util.HashMap<java.lang.Long,java.lang.Boolean>(2*_map468.size);
          long _key469;
          boolean _val470;
          for (int _i471 = 0; _i471 < _map468.size; ++_i471)
          {
            _key469 = iprot.readI64();
            _val470 = iprot.readBool();
            struct.in_memory_map.put(_key469, _val470);
          }
        }
        struct.setIn_memory_mapIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map472 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.data_property = new java.util.HashMap<java.lang.Long,TDataProperty>(2*_map472.size);
          long _key473;
          @org.apache.thrift.annotation.Nullable TDataProperty _val474;
          for (int _i475 = 0; _i475 < _map472.size; ++_i475)
          {
            _key473 = iprot.readI64();
            _val474 = new TDataProperty();
            _val474.read(iprot);
            struct.data_property.put(_key473, _val474);
          }
        }
        struct.setData_propertyIsSet(true);
      }
