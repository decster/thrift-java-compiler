...
public class TIndexReplicationInfo implements org.apache.thrift.TBase<TIndexReplicationInfo, TIndexReplicationInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TIndexReplicationInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablet_replication_infos = new java.util.HashMap<java.lang.Long,TTabletReplicationInfo>(2*_map824.size);
                long _key825;
                @org.apache.thrift.annotation.Nullable TTabletReplicationInfo _val826;
                for (int _i827 = 0; _i827 < _map824.size; ++_i827)
                {
                  _key825 = iprot.readI64();
                  _val826 = new TTabletReplicationInfo();
                  _val826.read(iprot);
                  struct.tablet_replication_infos.put(_key825, _val826);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.tablet_replication_infos != null) {
        if (struct.isSetTablet_replication_infos()) {
          oprot.writeFieldBegin(TABLET_REPLICATION_INFOS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, TTabletReplicationInfo> _iter828 : struct.tablet_replication_infos.entrySet())
            {
              oprot.writeI64(_iter828.getKey());
              _iter828.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TIndexReplicationInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIndexReplicationInfo> {
      ...
      if (struct.isSetTablet_replication_infos()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TTabletReplicationInfo> _iter829 : struct.tablet_replication_infos.entrySet())
          {
            oprot.writeI64(_iter829.getKey());
            _iter829.getValue().write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIndexReplicationInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map830 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.tablet_replication_infos = new java.util.HashMap<java.lang.Long,TTabletReplicationInfo>(2*_map830.size);
          long _key831;
          @org.apache.thrift.annotation.Nullable TTabletReplicationInfo _val832;
          for (int _i833 = 0; _i833 < _map830.size; ++_i833)
          {
            _key831 = iprot.readI64();
            _val832 = new TTabletReplicationInfo();
            _val832.read(iprot);
            struct.tablet_replication_infos.put(_key831, _val832);
          }
        }
        struct.setTablet_replication_infosIsSet(true);
      }
