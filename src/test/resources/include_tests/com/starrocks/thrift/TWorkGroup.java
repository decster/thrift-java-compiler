...
public class TWorkGroup implements org.apache.thrift.TBase<TWorkGroup, TWorkGroup._Fields>, java.io.Serializable, Cloneable, Comparable<TWorkGroup> {
  ...
  private static final org.apache.thrift.protocol.TField EXCLUSIVE_CPU_CORES_FIELD_DESC = new org.apache.thrift.protocol.TField("exclusive_cpu_cores", org.apache.thrift.protocol.TType.I32, (short)15);
  ...
  public int exclusive_cpu_cores; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXCLUSIVE_CPU_CORES((short)15, "exclusive_cpu_cores"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 15: // EXCLUSIVE_CPU_CORES
          return EXCLUSIVE_CPU_CORES;
  ...
  static {
    ...
    tmpMap.put(_Fields.SPILL_MEM_LIMIT_THRESHOLD, new org.apache.thrift.meta_data.FieldMetaData("spill_mem_limit_threshold", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.EXCLUSIVE_CPU_CORES, new org.apache.thrift.meta_data.FieldMetaData("exclusive_cpu_cores", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public TWorkGroup(TWorkGroup other) {
    ...
    this.exclusive_cpu_cores = other.exclusive_cpu_cores;
  ...
  public void clear() {
    ...
    setExclusive_cpu_coresIsSet(false);
    this.exclusive_cpu_cores = 0;
  ...
  public int getExclusive_cpu_cores() {
    return this.exclusive_cpu_cores;
  }

  public TWorkGroup setExclusive_cpu_cores(int exclusive_cpu_cores) {
    this.exclusive_cpu_cores = exclusive_cpu_cores;
    setExclusive_cpu_coresIsSet(true);
    return this;
  }

  public void unsetExclusive_cpu_cores() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __EXCLUSIVE_CPU_CORES_ISSET_ID);
  }

  /** Returns true if field exclusive_cpu_cores is set (has been assigned a value) and false otherwise */
  public boolean isSetExclusive_cpu_cores() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __EXCLUSIVE_CPU_CORES_ISSET_ID);
  }

  public void setExclusive_cpu_coresIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __EXCLUSIVE_CPU_CORES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case EXCLUSIVE_CPU_CORES:
      if (value == null) {
        unsetExclusive_cpu_cores();
      } else {
        setExclusive_cpu_cores((java.lang.Integer)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case EXCLUSIVE_CPU_CORES:
      return isSetExclusive_cpu_cores();
    case MAX_CPU_CORES:
  ...
  public boolean equals(TWorkGroup that) {
    ...
    boolean this_present_exclusive_cpu_cores = true && this.isSetExclusive_cpu_cores();
    boolean that_present_exclusive_cpu_cores = true && that.isSetExclusive_cpu_cores();
    if (this_present_exclusive_cpu_cores || that_present_exclusive_cpu_cores) {
      if (!(this_present_exclusive_cpu_cores && that_present_exclusive_cpu_cores))
        return false;
      if (this.exclusive_cpu_cores != that.exclusive_cpu_cores)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetExclusive_cpu_cores()) ? 131071 : 524287);
    if (isSetExclusive_cpu_cores())
      hashCode = hashCode * 8191 + exclusive_cpu_cores;
  ...
  public int compareTo(TWorkGroup other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetExclusive_cpu_cores(), other.isSetExclusive_cpu_cores());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExclusive_cpu_cores()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.exclusive_cpu_cores, other.exclusive_cpu_cores);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetExclusive_cpu_cores()) {
      if (!first) sb.append(", ");
      sb.append("exclusive_cpu_cores:");
      sb.append(this.exclusive_cpu_cores);
      first = false;
    }
    if (isSetMax_cpu_cores()) {
      if (!first) sb.append(", ");
  ...
  private static class TWorkGroupStandardScheme extends org.apache.thrift.scheme.StandardScheme<TWorkGroup> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TWorkGroup struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 15: // EXCLUSIVE_CPU_CORES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.exclusive_cpu_cores = iprot.readI32();
              struct.setExclusive_cpu_coresIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TWorkGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetExclusive_cpu_cores()) {
        oprot.writeFieldBegin(EXCLUSIVE_CPU_CORES_FIELD_DESC);
        oprot.writeI32(struct.exclusive_cpu_cores);
        oprot.writeFieldEnd();
      }
