...
public class TPublishVersionRequest implements org.apache.thrift.TBase<TPublishVersionRequest, TPublishVersionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TPublishVersionRequest> {
  ...
  private static final org.apache.thrift.protocol.TField GTID_FIELD_DESC = new org.apache.thrift.protocol.TField("gtid", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField IS_VERSION_OVERWRITE_FIELD_DESC = new org.apache.thrift.protocol.TField("is_version_overwrite", org.apache.thrift.protocol.TType.BOOL, (short)9);
   ...
   */
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTxnType txn_type; // optional
  public long gtid; // optional
  public boolean is_version_overwrite; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    GTID((short)8, "gtid"),
    IS_VERSION_OVERWRITE((short)9, "is_version_overwrite");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // GTID
          return GTID;
        case 9: // IS_VERSION_OVERWRITE
          return IS_VERSION_OVERWRITE;
        default:
          return null;
      }
    }
  ...
  private static final int __GTID_ISSET_ID = 4;
  private static final int __IS_VERSION_OVERWRITE_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.STRICT_MODE,_Fields.COMMIT_TIMESTAMP,_Fields.TXN_TRACE_PARENT,_Fields.ENABLE_SYNC_PUBLISH,_Fields.TXN_TYPE,_Fields.GTID,_Fields.IS_VERSION_OVERWRITE};
  ...
  static {
    ...
    tmpMap.put(_Fields.GTID, new org.apache.thrift.meta_data.FieldMetaData("gtid", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.IS_VERSION_OVERWRITE, new org.apache.thrift.meta_data.FieldMetaData("is_version_overwrite", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TPublishVersionRequest() {
    ...
    this.is_version_overwrite = false;
  ...
  public TPublishVersionRequest(TPublishVersionRequest other) {
    ...
    this.is_version_overwrite = other.is_version_overwrite;
  }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TTxnType getTxn_type() {
   ...
   * @see com.starrocks.thrift.TTxnType
   */
  public TPublishVersionRequest setTxn_type(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTxnType txn_type) {
  ...
  public TPublishVersionRequest setGtid(long gtid) {
    this.gtid = gtid;
    setGtidIsSet(true);
    return this;
  }
  ...
  public boolean isIs_version_overwrite() {
    return this.is_version_overwrite;
  }

  public TPublishVersionRequest setIs_version_overwrite(boolean is_version_overwrite) {
    this.is_version_overwrite = is_version_overwrite;
    setIs_version_overwriteIsSet(true);
    return this;
  }

  public void unsetIs_version_overwrite() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_VERSION_OVERWRITE_ISSET_ID);
  }

  /** Returns true if field is_version_overwrite is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_version_overwrite() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_VERSION_OVERWRITE_ISSET_ID);
  }

  public void setIs_version_overwriteIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_VERSION_OVERWRITE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TXN_TYPE:
      if (value == null) {
        ...
        setTxn_type((com.starrocks.thrift.TTxnType)value);
      }
      break;
    ...
    case IS_VERSION_OVERWRITE:
      if (value == null) {
        unsetIs_version_overwrite();
      } else {
        setIs_version_overwrite((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case GTID:
      return isSetGtid();
    case IS_VERSION_OVERWRITE:
      return isSetIs_version_overwrite();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TPublishVersionRequest that) {
    ...
    boolean this_present_is_version_overwrite = true && this.isSetIs_version_overwrite();
    boolean that_present_is_version_overwrite = true && that.isSetIs_version_overwrite();
    if (this_present_is_version_overwrite || that_present_is_version_overwrite) {
      if (!(this_present_is_version_overwrite && that_present_is_version_overwrite))
        return false;
      if (this.is_version_overwrite != that.is_version_overwrite)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIs_version_overwrite()) ? 131071 : 524287);
    if (isSetIs_version_overwrite())
      hashCode = hashCode * 8191 + ((is_version_overwrite) ? 131071 : 524287);
  ...
  public int compareTo(TPublishVersionRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_version_overwrite(), other.isSetIs_version_overwrite());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_version_overwrite()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_version_overwrite, other.is_version_overwrite);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetIs_version_overwrite()) {
      if (!first) sb.append(", ");
      sb.append("is_version_overwrite:");
      sb.append(this.is_version_overwrite);
      first = false;
    }
    sb.append(")");
    return sb.toString();
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_version_infos = new java.util.ArrayList<TPartitionVersionInfo>(_list182.size);
                @org.apache.thrift.annotation.Nullable TPartitionVersionInfo _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new TPartitionVersionInfo();
                  _elem183.read(iprot);
                  struct.partition_version_infos.add(_elem183);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // IS_VERSION_OVERWRITE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_version_overwrite = iprot.readBool();
              struct.setIs_version_overwriteIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_version_infos != null) {
        oprot.writeFieldBegin(PARTITION_VERSION_INFOS_FIELD_DESC);
        {
          ...
          for (TPartitionVersionInfo _iter185 : struct.partition_version_infos)
          {
      ...
      if (struct.isSetIs_version_overwrite()) {
        oprot.writeFieldBegin(IS_VERSION_OVERWRITE_FIELD_DESC);
        oprot.writeBool(struct.is_version_overwrite);
        oprot.writeFieldEnd();
      }
  ...
  private static class TPublishVersionRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPublishVersionRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.transaction_id);
      {
        ...
        for (TPartitionVersionInfo _iter186 : struct.partition_version_infos)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTransaction_idIsSet(true);
      {
        ...
        struct.partition_version_infos = new java.util.ArrayList<TPartitionVersionInfo>(_list187.size);
        @org.apache.thrift.annotation.Nullable TPartitionVersionInfo _elem188;
        for (int _i189 = 0; _i189 < _list187.size; ++_i189)
        {
          _elem188 = new TPartitionVersionInfo();
          _elem188.read(iprot);
          struct.partition_version_infos.add(_elem188);
        }
      }
      struct.setPartition_version_infosIsSet(true);
