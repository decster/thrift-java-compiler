...
public class TEsScanNode implements org.apache.thrift.TBase<TEsScanNode, TEsScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TEsScanNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.docvalue_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map200.size);
                ...
                for (int _i203 = 0; _i203 < _map200.size; ++_i203)
                {
                  ...
                  struct.docvalue_context.put(_key201, _val202);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.fields_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map204.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key205;
                @org.apache.thrift.annotation.Nullable java.lang.String _val206;
                for (int _i207 = 0; _i207 < _map204.size; ++_i207)
                {
                  _key205 = iprot.readString();
                  _val206 = iprot.readString();
                  struct.fields_context.put(_key205, _val206);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.docvalue_context != null) {
        if (struct.isSetDocvalue_context()) {
          oprot.writeFieldBegin(DOCVALUE_CONTEXT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter209 : struct.docvalue_context.entrySet())
            {
      ...
      if (struct.fields_context != null) {
        if (struct.isSetFields_context()) {
          oprot.writeFieldBegin(FIELDS_CONTEXT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter210 : struct.fields_context.entrySet())
            {
  ...
  private static class TEsScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TEsScanNode> {
      ...
      if (struct.isSetDocvalue_context()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter212 : struct.docvalue_context.entrySet())
          {
      ...
      if (struct.isSetFields_context()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter213 : struct.fields_context.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TEsScanNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map214.size);
          ...
          for (int _i217 = 0; _i217 < _map214.size; ++_i217)
          {
            ...
            struct.properties.put(_key215, _val216);
          }
        }
        struct.setPropertiesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map218 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.docvalue_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map218.size);
          ...
          for (int _i221 = 0; _i221 < _map218.size; ++_i221)
          {
            ...
            struct.docvalue_context.put(_key219, _val220);
          }
        }
        struct.setDocvalue_contextIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.fields_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map222.size);
          ...
          for (int _i225 = 0; _i225 < _map222.size; ++_i225)
          {
            ...
            struct.fields_context.put(_key223, _val224);
          }
        }
        struct.setFields_contextIsSet(true);
      }
