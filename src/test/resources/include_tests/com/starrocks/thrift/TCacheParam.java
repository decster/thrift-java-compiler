...
public class TCacheParam implements org.apache.thrift.TBase<TCacheParam, TCacheParam._Fields>, java.io.Serializable, Cloneable, Comparable<TCacheParam> {
  ...
  private static final org.apache.thrift.protocol.TField IS_LAKE_FIELD_DESC = new org.apache.thrift.protocol.TField("is_lake", org.apache.thrift.protocol.TType.BOOL, (short)12);
  ...
  public boolean is_lake; // optional
  ...
  private static final int __IS_LAKE_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.DIGEST,_Fields.SLOT_REMAPPING,_Fields.REGION_MAP,_Fields.FORCE_POPULATE,_Fields.ENTRY_MAX_BYTES,_Fields.ENTRY_MAX_ROWS,_Fields.CAN_USE_MULTIVERSION,_Fields.KEYS_TYPE,_Fields.CACHED_PLAN_NODE_IDS,_Fields.IS_LAKE};
  ...
  static {
    ...
    tmpMap.put(_Fields.CACHED_PLAN_NODE_IDS, new org.apache.thrift.meta_data.FieldMetaData("cached_plan_node_ids", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.SetMetaData(org.apache.thrift.protocol.TType.SET, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.IS_LAKE, new org.apache.thrift.meta_data.FieldMetaData("is_lake", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public boolean isIs_lake() {
    return this.is_lake;
  }

  public TCacheParam setIs_lake(boolean is_lake) {
    this.is_lake = is_lake;
    setIs_lakeIsSet(true);
    return this;
  }

  public void unsetIs_lake() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_LAKE_ISSET_ID);
  }

  /** Returns true if field is_lake is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_lake() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_LAKE_ISSET_ID);
  }

  public void setIs_lakeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_LAKE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IS_LAKE:
      if (value == null) {
        ...
        setIs_lake((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TCacheParam that) {
    ...
    boolean this_present_is_lake = true && this.isSetIs_lake();
    boolean that_present_is_lake = true && that.isSetIs_lake();
    if (this_present_is_lake || that_present_is_lake) {
      if (!(this_present_is_lake && that_present_is_lake))
        return false;
      if (this.is_lake != that.is_lake)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIs_lake()) ? 131071 : 524287);
    if (isSetIs_lake())
      hashCode = hashCode * 8191 + ((is_lake) ? 131071 : 524287);
  ...
  public int compareTo(TCacheParam other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_lake(), other.isSetIs_lake());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_lake()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_lake, other.is_lake);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TCacheParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCacheParam> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCacheParam struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 12: // IS_LAKE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_lake = iprot.readBool();
              struct.setIs_lakeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCacheParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIs_lake()) {
        oprot.writeFieldBegin(IS_LAKE_FIELD_DESC);
        oprot.writeBool(struct.is_lake);
        oprot.writeFieldEnd();
      }
