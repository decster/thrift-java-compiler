...
public class TFunction implements org.apache.thrift.TBase<TFunction, TFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TFunction> {
  ...
  private static final org.apache.thrift.protocol.TField AGG_STATE_DESC_FIELD_DESC = new org.apache.thrift.protocol.TField("agg_state_desc", org.apache.thrift.protocol.TType.STRUCT, (short)13);
  ...
  private static final org.apache.thrift.protocol.TField INPUT_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("input_type", org.apache.thrift.protocol.TType.STRING, (short)35);
  ...
  public @org.apache.thrift.annotation.Nullable TAggStateDesc agg_state_desc; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String input_type; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    AGG_STATE_DESC((short)13, "agg_state_desc"),
    FID((short)30, "fid"),
    ...
    INPUT_TYPE((short)35, "input_type"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 12: // CHECKSUM
          return CHECKSUM;
        case 13: // AGG_STATE_DESC
          return AGG_STATE_DESC;
        case 30: // FID
          return FID;
        case 31: // TABLE_FN
          return TABLE_FN;
  ...
  private static final _Fields optionals[] = {_Fields.COMMENT,_Fields.SIGNATURE,_Fields.HDFS_LOCATION,_Fields.SCALAR_FN,_Fields.AGGREGATE_FN,_Fields.ID,_Fields.CHECKSUM,_Fields.AGG_STATE_DESC,_Fields.FID,_Fields.TABLE_FN,_Fields.COULD_APPLY_DICT_OPTIMIZE,_Fields.IGNORE_NULLS,_Fields.ISOLATED,_Fields.INPUT_TYPE,_Fields.CONTENT};
  ...
  static {
    ...
    tmpMap.put(_Fields.CHECKSUM, new org.apache.thrift.meta_data.FieldMetaData("checksum", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.AGG_STATE_DESC, new org.apache.thrift.meta_data.FieldMetaData("agg_state_desc", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TAggStateDesc.class)));
    ...
    tmpMap.put(_Fields.ISOLATED, new org.apache.thrift.meta_data.FieldMetaData("isolated", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.INPUT_TYPE, new org.apache.thrift.meta_data.FieldMetaData("input_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public TFunction(TFunction other) {
    ...
    if (other.isSetAgg_state_desc()) {
      this.agg_state_desc = new TAggStateDesc(other.agg_state_desc);
    }
    this.fid = other.fid;
  ...
  @org.apache.thrift.annotation.Nullable
  public TAggStateDesc getAgg_state_desc() {
    return this.agg_state_desc;
  }

  public TFunction setAgg_state_desc(@org.apache.thrift.annotation.Nullable TAggStateDesc agg_state_desc) {
    this.agg_state_desc = agg_state_desc;
    return this;
  }

  public void unsetAgg_state_desc() {
    this.agg_state_desc = null;
  }

  /** Returns true if field agg_state_desc is set (has been assigned a value) and false otherwise */
  public boolean isSetAgg_state_desc() {
    return this.agg_state_desc != null;
  }

  public void setAgg_state_descIsSet(boolean value) {
    if (!value) {
      this.agg_state_desc = null;
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getInput_type() {
    return this.input_type;
  }

  public TFunction setInput_type(@org.apache.thrift.annotation.Nullable java.lang.String input_type) {
  ...
  public TFunction setContent(@org.apache.thrift.annotation.Nullable java.lang.String content) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case AGG_STATE_DESC:
      if (value == null) {
        ...
        setAgg_state_desc((TAggStateDesc)value);
      }
      break;
    ...
    case INPUT_TYPE:
      if (value == null) {
        ...
        setInput_type((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(TFunction that) {
    ...
    boolean this_present_agg_state_desc = true && this.isSetAgg_state_desc();
    boolean that_present_agg_state_desc = true && that.isSetAgg_state_desc();
    if (this_present_agg_state_desc || that_present_agg_state_desc) {
      if (!(this_present_agg_state_desc && that_present_agg_state_desc))
        return false;
      if (!this.agg_state_desc.equals(that.agg_state_desc))
        return false;
    }
    ...
    boolean this_present_input_type = true && this.isSetInput_type();
    boolean that_present_input_type = true && that.isSetInput_type();
    if (this_present_input_type || that_present_input_type) {
      if (!(this_present_input_type && that_present_input_type))
        return false;
      if (!this.input_type.equals(that.input_type))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetAgg_state_desc()) ? 131071 : 524287);
    if (isSetAgg_state_desc())
      hashCode = hashCode * 8191 + agg_state_desc.hashCode();
    ...
    hashCode = hashCode * 8191 + ((isSetInput_type()) ? 131071 : 524287);
    if (isSetInput_type())
      hashCode = hashCode * 8191 + input_type.hashCode();
  ...
  public int compareTo(TFunction other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAgg_state_desc(), other.isSetAgg_state_desc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgg_state_desc()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.agg_state_desc, other.agg_state_desc);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetInput_type(), other.isSetInput_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInput_type()) {
  ...
  public java.lang.String toString() {
    ...
    if (isSetAgg_state_desc()) {
      if (!first) sb.append(", ");
      sb.append("agg_state_desc:");
      if (this.agg_state_desc == null) {
        sb.append("null");
      } else {
        sb.append(this.agg_state_desc);
      }
      first = false;
    }
    if (isSetFid()) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (agg_state_desc != null) {
      agg_state_desc.validate();
    }
    if (table_fn != null) {
      table_fn.validate();
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TFunction struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arg_types = new java.util.ArrayList<TTypeDesc>(_list48.size);
                @org.apache.thrift.annotation.Nullable TTypeDesc _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new TTypeDesc();
                  _elem49.read(iprot);
                  struct.arg_types.add(_elem49);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // AGG_STATE_DESC
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.agg_state_desc = new TAggStateDesc();
              struct.agg_state_desc.read(iprot);
              struct.setAgg_state_descIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          ...
          case 35: // INPUT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.input_type = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFunction struct) throws org.apache.thrift.TException {
      ...
      if (struct.arg_types != null) {
        oprot.writeFieldBegin(ARG_TYPES_FIELD_DESC);
        {
          ...
          for (TTypeDesc _iter51 : struct.arg_types)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.agg_state_desc != null) {
        if (struct.isSetAgg_state_desc()) {
          oprot.writeFieldBegin(AGG_STATE_DESC_FIELD_DESC);
          struct.agg_state_desc.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetFid()) {
  ...
  private static class TFunctionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFunction> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TFunction struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.binary_type.getValue());
      {
        ...
        for (TTypeDesc _iter52 : struct.arg_types)
        {
          _iter52.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFunction struct) throws org.apache.thrift.TException {
      ...
      struct.setBinary_typeIsSet(true);
      {
        ...
        struct.arg_types = new java.util.ArrayList<TTypeDesc>(_list53.size);
        @org.apache.thrift.annotation.Nullable TTypeDesc _elem54;
        for (int _i55 = 0; _i55 < _list53.size; ++_i55)
        {
          _elem54 = new TTypeDesc();
          _elem54.read(iprot);
          struct.arg_types.add(_elem54);
        }
      }
      struct.setArg_typesIsSet(true);
      struct.ret_type = new TTypeDesc();
