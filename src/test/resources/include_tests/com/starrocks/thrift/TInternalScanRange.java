...
public class TInternalScanRange implements org.apache.thrift.TBase<TInternalScanRange, TInternalScanRange._Fields>, java.io.Serializable, Cloneable, Comparable<TInternalScanRange> {
  ...
  private static final org.apache.thrift.protocol.TField SKIP_PAGE_CACHE_FIELD_DESC = new org.apache.thrift.protocol.TField("skip_page_cache", org.apache.thrift.protocol.TType.BOOL, (short)14);
  private static final org.apache.thrift.protocol.TField SKIP_DISK_CACHE_FIELD_DESC = new org.apache.thrift.protocol.TField("skip_disk_cache", org.apache.thrift.protocol.TType.BOOL, (short)15);
  private static final org.apache.thrift.protocol.TField GTID_FIELD_DESC = new org.apache.thrift.protocol.TField("gtid", org.apache.thrift.protocol.TType.I64, (short)16);
  ...
  public boolean skip_page_cache; // optional
  public boolean skip_disk_cache; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SKIP_PAGE_CACHE((short)14, "skip_page_cache"),
    SKIP_DISK_CACHE((short)15, "skip_disk_cache"),
    GTID((short)16, "gtid");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 14: // SKIP_PAGE_CACHE
          return SKIP_PAGE_CACHE;
        case 15: // SKIP_DISK_CACHE
          return SKIP_DISK_CACHE;
        case 16: // GTID
          return GTID;
        default:
          return null;
  ...
  private static final int __SKIP_PAGE_CACHE_ISSET_ID = 5;
  private static final int __SKIP_DISK_CACHE_ISSET_ID = 6;
  private static final int __GTID_ISSET_ID = 7;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.PARTITION_COLUMN_RANGES,_Fields.INDEX_NAME,_Fields.TABLE_NAME,_Fields.PARTITION_ID,_Fields.ROW_COUNT,_Fields.FILL_DATA_CACHE,_Fields.BUCKET_SEQUENCE,_Fields.SKIP_PAGE_CACHE,_Fields.SKIP_DISK_CACHE,_Fields.GTID};
  ...
  static {
    ...
    tmpMap.put(_Fields.SKIP_PAGE_CACHE, new org.apache.thrift.meta_data.FieldMetaData("skip_page_cache", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.SKIP_DISK_CACHE, new org.apache.thrift.meta_data.FieldMetaData("skip_disk_cache", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TInternalScanRange() {
    ...
    this.skip_page_cache = false;

    this.skip_disk_cache = false;
  ...
  public TInternalScanRange(TInternalScanRange other) {
    ...
    this.skip_page_cache = other.skip_page_cache;
    this.skip_disk_cache = other.skip_disk_cache;
  ...
  public boolean isSkip_page_cache() {
    return this.skip_page_cache;
  }

  public TInternalScanRange setSkip_page_cache(boolean skip_page_cache) {
    this.skip_page_cache = skip_page_cache;
    setSkip_page_cacheIsSet(true);
    return this;
  }

  public void unsetSkip_page_cache() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SKIP_PAGE_CACHE_ISSET_ID);
  }

  /** Returns true if field skip_page_cache is set (has been assigned a value) and false otherwise */
  public boolean isSetSkip_page_cache() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SKIP_PAGE_CACHE_ISSET_ID);
  }

  public void setSkip_page_cacheIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SKIP_PAGE_CACHE_ISSET_ID, value);
  }

  public boolean isSkip_disk_cache() {
    return this.skip_disk_cache;
  }

  public TInternalScanRange setSkip_disk_cache(boolean skip_disk_cache) {
    this.skip_disk_cache = skip_disk_cache;
    setSkip_disk_cacheIsSet(true);
    return this;
  }

  public void unsetSkip_disk_cache() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SKIP_DISK_CACHE_ISSET_ID);
  }

  /** Returns true if field skip_disk_cache is set (has been assigned a value) and false otherwise */
  public boolean isSetSkip_disk_cache() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SKIP_DISK_CACHE_ISSET_ID);
  }

  public void setSkip_disk_cacheIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SKIP_DISK_CACHE_ISSET_ID, value);
  }
  ...
  public TInternalScanRange setGtid(long gtid) {
    this.gtid = gtid;
    setGtidIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SKIP_PAGE_CACHE:
      if (value == null) {
        unsetSkip_page_cache();
      } else {
        setSkip_page_cache((java.lang.Boolean)value);
      }
      break;

    case SKIP_DISK_CACHE:
      if (value == null) {
        unsetSkip_disk_cache();
      } else {
        setSkip_disk_cache((java.lang.Boolean)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case SKIP_PAGE_CACHE:
      return isSkip_page_cache();

    case SKIP_DISK_CACHE:
      return isSkip_disk_cache();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SKIP_PAGE_CACHE:
      return isSetSkip_page_cache();
    case SKIP_DISK_CACHE:
      return isSetSkip_disk_cache();
    case GTID:
      return isSetGtid();
    }
    throw new java.lang.IllegalStateException();
  ...
  public boolean equals(TInternalScanRange that) {
    ...
    boolean this_present_skip_page_cache = true && this.isSetSkip_page_cache();
    boolean that_present_skip_page_cache = true && that.isSetSkip_page_cache();
    if (this_present_skip_page_cache || that_present_skip_page_cache) {
      if (!(this_present_skip_page_cache && that_present_skip_page_cache))
        return false;
      if (this.skip_page_cache != that.skip_page_cache)
        return false;
    }

    boolean this_present_skip_disk_cache = true && this.isSetSkip_disk_cache();
    boolean that_present_skip_disk_cache = true && that.isSetSkip_disk_cache();
    if (this_present_skip_disk_cache || that_present_skip_disk_cache) {
      if (!(this_present_skip_disk_cache && that_present_skip_disk_cache))
        return false;
      if (this.skip_disk_cache != that.skip_disk_cache)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSkip_page_cache()) ? 131071 : 524287);
    if (isSetSkip_page_cache())
      hashCode = hashCode * 8191 + ((skip_page_cache) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((isSetSkip_disk_cache()) ? 131071 : 524287);
    if (isSetSkip_disk_cache())
      hashCode = hashCode * 8191 + ((skip_disk_cache) ? 131071 : 524287);
  ...
  public int compareTo(TInternalScanRange other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSkip_page_cache(), other.isSetSkip_page_cache());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSkip_page_cache()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.skip_page_cache, other.skip_page_cache);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.compare(isSetSkip_disk_cache(), other.isSetSkip_disk_cache());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSkip_disk_cache()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.skip_disk_cache, other.skip_disk_cache);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSkip_page_cache()) {
      if (!first) sb.append(", ");
      sb.append("skip_page_cache:");
      sb.append(this.skip_page_cache);
      first = false;
    }
    if (isSetSkip_disk_cache()) {
      if (!first) sb.append(", ");
      sb.append("skip_disk_cache:");
      sb.append(this.skip_disk_cache);
      first = false;
    }
    if (isSetGtid()) {
      if (!first) sb.append(", ");
  ...
  private static class TInternalScanRangeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TInternalScanRange> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TInternalScanRange struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 14: // SKIP_PAGE_CACHE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.skip_page_cache = iprot.readBool();
              struct.setSkip_page_cacheIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 15: // SKIP_DISK_CACHE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.skip_disk_cache = iprot.readBool();
              struct.setSkip_disk_cacheIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TInternalScanRange struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSkip_page_cache()) {
        oprot.writeFieldBegin(SKIP_PAGE_CACHE_FIELD_DESC);
        oprot.writeBool(struct.skip_page_cache);
        oprot.writeFieldEnd();
      }
      if (struct.isSetSkip_disk_cache()) {
        oprot.writeFieldBegin(SKIP_DISK_CACHE_FIELD_DESC);
        oprot.writeBool(struct.skip_disk_cache);
        oprot.writeFieldEnd();
      }
      if (struct.isSetGtid()) {
