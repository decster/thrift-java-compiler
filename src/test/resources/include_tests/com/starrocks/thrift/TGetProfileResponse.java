...
public class TGetProfileResponse implements org.apache.thrift.TBase<TGetProfileResponse, TGetProfileResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TGetProfileResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.query_result = new java.util.ArrayList<java.lang.String>(_list808.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem809;
                for (int _i810 = 0; _i810 < _list808.size; ++_i810)
                {
                  _elem809 = iprot.readString();
                  struct.query_result.add(_elem809);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.query_result != null) {
        if (struct.isSetQuery_result()) {
          oprot.writeFieldBegin(QUERY_RESULT_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter811 : struct.query_result)
            {
  ...
  private static class TGetProfileResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetProfileResponse> {
      ...
      if (struct.isSetQuery_result()) {
        {
          ...
          for (java.lang.String _iter812 : struct.query_result)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetProfileResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list813 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.query_result = new java.util.ArrayList<java.lang.String>(_list813.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem814;
          for (int _i815 = 0; _i815 < _list813.size; ++_i815)
          {
            _elem814 = iprot.readString();
            struct.query_result.add(_elem814);
          }
        }
        struct.setQuery_resultIsSet(true);
      }
