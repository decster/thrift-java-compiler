...
public class TTableFunction implements org.apache.thrift.TBase<TTableFunction, TTableFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TTableFunction> {
  ...
  private static final org.apache.thrift.protocol.TField IS_LEFT_JOIN_FIELD_DESC = new org.apache.thrift.protocol.TField("is_left_join", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final int __IS_LEFT_JOIN_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SYMBOL,_Fields.IS_LEFT_JOIN};
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_LEFT_JOIN, new org.apache.thrift.meta_data.FieldMetaData("is_left_join", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TTableFunction(TTableFunction other) {
    ...
    this.is_left_join = other.is_left_join;
  }
  ...
  public void clear() {
    this.ret_types = null;
    this.symbol = null;
    setIs_left_joinIsSet(false);
    this.is_left_join = false;
  }
  ...
  public boolean isIs_left_join() {
    return this.is_left_join;
  }

  public TTableFunction setIs_left_join(boolean is_left_join) {
    this.is_left_join = is_left_join;
    setIs_left_joinIsSet(true);
    return this;
  }

  public void unsetIs_left_join() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_LEFT_JOIN_ISSET_ID);
  }

  /** Returns true if field is_left_join is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_left_join() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_LEFT_JOIN_ISSET_ID);
  }

  public void setIs_left_joinIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_LEFT_JOIN_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IS_LEFT_JOIN:
      if (value == null) {
        ...
        setIs_left_join((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TTableFunction that) {
    ...
    boolean this_present_is_left_join = true && this.isSetIs_left_join();
    boolean that_present_is_left_join = true && that.isSetIs_left_join();
    if (this_present_is_left_join || that_present_is_left_join) {
      if (!(this_present_is_left_join && that_present_is_left_join))
        return false;
      if (this.is_left_join != that.is_left_join)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIs_left_join()) ? 131071 : 524287);
    if (isSetIs_left_join())
      hashCode = hashCode * 8191 + ((is_left_join) ? 131071 : 524287);
  ...
  public int compareTo(TTableFunction other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_left_join(), other.isSetIs_left_join());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_left_join()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_left_join, other.is_left_join);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetIs_left_join()) {
      if (!first) sb.append(", ");
      sb.append("is_left_join:");
      sb.append(this.is_left_join);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TTableFunctionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTableFunction> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // IS_LEFT_JOIN
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_left_join = iprot.readBool();
              struct.setIs_left_joinIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTableFunction struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIs_left_join()) {
        oprot.writeFieldBegin(IS_LEFT_JOIN_FIELD_DESC);
        oprot.writeBool(struct.is_left_join);
        oprot.writeFieldEnd();
      }
