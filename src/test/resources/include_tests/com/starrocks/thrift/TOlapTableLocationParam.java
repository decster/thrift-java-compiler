            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<TTabletLocation>(_list186.size);
                @org.apache.thrift.annotation.Nullable TTabletLocation _elem187;
                for (int _i188 = 0; _i188 < _list186.size; ++_i188)
                {
                  _elem187 = new TTabletLocation();
                  _elem187.read(iprot);
                  struct.tablets.add(_elem187);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.tablets != null) {
        oprot.writeFieldBegin(TABLETS_FIELD_DESC);
        {
          ...
          for (TTabletLocation _iter189 : struct.tablets)
          {
  ...
  private static class TOlapTableLocationParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableLocationParam> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.version);
      {
        ...
        for (TTabletLocation _iter190 : struct.tablets)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.tablets = new java.util.ArrayList<TTabletLocation>(_list191.size);
        @org.apache.thrift.annotation.Nullable TTabletLocation _elem192;
        for (int _i193 = 0; _i193 < _list191.size; ++_i193)
        {
          _elem192 = new TTabletLocation();
          _elem192.read(iprot);
          struct.tablets.add(_elem192);
        }
      }
      struct.setTabletsIsSet(true);
    }
