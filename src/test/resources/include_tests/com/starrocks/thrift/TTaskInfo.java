...
public class TTaskInfo implements org.apache.thrift.TBase<TTaskInfo, TTaskInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TTaskInfo> {
  ...
  private static final org.apache.thrift.protocol.TField CREATOR_FIELD_DESC = new org.apache.thrift.protocol.TField("creator", org.apache.thrift.protocol.TType.STRING, (short)9);
  ...
  private static final _Fields optionals[] = {_Fields.TASK_NAME,_Fields.CREATE_TIME,_Fields.SCHEDULE,_Fields.DATABASE,_Fields.DEFINITION,_Fields.EXPIRE_TIME,_Fields.PROPERTIES,_Fields.CATALOG,_Fields.CREATOR};
  ...
  public TTaskInfo setCatalog(@org.apache.thrift.annotation.Nullable java.lang.String catalog) {
  ...
  public TTaskInfo setCreator(@org.apache.thrift.annotation.Nullable java.lang.String creator) {
