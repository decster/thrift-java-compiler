            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1050.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1051;
                for (int _i1052 = 0; _i1052 < _list1050.size; ++_i1052)
                {
                  _elem1051 = new com.starrocks.thrift.TExpr();
                  _elem1051.read(iprot);
                  struct.grouping_exprs.add(_elem1051);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1053.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1054;
                for (int _i1055 = 0; _i1055 < _list1053.size; ++_i1055)
                {
                  _elem1054 = new com.starrocks.thrift.TExpr();
                  _elem1054.read(iprot);
                  struct.aggregate_functions.add(_elem1054);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGrouping_exprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter1056 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        if (struct.isSetAggregate_functions()) {
          oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter1057 : struct.aggregate_functions)
            {
      ...
      if (struct.isSetGrouping_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter1058 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetAggregate_functions()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter1059 : struct.aggregate_functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1060.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1061;
          for (int _i1062 = 0; _i1062 < _list1060.size; ++_i1062)
          {
            _elem1061 = new com.starrocks.thrift.TExpr();
            _elem1061.read(iprot);
            struct.grouping_exprs.add(_elem1061);
          }
        }
        struct.setGrouping_exprsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1063.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1064;
          for (int _i1065 = 0; _i1065 < _list1063.size; ++_i1065)
          {
            _elem1064 = new com.starrocks.thrift.TExpr();
            _elem1064.read(iprot);
            struct.aggregate_functions.add(_elem1064);
          }
        }
        struct.setAggregate_functionsIsSet(true);
      }
