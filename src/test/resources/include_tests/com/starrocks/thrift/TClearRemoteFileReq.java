            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.remote_source_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map172.size);
                ...
                for (int _i175 = 0; _i175 < _map172.size; ++_i175)
                {
                  ...
                  struct.remote_source_properties.put(_key173, _val174);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TClearRemoteFileReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.remote_source_properties != null) {
        oprot.writeFieldBegin(REMOTE_SOURCE_PROPERTIES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter176 : struct.remote_source_properties.entrySet())
          {
  ...
  private static class TClearRemoteFileReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TClearRemoteFileReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TClearRemoteFileReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.remote_file_path);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter177 : struct.remote_source_properties.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TClearRemoteFileReq struct) throws org.apache.thrift.TException {
      ...
      struct.setRemote_file_pathIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map178 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
        struct.remote_source_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map178.size);
        ...
        for (int _i181 = 0; _i181 < _map178.size; ++_i181)
        {
          ...
          struct.remote_source_properties.put(_key179, _val180);
        }
      }
      struct.setRemote_source_propertiesIsSet(true);
    }
