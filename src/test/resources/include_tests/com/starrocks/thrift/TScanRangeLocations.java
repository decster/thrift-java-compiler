            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.locations = new java.util.ArrayList<TScanRangeLocation>(_list78.size);
                @org.apache.thrift.annotation.Nullable TScanRangeLocation _elem79;
                for (int _i80 = 0; _i80 < _list78.size; ++_i80)
                {
                  _elem79 = new TScanRangeLocation();
                  _elem79.read(iprot);
                  struct.locations.add(_elem79);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TScanRangeLocations struct) throws org.apache.thrift.TException {
      ...
      if (struct.locations != null) {
        oprot.writeFieldBegin(LOCATIONS_FIELD_DESC);
        {
          ...
          for (TScanRangeLocation _iter81 : struct.locations)
          {
            _iter81.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetLocations()) {
        {
          ...
          for (TScanRangeLocation _iter82 : struct.locations)
          {
            _iter82.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.locations = new java.util.ArrayList<TScanRangeLocation>(_list83.size);
          @org.apache.thrift.annotation.Nullable TScanRangeLocation _elem84;
          for (int _i85 = 0; _i85 < _list83.size; ++_i85)
          {
            _elem84 = new TScanRangeLocation();
            _elem84.read(iprot);
            struct.locations.add(_elem84);
          }
        }
        struct.setLocationsIsSet(true);
      }
