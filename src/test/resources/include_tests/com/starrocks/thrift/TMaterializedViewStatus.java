...
public class TMaterializedViewStatus implements org.apache.thrift.TBase<TMaterializedViewStatus, TMaterializedViewStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TMaterializedViewStatus> {
  ...
  private static final org.apache.thrift.protocol.TField QUERY_REWRITE_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("query_rewrite_status", org.apache.thrift.protocol.TType.STRING, (short)27);
  private static final org.apache.thrift.protocol.TField CREATOR_FIELD_DESC = new org.apache.thrift.protocol.TField("creator", org.apache.thrift.protocol.TType.STRING, (short)28);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String query_rewrite_status; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String creator; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    QUERY_REWRITE_STATUS((short)27, "query_rewrite_status"),
    CREATOR((short)28, "creator");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 27: // QUERY_REWRITE_STATUS
          return QUERY_REWRITE_STATUS;
        case 28: // CREATOR
          return CREATOR;
        default:
          return null;
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.DATABASE_NAME,_Fields.NAME,_Fields.REFRESH_TYPE,_Fields.IS_ACTIVE,_Fields.LAST_REFRESH_START_TIME,_Fields.LAST_REFRESH_FINISHED_TIME,_Fields.LAST_REFRESH_DURATION,_Fields.LAST_REFRESH_STATE,_Fields.LAST_REFRESH_ERROR_CODE,_Fields.LAST_REFRESH_ERROR_MESSAGE,_Fields.TEXT,_Fields.ROWS,_Fields.PARTITION_TYPE,_Fields.LAST_REFRESH_FORCE_REFRESH,_Fields.LAST_REFRESH_START_PARTITION,_Fields.LAST_REFRESH_END_PARTITION,_Fields.LAST_REFRESH_BASE_REFRESH_PARTITIONS,_Fields.LAST_REFRESH_MV_REFRESH_PARTITIONS,_Fields.LAST_CHECK_TIME,_Fields.CREATE_TIME,_Fields.DDL_SQL,_Fields.TASK_ID,_Fields.TASK_NAME,_Fields.INACTIVE_REASON,_Fields.EXTRA_MESSAGE,_Fields.QUERY_REWRITE_STATUS,_Fields.CREATOR};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXTRA_MESSAGE, new org.apache.thrift.meta_data.FieldMetaData("extra_message", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.QUERY_REWRITE_STATUS, new org.apache.thrift.meta_data.FieldMetaData("query_rewrite_status", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public TMaterializedViewStatus(TMaterializedViewStatus other) {
    ...
    if (other.isSetQuery_rewrite_status()) {
      this.query_rewrite_status = other.query_rewrite_status;
    }
  ...
  public void clear() {
    ...
    this.query_rewrite_status = null;
    this.creator = null;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getQuery_rewrite_status() {
    return this.query_rewrite_status;
  }

  public TMaterializedViewStatus setQuery_rewrite_status(@org.apache.thrift.annotation.Nullable java.lang.String query_rewrite_status) {
    this.query_rewrite_status = query_rewrite_status;
    return this;
  }

  public void unsetQuery_rewrite_status() {
    this.query_rewrite_status = null;
  }

  /** Returns true if field query_rewrite_status is set (has been assigned a value) and false otherwise */
  public boolean isSetQuery_rewrite_status() {
    return this.query_rewrite_status != null;
  }

  public void setQuery_rewrite_statusIsSet(boolean value) {
    if (!value) {
      this.query_rewrite_status = null;
    }
  }
  ...
  public TMaterializedViewStatus setCreator(@org.apache.thrift.annotation.Nullable java.lang.String creator) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case QUERY_REWRITE_STATUS:
      if (value == null) {
        unsetQuery_rewrite_status();
      } else {
        setQuery_rewrite_status((java.lang.String)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case QUERY_REWRITE_STATUS:
      return getQuery_rewrite_status();
  ...
  public boolean isSet(_Fields field) {
    ...
    case QUERY_REWRITE_STATUS:
      return isSetQuery_rewrite_status();
    case CREATOR:
      return isSetCreator();
    }
    throw new java.lang.IllegalStateException();
  ...
  public boolean equals(TMaterializedViewStatus that) {
    ...
    boolean this_present_query_rewrite_status = true && this.isSetQuery_rewrite_status();
    boolean that_present_query_rewrite_status = true && that.isSetQuery_rewrite_status();
    if (this_present_query_rewrite_status || that_present_query_rewrite_status) {
      if (!(this_present_query_rewrite_status && that_present_query_rewrite_status))
        return false;
      if (!this.query_rewrite_status.equals(that.query_rewrite_status))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetQuery_rewrite_status()) ? 131071 : 524287);
    if (isSetQuery_rewrite_status())
      hashCode = hashCode * 8191 + query_rewrite_status.hashCode();
  ...
  public int compareTo(TMaterializedViewStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetQuery_rewrite_status(), other.isSetQuery_rewrite_status());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQuery_rewrite_status()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.query_rewrite_status, other.query_rewrite_status);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetQuery_rewrite_status()) {
      if (!first) sb.append(", ");
      sb.append("query_rewrite_status:");
      if (this.query_rewrite_status == null) {
        sb.append("null");
      } else {
        sb.append(this.query_rewrite_status);
      }
      first = false;
    }
    if (isSetCreator()) {
  ...
  private static class TMaterializedViewStatusStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMaterializedViewStatus> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TMaterializedViewStatus struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 27: // QUERY_REWRITE_STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.query_rewrite_status = iprot.readString();
              struct.setQuery_rewrite_statusIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMaterializedViewStatus struct) throws org.apache.thrift.TException {
      ...
      if (struct.query_rewrite_status != null) {
        if (struct.isSetQuery_rewrite_status()) {
          oprot.writeFieldBegin(QUERY_REWRITE_STATUS_FIELD_DESC);
          oprot.writeString(struct.query_rewrite_status);
          oprot.writeFieldEnd();
        }
      }
