    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter124 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBroker_prop()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter125 : struct.broker_prop.entrySet())
            {
  ...
  private static class TUploadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUploadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter126 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBroker_prop()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter127 : struct.broker_prop.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJob_idIsSet(true);
      {
        ...
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map128.size);
        ...
        for (int _i131 = 0; _i131 < _map128.size; ++_i131)
        {
          ...
          struct.src_dest_map.put(_key129, _val130);
        }
      }
      struct.setSrc_dest_mapIsSet(true);
      struct.broker_addr = new com.starrocks.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map132 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map132.size);
          ...
          for (int _i135 = 0; _i135 < _map132.size; ++_i135)
          {
            ...
            struct.broker_prop.put(_key133, _val134);
          }
        }
        struct.setBroker_propIsSet(true);
      }
