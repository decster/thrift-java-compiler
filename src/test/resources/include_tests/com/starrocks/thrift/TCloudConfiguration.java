...
public class TCloudConfiguration implements org.apache.thrift.TBase<TCloudConfiguration, TCloudConfiguration._Fields>, java.io.Serializable, Cloneable, Comparable<TCloudConfiguration> {
  ...
  private static final org.apache.thrift.protocol.TField DEPRECATED_CLOUD_PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField("deprecated_cloud_properties", org.apache.thrift.protocol.TType.LIST, (short)2);
  private static final org.apache.thrift.protocol.TField CLOUD_PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField("cloud_properties", org.apache.thrift.protocol.TType.MAP, (short)3);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TCloudProperty> deprecated_cloud_properties; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> cloud_properties; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DEPRECATED_CLOUD_PROPERTIES((short)2, "deprecated_cloud_properties"),
    CLOUD_PROPERTIES((short)3, "cloud_properties");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // CLOUD_TYPE
          return CLOUD_TYPE;
        case 2: // DEPRECATED_CLOUD_PROPERTIES
          return DEPRECATED_CLOUD_PROPERTIES;
        case 3: // CLOUD_PROPERTIES
  ...
  private static final _Fields optionals[] = {_Fields.CLOUD_TYPE,_Fields.DEPRECATED_CLOUD_PROPERTIES,_Fields.CLOUD_PROPERTIES};
  ...
  static {
    ...
    tmpMap.put(_Fields.DEPRECATED_CLOUD_PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("deprecated_cloud_properties", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TCloudConfiguration(TCloudConfiguration other) {
    ...
    if (other.isSetDeprecated_cloud_properties()) {
      java.util.List<TCloudProperty> __this__deprecated_cloud_properties = new java.util.ArrayList<TCloudProperty>(other.deprecated_cloud_properties.size());
      for (TCloudProperty other_element : other.deprecated_cloud_properties) {
        __this__deprecated_cloud_properties.add(new TCloudProperty(other_element));
      }
      this.deprecated_cloud_properties = __this__deprecated_cloud_properties;
    }
    if (other.isSetCloud_properties()) {
      java.util.Map<java.lang.String,java.lang.String> __this__cloud_properties = new java.util.HashMap<java.lang.String,java.lang.String>(other.cloud_properties);
  ...
  public void clear() {
    ...
    this.deprecated_cloud_properties = null;
  ...
  public int getDeprecated_cloud_propertiesSize() {
    return (this.deprecated_cloud_properties == null) ? 0 : this.deprecated_cloud_properties.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<TCloudProperty> getDeprecated_cloud_propertiesIterator() {
    return (this.deprecated_cloud_properties == null) ? null : this.deprecated_cloud_properties.iterator();
  }

  public void addToDeprecated_cloud_properties(TCloudProperty elem) {
    if (this.deprecated_cloud_properties == null) {
      this.deprecated_cloud_properties = new java.util.ArrayList<TCloudProperty>();
    }
    this.deprecated_cloud_properties.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<TCloudProperty> getDeprecated_cloud_properties() {
    return this.deprecated_cloud_properties;
  }

  public TCloudConfiguration setDeprecated_cloud_properties(@org.apache.thrift.annotation.Nullable java.util.List<TCloudProperty> deprecated_cloud_properties) {
    this.deprecated_cloud_properties = deprecated_cloud_properties;
    return this;
  }

  public void unsetDeprecated_cloud_properties() {
    this.deprecated_cloud_properties = null;
  }

  /** Returns true if field deprecated_cloud_properties is set (has been assigned a value) and false otherwise */
  public boolean isSetDeprecated_cloud_properties() {
    return this.deprecated_cloud_properties != null;
  }

  public void setDeprecated_cloud_propertiesIsSet(boolean value) {
    if (!value) {
      this.deprecated_cloud_properties = null;
    }
  }
  ...
  public void putToCloud_properties(java.lang.String key, java.lang.String val) {
    if (this.cloud_properties == null) {
      this.cloud_properties = new java.util.HashMap<java.lang.String,java.lang.String>();
    }
    this.cloud_properties.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.lang.String> getCloud_properties() {
    return this.cloud_properties;
  }

  public TCloudConfiguration setCloud_properties(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> cloud_properties) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DEPRECATED_CLOUD_PROPERTIES:
      if (value == null) {
        unsetDeprecated_cloud_properties();
      } else {
        setDeprecated_cloud_properties((java.util.List<TCloudProperty>)value);
      }
      break;
    ...
    case CLOUD_PROPERTIES:
      if (value == null) {
        ...
        setCloud_properties((java.util.Map<java.lang.String,java.lang.String>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case DEPRECATED_CLOUD_PROPERTIES:
      return getDeprecated_cloud_properties();
  ...
  public boolean isSet(_Fields field) {
    ...
    case DEPRECATED_CLOUD_PROPERTIES:
      return isSetDeprecated_cloud_properties();
    case CLOUD_PROPERTIES:
  ...
  public boolean equals(TCloudConfiguration that) {
    ...
    boolean this_present_deprecated_cloud_properties = true && this.isSetDeprecated_cloud_properties();
    boolean that_present_deprecated_cloud_properties = true && that.isSetDeprecated_cloud_properties();
    if (this_present_deprecated_cloud_properties || that_present_deprecated_cloud_properties) {
      if (!(this_present_deprecated_cloud_properties && that_present_deprecated_cloud_properties))
        return false;
      if (!this.deprecated_cloud_properties.equals(that.deprecated_cloud_properties))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDeprecated_cloud_properties()) ? 131071 : 524287);
    if (isSetDeprecated_cloud_properties())
      hashCode = hashCode * 8191 + deprecated_cloud_properties.hashCode();
  ...
  public int compareTo(TCloudConfiguration other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDeprecated_cloud_properties(), other.isSetDeprecated_cloud_properties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeprecated_cloud_properties()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.deprecated_cloud_properties, other.deprecated_cloud_properties);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetDeprecated_cloud_properties()) {
      if (!first) sb.append(", ");
      sb.append("deprecated_cloud_properties:");
      if (this.deprecated_cloud_properties == null) {
        sb.append("null");
      } else {
        sb.append(this.deprecated_cloud_properties);
      }
      first = false;
    }
    if (isSetCloud_properties()) {
  ...
  private static class TCloudConfigurationStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCloudConfiguration> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deprecated_cloud_properties = new java.util.ArrayList<TCloudProperty>(_list0.size);
                @org.apache.thrift.annotation.Nullable TCloudProperty _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TCloudProperty();
                  _elem1.read(iprot);
                  struct.deprecated_cloud_properties.add(_elem1);
                }
                iprot.readListEnd();
              }
              struct.setDeprecated_cloud_propertiesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cloud_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map3.size);
                ...
                for (int _i6 = 0; _i6 < _map3.size; ++_i6)
                {
                  ...
                  struct.cloud_properties.put(_key4, _val5);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCloudConfiguration struct) throws org.apache.thrift.TException {
      ...
      if (struct.deprecated_cloud_properties != null) {
        if (struct.isSetDeprecated_cloud_properties()) {
          oprot.writeFieldBegin(DEPRECATED_CLOUD_PROPERTIES_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.deprecated_cloud_properties.size()));
            for (TCloudProperty _iter7 : struct.deprecated_cloud_properties)
            {
              _iter7.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.cloud_properties != null) {
        if (struct.isSetCloud_properties()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.cloud_properties.size()));
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter8 : struct.cloud_properties.entrySet())
            {
  ...
  private static class TCloudConfigurationTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCloudConfiguration> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TCloudConfiguration struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetDeprecated_cloud_properties()) {
        {
          oprot.writeI32(struct.deprecated_cloud_properties.size());
          for (TCloudProperty _iter9 : struct.deprecated_cloud_properties)
          {
            _iter9.write(oprot);
          }
        }
      ...
      if (struct.isSetCloud_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter10 : struct.cloud_properties.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.deprecated_cloud_properties = new java.util.ArrayList<TCloudProperty>(_list11.size);
          @org.apache.thrift.annotation.Nullable TCloudProperty _elem12;
          for (int _i13 = 0; _i13 < _list11.size; ++_i13)
          {
            _elem12 = new TCloudProperty();
            _elem12.read(iprot);
            struct.deprecated_cloud_properties.add(_elem12);
          }
        }
        struct.setDeprecated_cloud_propertiesIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.cloud_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map14.size);
          ...
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.cloud_properties.put(_key15, _val16);
          }
        }
        struct.setCloud_propertiesIsSet(true);
      }
