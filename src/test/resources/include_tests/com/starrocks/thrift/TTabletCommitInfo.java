            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invalid_dict_cache_columns = new java.util.ArrayList<java.lang.String>(_list56.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.invalid_dict_cache_columns.add(_elem57);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.valid_dict_cache_columns = new java.util.ArrayList<java.lang.String>(_list59.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem60;
                for (int _i61 = 0; _i61 < _list59.size; ++_i61)
                {
                  _elem60 = iprot.readString();
                  struct.valid_dict_cache_columns.add(_elem60);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.valid_dict_collected_versions = new java.util.ArrayList<java.lang.Long>(_list62.size);
                long _elem63;
                for (int _i64 = 0; _i64 < _list62.size; ++_i64)
                {
                  _elem63 = iprot.readI64();
                  struct.valid_dict_collected_versions.add(_elem63);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.invalid_dict_cache_columns != null) {
        if (struct.isSetInvalid_dict_cache_columns()) {
          oprot.writeFieldBegin(INVALID_DICT_CACHE_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter65 : struct.invalid_dict_cache_columns)
            {
      ...
      if (struct.valid_dict_cache_columns != null) {
        if (struct.isSetValid_dict_cache_columns()) {
          oprot.writeFieldBegin(VALID_DICT_CACHE_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter66 : struct.valid_dict_cache_columns)
            {
      ...
      if (struct.valid_dict_collected_versions != null) {
        if (struct.isSetValid_dict_collected_versions()) {
          oprot.writeFieldBegin(VALID_DICT_COLLECTED_VERSIONS_FIELD_DESC);
          {
            ...
            for (long _iter67 : struct.valid_dict_collected_versions)
            {
      ...
      if (struct.isSetInvalid_dict_cache_columns()) {
        {
          ...
          for (java.lang.String _iter68 : struct.invalid_dict_cache_columns)
          {
      ...
      if (struct.isSetValid_dict_cache_columns()) {
        {
          ...
          for (java.lang.String _iter69 : struct.valid_dict_cache_columns)
          {
      ...
      if (struct.isSetValid_dict_collected_versions()) {
        {
          ...
          for (long _iter70 : struct.valid_dict_collected_versions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.invalid_dict_cache_columns = new java.util.ArrayList<java.lang.String>(_list71.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = iprot.readString();
            struct.invalid_dict_cache_columns.add(_elem72);
          }
        }
        struct.setInvalid_dict_cache_columnsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.valid_dict_cache_columns = new java.util.ArrayList<java.lang.String>(_list74.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem75;
          for (int _i76 = 0; _i76 < _list74.size; ++_i76)
          {
            _elem75 = iprot.readString();
            struct.valid_dict_cache_columns.add(_elem75);
          }
        }
        struct.setValid_dict_cache_columnsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.valid_dict_collected_versions = new java.util.ArrayList<java.lang.Long>(_list77.size);
          long _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = iprot.readI64();
            struct.valid_dict_collected_versions.add(_elem78);
          }
        }
        struct.setValid_dict_collected_versionsIsSet(true);
      }
