...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletCommitInfo _iter356 : struct.commitInfos)
            {
      ...
      if (struct.failInfos != null) {
        if (struct.isSetFailInfos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletFailInfo _iter357 : struct.failInfos)
            {
  ...
  private static class TLoadTxnCommitRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLoadTxnCommitRequest> {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletCommitInfo _iter358 : struct.commitInfos)
          {
      ...
      if (struct.isSetFailInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletFailInfo _iter359 : struct.failInfos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLoadTxnCommitRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list360 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.commitInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list360.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem361;
          for (int _i362 = 0; _i362 < _list360.size; ++_i362)
          {
            _elem361 = new com.starrocks.thrift.TTabletCommitInfo();
            _elem361.read(iprot);
            struct.commitInfos.add(_elem361);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.failInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list363.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem364;
          for (int _i365 = 0; _i365 < _list363.size; ++_i365)
          {
            _elem364 = new com.starrocks.thrift.TTabletFailInfo();
            _elem364.read(iprot);
            struct.failInfos.add(_elem364);
          }
        }
        struct.setFailInfosIsSet(true);
      }
