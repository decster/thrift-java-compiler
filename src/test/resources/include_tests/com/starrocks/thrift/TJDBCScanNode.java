...
public class TJDBCScanNode implements org.apache.thrift.TBase<TJDBCScanNode, TJDBCScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TJDBCScanNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list326.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new java.util.ArrayList<java.lang.String>(_list329.size);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter332 : struct.columns)
            {
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter333 : struct.filters)
            {
  ...
  private static class TJDBCScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TJDBCScanNode> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter334 : struct.columns)
          {
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (java.lang.String _iter335 : struct.filters)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TJDBCScanNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list336 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.columns = new java.util.ArrayList<java.lang.String>(_list336.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem337;
          for (int _i338 = 0; _i338 < _list336.size; ++_i338)
          {
            _elem337 = iprot.readString();
            struct.columns.add(_elem337);
          }
        }
        struct.setColumnsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list339 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.filters = new java.util.ArrayList<java.lang.String>(_list339.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem340;
          for (int _i341 = 0; _i341 < _list339.size; ++_i341)
          {
            _elem340 = iprot.readString();
            struct.filters.add(_elem340);
          }
        }
        struct.setFiltersIsSet(true);
      }
