...
public class TTableReplicationRequest implements org.apache.thrift.TBase<TTableReplicationRequest, TTableReplicationRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TTableReplicationRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partition_replication_infos = new java.util.HashMap<java.lang.Long,TPartitionReplicationInfo>(2*_map844.size);
                long _key845;
                @org.apache.thrift.annotation.Nullable TPartitionReplicationInfo _val846;
                for (int _i847 = 0; _i847 < _map844.size; ++_i847)
                {
                  _key845 = iprot.readI64();
                  _val846 = new TPartitionReplicationInfo();
                  _val846.read(iprot);
                  struct.partition_replication_infos.put(_key845, _val846);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.partition_replication_infos != null) {
        if (struct.isSetPartition_replication_infos()) {
          oprot.writeFieldBegin(PARTITION_REPLICATION_INFOS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, TPartitionReplicationInfo> _iter848 : struct.partition_replication_infos.entrySet())
            {
              oprot.writeI64(_iter848.getKey());
  ...
  private static class TTableReplicationRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableReplicationRequest> {
      ...
      if (struct.isSetPartition_replication_infos()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TPartitionReplicationInfo> _iter849 : struct.partition_replication_infos.entrySet())
          {
            oprot.writeI64(_iter849.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableReplicationRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map850 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.partition_replication_infos = new java.util.HashMap<java.lang.Long,TPartitionReplicationInfo>(2*_map850.size);
          long _key851;
          @org.apache.thrift.annotation.Nullable TPartitionReplicationInfo _val852;
          for (int _i853 = 0; _i853 < _map850.size; ++_i853)
          {
            _key851 = iprot.readI64();
            _val852 = new TPartitionReplicationInfo();
            _val852.read(iprot);
            struct.partition_replication_infos.put(_key851, _val852);
          }
        }
        struct.setPartition_replication_infosIsSet(true);
      }
