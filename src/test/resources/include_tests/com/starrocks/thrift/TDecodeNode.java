...
public class TDecodeNode implements org.apache.thrift.TBase<TDecodeNode, TDecodeNode._Fields>, java.io.Serializable, Cloneable, Comparable<TDecodeNode> {
        ...
        switch (schemeField.id) {
          case 1: // DICT_ID_TO_STRING_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map966 = iprot.readMapBegin();
                struct.dict_id_to_string_ids = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map966.size);
                int _key967;
                int _val968;
                for (int _i969 = 0; _i969 < _map966.size; ++_i969)
                {
                  _key967 = iprot.readI32();
                  _val968 = iprot.readI32();
                  struct.dict_id_to_string_ids.put(_key967, _val968);
                }
                iprot.readMapEnd();
              }
          ...
          case 2: // STRING_FUNCTIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map970 = iprot.readMapBegin();
                struct.string_functions = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map970.size);
                int _key971;
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val972;
                for (int _i973 = 0; _i973 < _map970.size; ++_i973)
                {
                  _key971 = iprot.readI32();
                  _val972 = new com.starrocks.thrift.TExpr();
                  _val972.read(iprot);
                  struct.string_functions.put(_key971, _val972);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.dict_id_to_string_ids != null) {
        if (struct.isSetDict_id_to_string_ids()) {
          oprot.writeFieldBegin(DICT_ID_TO_STRING_IDS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter974 : struct.dict_id_to_string_ids.entrySet())
            {
              oprot.writeI32(_iter974.getKey());
      ...
      if (struct.string_functions != null) {
        if (struct.isSetString_functions()) {
          oprot.writeFieldBegin(STRING_FUNCTIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter975 : struct.string_functions.entrySet())
            {
              oprot.writeI32(_iter975.getKey());
              _iter975.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TDecodeNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDecodeNode> {
      ...
      if (struct.isSetDict_id_to_string_ids()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter976 : struct.dict_id_to_string_ids.entrySet())
          {
            oprot.writeI32(_iter976.getKey());
            oprot.writeI32(_iter976.getValue());
          }
        }
      }
      if (struct.isSetString_functions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter977 : struct.string_functions.entrySet())
          {
            oprot.writeI32(_iter977.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDecodeNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map978 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32); 
          struct.dict_id_to_string_ids = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map978.size);
          int _key979;
          int _val980;
          for (int _i981 = 0; _i981 < _map978.size; ++_i981)
          {
            _key979 = iprot.readI32();
            _val980 = iprot.readI32();
            struct.dict_id_to_string_ids.put(_key979, _val980);
          }
        }
        struct.setDict_id_to_string_idsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map982 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.string_functions = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map982.size);
          int _key983;
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val984;
          for (int _i985 = 0; _i985 < _map982.size; ++_i985)
          {
            _key983 = iprot.readI32();
            _val984 = new com.starrocks.thrift.TExpr();
            _val984.read(iprot);
            struct.string_functions.put(_key983, _val984);
          }
        }
        struct.setString_functionsIsSet(true);
      }
