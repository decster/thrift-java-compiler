...
public class TDictionaryGetExpr implements org.apache.thrift.TBase<TDictionaryGetExpr, TDictionaryGetExpr._Fields>, java.io.Serializable, Cloneable, Comparable<TDictionaryGetExpr> {
  ...
  private static final org.apache.thrift.protocol.TField NULL_IF_NOT_EXIST_FIELD_DESC = new org.apache.thrift.protocol.TField("null_if_not_exist", org.apache.thrift.protocol.TType.BOOL, (short)4);
  ...
  public boolean null_if_not_exist; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NULL_IF_NOT_EXIST((short)4, "null_if_not_exist");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // KEY_SIZE
          return KEY_SIZE;
        case 4: // NULL_IF_NOT_EXIST
          return NULL_IF_NOT_EXIST;
        default:
          return null;
      }
    }
  ...
  private static final int __NULL_IF_NOT_EXIST_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.DICT_ID,_Fields.TXN_ID,_Fields.KEY_SIZE,_Fields.NULL_IF_NOT_EXIST};
  ...
  static {
    ...
    tmpMap.put(_Fields.NULL_IF_NOT_EXIST, new org.apache.thrift.meta_data.FieldMetaData("null_if_not_exist", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TDictionaryGetExpr(TDictionaryGetExpr other) {
    ...
    this.null_if_not_exist = other.null_if_not_exist;
  }
  ...
  public void clear() {
    ...
    this.key_size = 0;
    setNull_if_not_existIsSet(false);
    this.null_if_not_exist = false;
  }
  ...
  public boolean isNull_if_not_exist() {
    return this.null_if_not_exist;
  }

  public TDictionaryGetExpr setNull_if_not_exist(boolean null_if_not_exist) {
    this.null_if_not_exist = null_if_not_exist;
    setNull_if_not_existIsSet(true);
    return this;
  }

  public void unsetNull_if_not_exist() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __NULL_IF_NOT_EXIST_ISSET_ID);
  }

  /** Returns true if field null_if_not_exist is set (has been assigned a value) and false otherwise */
  public boolean isSetNull_if_not_exist() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __NULL_IF_NOT_EXIST_ISSET_ID);
  }

  public void setNull_if_not_existIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __NULL_IF_NOT_EXIST_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case NULL_IF_NOT_EXIST:
      if (value == null) {
        unsetNull_if_not_exist();
      } else {
        setNull_if_not_exist((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TDictionaryGetExpr that) {
    ...
    boolean this_present_null_if_not_exist = true && this.isSetNull_if_not_exist();
    boolean that_present_null_if_not_exist = true && that.isSetNull_if_not_exist();
    if (this_present_null_if_not_exist || that_present_null_if_not_exist) {
      if (!(this_present_null_if_not_exist && that_present_null_if_not_exist))
        return false;
      if (this.null_if_not_exist != that.null_if_not_exist)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetNull_if_not_exist()) ? 131071 : 524287);
    if (isSetNull_if_not_exist())
      hashCode = hashCode * 8191 + ((null_if_not_exist) ? 131071 : 524287);
  ...
  public int compareTo(TDictionaryGetExpr other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNull_if_not_exist(), other.isSetNull_if_not_exist());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNull_if_not_exist()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.null_if_not_exist, other.null_if_not_exist);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetNull_if_not_exist()) {
      if (!first) sb.append(", ");
      sb.append("null_if_not_exist:");
      sb.append(this.null_if_not_exist);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TDictionaryGetExprStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDictionaryGetExpr> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // NULL_IF_NOT_EXIST
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.null_if_not_exist = iprot.readBool();
              struct.setNull_if_not_existIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDictionaryGetExpr struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNull_if_not_exist()) {
        oprot.writeFieldBegin(NULL_IF_NOT_EXIST_FIELD_DESC);
        oprot.writeBool(struct.null_if_not_exist);
        oprot.writeFieldEnd();
      }
