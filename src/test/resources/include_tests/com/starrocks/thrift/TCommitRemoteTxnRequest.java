...
public class TCommitRemoteTxnRequest implements org.apache.thrift.TBase<TCommitRemoteTxnRequest, TCommitRemoteTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TCommitRemoteTxnRequest> {
      ...
      if (struct.commit_infos != null) {
        if (struct.isSetCommit_infos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletCommitInfo _iter566 : struct.commit_infos)
            {
      ...
      if (struct.fail_infos != null) {
        if (struct.isSetFail_infos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletFailInfo _iter567 : struct.fail_infos)
            {
  ...
  private static class TCommitRemoteTxnRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCommitRemoteTxnRequest> {
      ...
      if (struct.isSetCommit_infos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletCommitInfo _iter568 : struct.commit_infos)
          {
      ...
      if (struct.isSetFail_infos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletFailInfo _iter569 : struct.fail_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCommitRemoteTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list570 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.commit_infos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list570.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem571;
          for (int _i572 = 0; _i572 < _list570.size; ++_i572)
          {
            _elem571 = new com.starrocks.thrift.TTabletCommitInfo();
            _elem571.read(iprot);
            struct.commit_infos.add(_elem571);
          }
        }
        struct.setCommit_infosIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.fail_infos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list573.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem574;
          for (int _i575 = 0; _i575 < _list573.size; ++_i575)
          {
            _elem574 = new com.starrocks.thrift.TTabletFailInfo();
            _elem574.read(iprot);
            struct.fail_infos.add(_elem574);
          }
        }
        struct.setFail_infosIsSet(true);
      }
