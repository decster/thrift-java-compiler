...
public class TFinishTaskRequest implements org.apache.thrift.TBase<TFinishTaskRequest, TFinishTaskRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TFinishTaskRequest> {
  ...
  private static final org.apache.thrift.protocol.TField SNAPSHOT_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("snapshot_info", org.apache.thrift.protocol.TType.STRUCT, (short)19);
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TSnapshotInfo snapshot_info; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SNAPSHOT_INFO((short)19, "snapshot_info");
  ...
  static {
    ...
    tmpMap.put(_Fields.TABLET_PUBLISH_VERSIONS, new org.apache.thrift.meta_data.FieldMetaData("tablet_publish_versions", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TTabletVersionPair.class))));
    tmpMap.put(_Fields.SNAPSHOT_INFO, new org.apache.thrift.meta_data.FieldMetaData("snapshot_info", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TFinishTaskRequest(TFinishTaskRequest other) {
    ...
    if (other.isSetSnapshot_info()) {
      this.snapshot_info = new com.starrocks.thrift.TSnapshotInfo(other.snapshot_info);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TSnapshotInfo getSnapshot_info() {
    return this.snapshot_info;
  }

  public TFinishTaskRequest setSnapshot_info(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TSnapshotInfo snapshot_info) {
    this.snapshot_info = snapshot_info;
    return this;
  }

  public void unsetSnapshot_info() {
    this.snapshot_info = null;
  }

  /** Returns true if field snapshot_info is set (has been assigned a value) and false otherwise */
  public boolean isSetSnapshot_info() {
    return this.snapshot_info != null;
  }

  public void setSnapshot_infoIsSet(boolean value) {
    if (!value) {
      this.snapshot_info = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SNAPSHOT_INFO:
      if (value == null) {
        ...
        setSnapshot_info((com.starrocks.thrift.TSnapshotInfo)value);
      }
      break;
  ...
  public boolean equals(TFinishTaskRequest that) {
    ...
    boolean this_present_snapshot_info = true && this.isSetSnapshot_info();
    boolean that_present_snapshot_info = true && that.isSetSnapshot_info();
    if (this_present_snapshot_info || that_present_snapshot_info) {
      if (!(this_present_snapshot_info && that_present_snapshot_info))
        return false;
      if (!this.snapshot_info.equals(that.snapshot_info))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSnapshot_info()) ? 131071 : 524287);
    if (isSetSnapshot_info())
      hashCode = hashCode * 8191 + snapshot_info.hashCode();
  ...
  public int compareTo(TFinishTaskRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSnapshot_info(), other.isSetSnapshot_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSnapshot_info()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.snapshot_info, other.snapshot_info);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSnapshot_info()) {
      if (!first) sb.append(", ");
      sb.append("snapshot_info:");
      if (this.snapshot_info == null) {
        sb.append("null");
      } else {
        sb.append(this.snapshot_info);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TFinishTaskRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFinishTaskRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TFinishTaskRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 19: // SNAPSHOT_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.snapshot_info = new com.starrocks.thrift.TSnapshotInfo();
              struct.snapshot_info.read(iprot);
              struct.setSnapshot_infoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFinishTaskRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.snapshot_info != null) {
        if (struct.isSetSnapshot_info()) {
          oprot.writeFieldBegin(SNAPSHOT_INFO_FIELD_DESC);
          struct.snapshot_info.write(oprot);
          oprot.writeFieldEnd();
        }
      }
