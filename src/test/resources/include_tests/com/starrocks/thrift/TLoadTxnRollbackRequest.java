...
public class TLoadTxnRollbackRequest implements org.apache.thrift.TBase<TLoadTxnRollbackRequest, TLoadTxnRollbackRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnRollbackRequest> {
      ...
      if (struct.failInfos != null) {
        if (struct.isSetFailInfos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletFailInfo _iter372 : struct.failInfos)
            {
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletCommitInfo _iter373 : struct.commitInfos)
            {
  ...
  private static class TLoadTxnRollbackRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLoadTxnRollbackRequest> {
      ...
      if (struct.isSetFailInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletFailInfo _iter374 : struct.failInfos)
          {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletCommitInfo _iter375 : struct.commitInfos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLoadTxnRollbackRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list376 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.failInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list376.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem377;
          for (int _i378 = 0; _i378 < _list376.size; ++_i378)
          {
            _elem377 = new com.starrocks.thrift.TTabletFailInfo();
            _elem377.read(iprot);
            struct.failInfos.add(_elem377);
          }
        }
        struct.setFailInfosIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list379.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem380;
          for (int _i381 = 0; _i381 < _list379.size; ++_i381)
          {
            _elem380 = new com.starrocks.thrift.TTabletCommitInfo();
            _elem380.read(iprot);
            struct.commitInfos.add(_elem380);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
