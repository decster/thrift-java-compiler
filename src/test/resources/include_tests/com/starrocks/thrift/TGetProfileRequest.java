...
public class TGetProfileRequest implements org.apache.thrift.TBase<TGetProfileRequest, TGetProfileRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TGetProfileRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.query_id = new java.util.ArrayList<java.lang.String>(_list800.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem801;
                for (int _i802 = 0; _i802 < _list800.size; ++_i802)
                {
                  _elem801 = iprot.readString();
                  struct.query_id.add(_elem801);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.query_id != null) {
        if (struct.isSetQuery_id()) {
          oprot.writeFieldBegin(QUERY_ID_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter803 : struct.query_id)
            {
  ...
  private static class TGetProfileRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetProfileRequest> {
      ...
      if (struct.isSetQuery_id()) {
        {
          ...
          for (java.lang.String _iter804 : struct.query_id)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetProfileRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list805 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.query_id = new java.util.ArrayList<java.lang.String>(_list805.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem806;
          for (int _i807 = 0; _i807 < _list805.size; ++_i807)
          {
            _elem806 = iprot.readString();
            struct.query_id.add(_elem806);
          }
        }
        struct.setQuery_idIsSet(true);
      }
