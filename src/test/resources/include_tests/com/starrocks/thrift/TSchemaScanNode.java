            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.frontends = new java.util.ArrayList<TFrontend>(_list226.size);
                @org.apache.thrift.annotation.Nullable TFrontend _elem227;
                for (int _i228 = 0; _i228 < _list226.size; ++_i228)
                {
                  _elem227 = new TFrontend();
                  _elem227.read(iprot);
                  struct.frontends.add(_elem227);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.frontends != null) {
        if (struct.isSetFrontends()) {
          oprot.writeFieldBegin(FRONTENDS_FIELD_DESC);
          {
            ...
            for (TFrontend _iter229 : struct.frontends)
            {
      ...
      if (struct.isSetFrontends()) {
        {
          ...
          for (TFrontend _iter230 : struct.frontends)
          {
      ...
      if (incoming.get(23)) {
        {
          ...
          struct.frontends = new java.util.ArrayList<TFrontend>(_list231.size);
          @org.apache.thrift.annotation.Nullable TFrontend _elem232;
          for (int _i233 = 0; _i233 < _list231.size; ++_i233)
          {
            _elem232 = new TFrontend();
            _elem232.read(iprot);
            struct.frontends.add(_elem232);
          }
        }
        struct.setFrontendsIsSet(true);
      }
