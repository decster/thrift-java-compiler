...
public class TDataStreamSink implements org.apache.thrift.TBase<TDataStreamSink, TDataStreamSink._Fields>, java.io.Serializable, Cloneable, Comparable<TDataStreamSink> {
  ...
  public TDataStreamSink(TDataStreamSink other) {
    ...
    if (other.isSetOutput_columns()) {
      java.util.List<java.lang.Integer> __this__output_columns = new java.util.ArrayList<java.lang.Integer>(other.output_columns);
  ...
  public TDataStreamSink setOutput_columns(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> output_columns) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IGNORE_NOT_FOUND:
      if (value == null) {
        ...
        setIgnore_not_found((java.lang.Boolean)value);
      }
      break;
    ...
    case IS_MERGE:
      if (value == null) {
        ...
        setIs_merge((java.lang.Boolean)value);
      }
      break;
    ...
    case DEST_DOP:
      if (value == null) {
        ...
        setDest_dop((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(TDataStreamSink other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOutput_partition(), other.isSetOutput_partition());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOutput_partition()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIgnore_not_found(), other.isSetIgnore_not_found());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIgnore_not_found()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_merge(), other.isSetIs_merge());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_merge()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDest_dop(), other.isSetDest_dop());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDest_dop()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list26.size);
                int _elem27;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list31.size);
          int _elem32;
