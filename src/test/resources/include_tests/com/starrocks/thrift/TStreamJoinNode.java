            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list1018.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem1019;
                for (int _i1020 = 0; _i1020 < _list1018.size; ++_i1020)
                {
                  _elem1019 = new TEqJoinCondition();
                  _elem1019.read(iprot);
                  struct.eq_join_conjuncts.add(_elem1019);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1021.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1022;
                for (int _i1023 = 0; _i1023 < _list1021.size; ++_i1023)
                {
                  _elem1022 = new com.starrocks.thrift.TExpr();
                  _elem1022.read(iprot);
                  struct.other_join_conjuncts.add(_elem1022);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1024.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1025;
                for (int _i1026 = 0; _i1026 < _list1024.size; ++_i1026)
                {
                  _elem1025 = new com.starrocks.thrift.TExpr();
                  _elem1025.read(iprot);
                  struct.partition_exprs.add(_elem1025);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list1027.size);
                int _elem1028;
                for (int _i1029 = 0; _i1029 < _list1027.size; ++_i1029)
                {
                  _elem1028 = iprot.readI32();
                  struct.output_columns.add(_elem1028);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter1030 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter1031 : struct.other_join_conjuncts)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter1032 : struct.partition_exprs)
            {
      ...
      if (struct.output_columns != null) {
        if (struct.isSetOutput_columns()) {
          oprot.writeFieldBegin(OUTPUT_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter1033 : struct.output_columns)
            {
              oprot.writeI32(_iter1033);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TStreamJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TStreamJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.join_op.getValue());
      {
        ...
        for (TEqJoinCondition _iter1034 : struct.eq_join_conjuncts)
        {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter1035 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter1036 : struct.partition_exprs)
          {
      ...
      if (struct.isSetOutput_columns()) {
        {
          ...
          for (int _iter1037 : struct.output_columns)
          {
            oprot.writeI32(_iter1037);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      ...
      struct.setJoin_opIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1038 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list1038.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem1039;
        for (int _i1040 = 0; _i1040 < _list1038.size; ++_i1040)
        {
          _elem1039 = new TEqJoinCondition();
          _elem1039.read(iprot);
          struct.eq_join_conjuncts.add(_elem1039);
        }
      }
      struct.setEq_join_conjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1041.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1042;
          for (int _i1043 = 0; _i1043 < _list1041.size; ++_i1043)
          {
            _elem1042 = new com.starrocks.thrift.TExpr();
            _elem1042.read(iprot);
            struct.other_join_conjuncts.add(_elem1042);
          }
        }
        struct.setOther_join_conjunctsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list1044.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem1045;
          for (int _i1046 = 0; _i1046 < _list1044.size; ++_i1046)
          {
            _elem1045 = new com.starrocks.thrift.TExpr();
            _elem1045.read(iprot);
            struct.partition_exprs.add(_elem1045);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list1047 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list1047.size);
          int _elem1048;
          for (int _i1049 = 0; _i1049 < _list1047.size; ++_i1049)
          {
            _elem1048 = iprot.readI32();
            struct.output_columns.add(_elem1048);
          }
        }
        struct.setOutput_columnsIsSet(true);
      }
