...
public class TOlapTableIndex implements org.apache.thrift.TBase<TOlapTableIndex, TOlapTableIndex._Fields>, java.io.Serializable, Cloneable, Comparable<TOlapTableIndex> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list130.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.common_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map133.size);
                ...
                for (int _i136 = 0; _i136 < _map133.size; ++_i136)
                {
                  ...
                  struct.common_properties.put(_key134, _val135);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.index_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map137.size);
                ...
                for (int _i140 = 0; _i140 < _map137.size; ++_i140)
                {
                  ...
                  struct.index_properties.put(_key138, _val139);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.search_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map141.size);
                ...
                for (int _i144 = 0; _i144 < _map141.size; ++_i144)
                {
                  ...
                  struct.search_properties.put(_key142, _val143);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map145.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key146;
                @org.apache.thrift.annotation.Nullable java.lang.String _val147;
                for (int _i148 = 0; _i148 < _map145.size; ++_i148)
                {
                  _key146 = iprot.readString();
                  _val147 = iprot.readString();
                  struct.extra_properties.put(_key146, _val147);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter149 : struct.columns)
            {
      ...
      if (struct.common_properties != null) {
        if (struct.isSetCommon_properties()) {
          oprot.writeFieldBegin(COMMON_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter150 : struct.common_properties.entrySet())
            {
      ...
      if (struct.index_properties != null) {
        if (struct.isSetIndex_properties()) {
          oprot.writeFieldBegin(INDEX_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter151 : struct.index_properties.entrySet())
            {
      ...
      if (struct.search_properties != null) {
        if (struct.isSetSearch_properties()) {
          oprot.writeFieldBegin(SEARCH_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter152 : struct.search_properties.entrySet())
            {
      ...
      if (struct.extra_properties != null) {
        if (struct.isSetExtra_properties()) {
          oprot.writeFieldBegin(EXTRA_PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter153 : struct.extra_properties.entrySet())
            {
  ...
  private static class TOlapTableIndexTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableIndex> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter154 : struct.columns)
          {
      ...
      if (struct.isSetCommon_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter155 : struct.common_properties.entrySet())
          {
      ...
      if (struct.isSetIndex_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter156 : struct.index_properties.entrySet())
          {
      ...
      if (struct.isSetSearch_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter157 : struct.search_properties.entrySet())
          {
      ...
      if (struct.isSetExtra_properties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter158 : struct.extra_properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableIndex struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list159 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.columns = new java.util.ArrayList<java.lang.String>(_list159.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem160;
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map162 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.common_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map162.size);
          ...
          for (int _i165 = 0; _i165 < _map162.size; ++_i165)
          {
            ...
            struct.common_properties.put(_key163, _val164);
          }
        }
        struct.setCommon_propertiesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.index_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map166.size);
          ...
          for (int _i169 = 0; _i169 < _map166.size; ++_i169)
          {
            ...
            struct.index_properties.put(_key167, _val168);
          }
        }
        struct.setIndex_propertiesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.search_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map170.size);
          ...
          for (int _i173 = 0; _i173 < _map170.size; ++_i173)
          {
            ...
            struct.search_properties.put(_key171, _val172);
          }
        }
        struct.setSearch_propertiesIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.extra_properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map174.size);
          ...
          for (int _i177 = 0; _i177 < _map174.size; ++_i177)
          {
            ...
            struct.extra_properties.put(_key175, _val176);
          }
        }
        struct.setExtra_propertiesIsSet(true);
      }
