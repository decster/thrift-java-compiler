...
public class TIcebergTable implements org.apache.thrift.TBase<TIcebergTable, TIcebergTable._Fields>, java.io.Serializable, Cloneable, Comparable<TIcebergTable> {
  ...
  private static final org.apache.thrift.protocol.TField ICEBERG_EQUAL_DELETE_SCHEMA_FIELD_DESC = new org.apache.thrift.protocol.TField("iceberg_equal_delete_schema", org.apache.thrift.protocol.TType.STRUCT, (short)7);
  ...
  public @org.apache.thrift.annotation.Nullable TIcebergSchema iceberg_equal_delete_schema; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ICEBERG_EQUAL_DELETE_SCHEMA((short)7, "iceberg_equal_delete_schema");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // PARTITIONS
          return PARTITIONS;
        case 7: // ICEBERG_EQUAL_DELETE_SCHEMA
          return ICEBERG_EQUAL_DELETE_SCHEMA;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.LOCATION,_Fields.COLUMNS,_Fields.ICEBERG_SCHEMA,_Fields.PARTITION_COLUMN_NAMES,_Fields.COMPRESSED_PARTITIONS,_Fields.PARTITIONS,_Fields.ICEBERG_EQUAL_DELETE_SCHEMA};
  ...
  static {
    ...
    tmpMap.put(_Fields.ICEBERG_EQUAL_DELETE_SCHEMA, new org.apache.thrift.meta_data.FieldMetaData("iceberg_equal_delete_schema", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TIcebergSchema.class)));
  ...
  public TIcebergTable(TIcebergTable other) {
    ...
    if (other.isSetIceberg_equal_delete_schema()) {
      this.iceberg_equal_delete_schema = new TIcebergSchema(other.iceberg_equal_delete_schema);
    }
  }
  ...
  public void clear() {
    ...
    this.iceberg_equal_delete_schema = null;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TIcebergSchema getIceberg_equal_delete_schema() {
    return this.iceberg_equal_delete_schema;
  }

  public TIcebergTable setIceberg_equal_delete_schema(@org.apache.thrift.annotation.Nullable TIcebergSchema iceberg_equal_delete_schema) {
    this.iceberg_equal_delete_schema = iceberg_equal_delete_schema;
    return this;
  }

  public void unsetIceberg_equal_delete_schema() {
    this.iceberg_equal_delete_schema = null;
  }

  /** Returns true if field iceberg_equal_delete_schema is set (has been assigned a value) and false otherwise */
  public boolean isSetIceberg_equal_delete_schema() {
    return this.iceberg_equal_delete_schema != null;
  }

  public void setIceberg_equal_delete_schemaIsSet(boolean value) {
    if (!value) {
      this.iceberg_equal_delete_schema = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ICEBERG_EQUAL_DELETE_SCHEMA:
      if (value == null) {
        unsetIceberg_equal_delete_schema();
      } else {
        setIceberg_equal_delete_schema((TIcebergSchema)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case ICEBERG_EQUAL_DELETE_SCHEMA:
      return getIceberg_equal_delete_schema();
  ...
  public boolean isSet(_Fields field) {
    ...
    case ICEBERG_EQUAL_DELETE_SCHEMA:
      return isSetIceberg_equal_delete_schema();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TIcebergTable that) {
    ...
    boolean this_present_iceberg_equal_delete_schema = true && this.isSetIceberg_equal_delete_schema();
    boolean that_present_iceberg_equal_delete_schema = true && that.isSetIceberg_equal_delete_schema();
    if (this_present_iceberg_equal_delete_schema || that_present_iceberg_equal_delete_schema) {
      if (!(this_present_iceberg_equal_delete_schema && that_present_iceberg_equal_delete_schema))
        return false;
      if (!this.iceberg_equal_delete_schema.equals(that.iceberg_equal_delete_schema))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIceberg_equal_delete_schema()) ? 131071 : 524287);
    if (isSetIceberg_equal_delete_schema())
      hashCode = hashCode * 8191 + iceberg_equal_delete_schema.hashCode();
  ...
  public int compareTo(TIcebergTable other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIceberg_equal_delete_schema(), other.isSetIceberg_equal_delete_schema());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIceberg_equal_delete_schema()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.iceberg_equal_delete_schema, other.iceberg_equal_delete_schema);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetIceberg_equal_delete_schema()) {
      if (!first) sb.append(", ");
      sb.append("iceberg_equal_delete_schema:");
      if (this.iceberg_equal_delete_schema == null) {
        sb.append("null");
      } else {
        sb.append(this.iceberg_equal_delete_schema);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (iceberg_equal_delete_schema != null) {
      iceberg_equal_delete_schema.validate();
    }
  }
  ...
  private static class TIcebergTableStandardScheme extends org.apache.thrift.scheme.StandardScheme<TIcebergTable> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TIcebergTable struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumn>(_list304.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem305;
                for (int _i306 = 0; _i306 < _list304.size; ++_i306)
                {
                  _elem305 = new TColumn();
                  _elem305.read(iprot);
                  struct.columns.add(_elem305);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_column_names = new java.util.ArrayList<java.lang.String>(_list307.size);
                ...
                for (int _i309 = 0; _i309 < _list307.size; ++_i309)
                {
                  ...
                  struct.partition_column_names.add(_elem308);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partitions = new java.util.HashMap<java.lang.Long,THdfsPartition>(2*_map310.size);
                long _key311;
                @org.apache.thrift.annotation.Nullable THdfsPartition _val312;
                for (int _i313 = 0; _i313 < _map310.size; ++_i313)
                {
                  _key311 = iprot.readI64();
                  _val312 = new THdfsPartition();
                  _val312.read(iprot);
                  struct.partitions.put(_key311, _val312);
                }
                iprot.readMapEnd();
              }
          ...
          case 7: // ICEBERG_EQUAL_DELETE_SCHEMA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.iceberg_equal_delete_schema = new TIcebergSchema();
              struct.iceberg_equal_delete_schema.read(iprot);
              struct.setIceberg_equal_delete_schemaIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TIcebergTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter314 : struct.columns)
            {
      ...
      if (struct.partition_column_names != null) {
        if (struct.isSetPartition_column_names()) {
          oprot.writeFieldBegin(PARTITION_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter315 : struct.partition_column_names)
            {
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter316 : struct.partitions.entrySet())
            {
              oprot.writeI64(_iter316.getKey());
              _iter316.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.iceberg_equal_delete_schema != null) {
        if (struct.isSetIceberg_equal_delete_schema()) {
          oprot.writeFieldBegin(ICEBERG_EQUAL_DELETE_SCHEMA_FIELD_DESC);
          struct.iceberg_equal_delete_schema.write(oprot);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class TIcebergTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIcebergTable> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumn _iter317 : struct.columns)
          {
      ...
      if (struct.isSetPartition_column_names()) {
        {
          ...
          for (java.lang.String _iter318 : struct.partition_column_names)
          {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, THdfsPartition> _iter319 : struct.partitions.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIcebergTable struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partition_column_names = new java.util.ArrayList<java.lang.String>(_list323.size);
          ...
          for (int _i325 = 0; _i325 < _list323.size; ++_i325)
          {
            ...
            struct.partition_column_names.add(_elem324);
          }
        }
        struct.setPartition_column_namesIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map326 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
