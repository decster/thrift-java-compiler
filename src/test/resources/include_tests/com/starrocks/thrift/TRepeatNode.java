        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slot_id_set_list = new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list520.size);
                @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> _elem521;
                for (int _i522 = 0; _i522 < _list520.size; ++_i522)
                {
                  {
                    org.apache.thrift.protocol.TSet _set523 = iprot.readSetBegin();
                    _elem521 = new java.util.HashSet<java.lang.Integer>(2*_set523.size);
                    int _elem524;
                    for (int _i525 = 0; _i525 < _set523.size; ++_i525)
                    {
                      _elem524 = iprot.readI32();
                      _elem521.add(_elem524);
                    }
                    iprot.readSetEnd();
                  }
                  struct.slot_id_set_list.add(_elem521);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.repeat_id_list = new java.util.ArrayList<java.lang.Long>(_list526.size);
                long _elem527;
                for (int _i528 = 0; _i528 < _list526.size; ++_i528)
                {
                  _elem527 = iprot.readI64();
                  struct.repeat_id_list.add(_elem527);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_list = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list529.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem530;
                for (int _i531 = 0; _i531 < _list529.size; ++_i531)
                {
                  {
                    org.apache.thrift.protocol.TList _list532 = iprot.readListBegin();
                    _elem530 = new java.util.ArrayList<java.lang.Long>(_list532.size);
                    long _elem533;
                    for (int _i534 = 0; _i534 < _list532.size; ++_i534)
                    {
                      _elem533 = iprot.readI64();
                      _elem530.add(_elem533);
                    }
                    iprot.readListEnd();
                  }
                  struct.grouping_list.add(_elem530);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // ALL_SLOT_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set535 = iprot.readSetBegin();
                struct.all_slot_ids = new java.util.HashSet<java.lang.Integer>(2*_set535.size);
                int _elem536;
                for (int _i537 = 0; _i537 < _set535.size; ++_i537)
                {
                  _elem536 = iprot.readI32();
                  struct.all_slot_ids.add(_elem536);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.slot_id_set_list != null) {
        oprot.writeFieldBegin(SLOT_ID_SET_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Set<java.lang.Integer> _iter538 : struct.slot_id_set_list)
          {
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, _iter538.size()));
      ...
      if (struct.repeat_id_list != null) {
        oprot.writeFieldBegin(REPEAT_ID_LIST_FIELD_DESC);
        {
          ...
          for (long _iter540 : struct.repeat_id_list)
          {
      ...
      if (struct.grouping_list != null) {
        oprot.writeFieldBegin(GROUPING_LIST_FIELD_DESC);
        {
          ...
          for (java.util.List<java.lang.Long> _iter541 : struct.grouping_list)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter541.size()));
              for (long _iter542 : _iter541)
              {
      ...
      if (struct.all_slot_ids != null) {
        oprot.writeFieldBegin(ALL_SLOT_IDS_FIELD_DESC);
        {
          ...
          for (int _iter543 : struct.all_slot_ids)
          {
  ...
  private static class TRepeatNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRepeatNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.output_tuple_id);
      {
        ...
        for (java.util.Set<java.lang.Integer> _iter544 : struct.slot_id_set_list)
        {
          {
            oprot.writeI32(_iter544.size());
            for (int _iter545 : _iter544)
            {
              oprot.writeI32(_iter545);
            }
          }
        }
      }
      {
        ...
        for (long _iter546 : struct.repeat_id_list)
        {
      ...
      }
      {
        ...
        for (java.util.List<java.lang.Long> _iter547 : struct.grouping_list)
        {
          {
            oprot.writeI32(_iter547.size());
            for (long _iter548 : _iter547)
            {
      ...
      }
      {
        ...
        for (int _iter549 : struct.all_slot_ids)
        {
          oprot.writeI32(_iter549);
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      struct.setOutput_tuple_idIsSet(true);
      {
        org.apache.thrift.protocol.TList _list550 = iprot.readListBegin(org.apache.thrift.protocol.TType.SET);
        struct.slot_id_set_list = new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list550.size);
        @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> _elem551;
        for (int _i552 = 0; _i552 < _list550.size; ++_i552)
        {
          {
            org.apache.thrift.protocol.TSet _set553 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
            _elem551 = new java.util.HashSet<java.lang.Integer>(2*_set553.size);
            int _elem554;
            for (int _i555 = 0; _i555 < _set553.size; ++_i555)
            {
              _elem554 = iprot.readI32();
              _elem551.add(_elem554);
            }
          }
          struct.slot_id_set_list.add(_elem551);
        }
      }
      struct.setSlot_id_set_listIsSet(true);
      {
        org.apache.thrift.protocol.TList _list556 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
        struct.repeat_id_list = new java.util.ArrayList<java.lang.Long>(_list556.size);
        long _elem557;
        for (int _i558 = 0; _i558 < _list556.size; ++_i558)
        {
          _elem557 = iprot.readI64();
          struct.repeat_id_list.add(_elem557);
        }
      }
      struct.setRepeat_id_listIsSet(true);
      {
        org.apache.thrift.protocol.TList _list559 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.grouping_list = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list559.size);
        @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem560;
        for (int _i561 = 0; _i561 < _list559.size; ++_i561)
        {
          {
            org.apache.thrift.protocol.TList _list562 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
            _elem560 = new java.util.ArrayList<java.lang.Long>(_list562.size);
            long _elem563;
          ...
          struct.grouping_list.add(_elem560);
        }
      }
      struct.setGrouping_listIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set565 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
        struct.all_slot_ids = new java.util.HashSet<java.lang.Integer>(2*_set565.size);
        int _elem566;
        for (int _i567 = 0; _i567 < _set565.size; ++_i567)
        {
          _elem566 = iprot.readI32();
          struct.all_slot_ids.add(_elem566);
        }
      }
      struct.setAll_slot_idsIsSet(true);
    }
