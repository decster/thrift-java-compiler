...
public class TImmutablePartitionRequest implements org.apache.thrift.TBase<TImmutablePartitionRequest, TImmutablePartitionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TImmutablePartitionRequest> {
  ...
  private static final org.apache.thrift.protocol.TField BACKEND_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("backend_id", org.apache.thrift.protocol.TType.I64, (short)101);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BACKEND_ID((short)101, "backend_id");
  ...
  private static final _Fields optionals[] = {_Fields.TXN_ID,_Fields.DB_ID,_Fields.TABLE_ID,_Fields.PARTITION_IDS,_Fields.BACKEND_ID};
  ...
  public TImmutablePartitionRequest setBackend_id(long backend_id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_ids = new java.util.ArrayList<java.lang.Long>(_list648.size);
                long _elem649;
                for (int _i650 = 0; _i650 < _list648.size; ++_i650)
                {
                  _elem649 = iprot.readI64();
                  struct.partition_ids.add(_elem649);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partition_ids != null) {
        if (struct.isSetPartition_ids()) {
          oprot.writeFieldBegin(PARTITION_IDS_FIELD_DESC);
          {
            ...
            for (long _iter651 : struct.partition_ids)
            {
      ...
      if (struct.isSetPartition_ids()) {
        {
          ...
          for (long _iter652 : struct.partition_ids)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partition_ids = new java.util.ArrayList<java.lang.Long>(_list653.size);
          long _elem654;
          for (int _i655 = 0; _i655 < _list653.size; ++_i655)
          {
            _elem654 = iprot.readI64();
            struct.partition_ids.add(_elem654);
          }
        }
        struct.setPartition_idsIsSet(true);
      }
