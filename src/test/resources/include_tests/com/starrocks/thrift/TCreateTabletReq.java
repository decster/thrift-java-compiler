...
public class TCreateTabletReq implements org.apache.thrift.TBase<TCreateTabletReq, TCreateTabletReq._Fields>, java.io.Serializable, Cloneable, Comparable<TCreateTabletReq> {
  ...
  private static final org.apache.thrift.protocol.TField COMPRESSION_LEVEL_FIELD_DESC = new org.apache.thrift.protocol.TField("compression_level", org.apache.thrift.protocol.TType.I32, (short)21);
  private static final org.apache.thrift.protocol.TField ENABLE_TABLET_CREATION_OPTIMIZATION_FIELD_DESC = new org.apache.thrift.protocol.TField("enable_tablet_creation_optimization", org.apache.thrift.protocol.TType.BOOL, (short)22);
  private static final org.apache.thrift.protocol.TField TIMEOUT_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("timeout_ms", org.apache.thrift.protocol.TType.I64, (short)23);
  private static final org.apache.thrift.protocol.TField GTID_FIELD_DESC = new org.apache.thrift.protocol.TField("gtid", org.apache.thrift.protocol.TType.I64, (short)24);
  private static final org.apache.thrift.protocol.TField FLAT_JSON_CONFIG_FIELD_DESC = new org.apache.thrift.protocol.TField("flat_json_config", org.apache.thrift.protocol.TType.STRUCT, (short)25);
  ...
  public boolean enable_tablet_creation_optimization; // optional
  public long timeout_ms; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COMPRESSION_LEVEL((short)21, "compression_level"),
    ENABLE_TABLET_CREATION_OPTIMIZATION((short)22, "enable_tablet_creation_optimization"),
    TIMEOUT_MS((short)23, "timeout_ms"),
    GTID((short)24, "gtid"),
    FLAT_JSON_CONFIG((short)25, "flat_json_config");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 21: // COMPRESSION_LEVEL
          return COMPRESSION_LEVEL;
        case 22: // ENABLE_TABLET_CREATION_OPTIMIZATION
          return ENABLE_TABLET_CREATION_OPTIMIZATION;
        case 23: // TIMEOUT_MS
          return TIMEOUT_MS;
        case 24: // GTID
          return GTID;
        case 25: // FLAT_JSON_CONFIG
  ...
  private static final int __COMPRESSION_LEVEL_ISSET_ID = 13;
  private static final int __ENABLE_TABLET_CREATION_OPTIMIZATION_ISSET_ID = 14;
  private static final int __TIMEOUT_MS_ISSET_ID = 15;
  private static final int __GTID_ISSET_ID = 16;
  private int __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.VERSION_HASH,_Fields.STORAGE_MEDIUM,_Fields.IN_RESTORE_MODE,_Fields.BASE_TABLET_ID,_Fields.BASE_SCHEMA_HASH,_Fields.TABLE_ID,_Fields.PARTITION_ID,_Fields.ALLOCATION_TERM,_Fields.IS_ECO_MODE,_Fields.STORAGE_FORMAT,_Fields.TABLET_TYPE,_Fields.ENABLE_PERSISTENT_INDEX,_Fields.COMPRESSION_TYPE,_Fields.BINLOG_CONFIG,_Fields.PERSISTENT_INDEX_TYPE,_Fields.PRIMARY_INDEX_CACHE_EXPIRE_SEC,_Fields.CREATE_SCHEMA_FILE,_Fields.COMPRESSION_LEVEL,_Fields.ENABLE_TABLET_CREATION_OPTIMIZATION,_Fields.TIMEOUT_MS,_Fields.GTID,_Fields.FLAT_JSON_CONFIG};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMPRESSION_LEVEL, new org.apache.thrift.meta_data.FieldMetaData("compression_level", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ENABLE_TABLET_CREATION_OPTIMIZATION, new org.apache.thrift.meta_data.FieldMetaData("enable_tablet_creation_optimization", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.TIMEOUT_MS, new org.apache.thrift.meta_data.FieldMetaData("timeout_ms", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
  ...
  public TCreateTabletReq() {
    ...
    this.enable_tablet_creation_optimization = false;
  ...
  public TCreateTabletReq(TCreateTabletReq other) {
    ...
    this.enable_tablet_creation_optimization = other.enable_tablet_creation_optimization;
  ...
  public TCreateTabletReq setCompression_level(int compression_level) {
  ...
  public boolean isEnable_tablet_creation_optimization() {
    return this.enable_tablet_creation_optimization;
  }

  public TCreateTabletReq setEnable_tablet_creation_optimization(boolean enable_tablet_creation_optimization) {
    this.enable_tablet_creation_optimization = enable_tablet_creation_optimization;
    setEnable_tablet_creation_optimizationIsSet(true);
    return this;
  }

  public void unsetEnable_tablet_creation_optimization() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ENABLE_TABLET_CREATION_OPTIMIZATION_ISSET_ID);
  }

  /** Returns true if field enable_tablet_creation_optimization is set (has been assigned a value) and false otherwise */
  public boolean isSetEnable_tablet_creation_optimization() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ENABLE_TABLET_CREATION_OPTIMIZATION_ISSET_ID);
  }

  public void setEnable_tablet_creation_optimizationIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ENABLE_TABLET_CREATION_OPTIMIZATION_ISSET_ID, value);
  }
  ...
  public TCreateTabletReq setTimeout_ms(long timeout_ms) {
  ...
  public void unsetTimeout_ms() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __TIMEOUT_MS_ISSET_ID);
  }

  /** Returns true if field timeout_ms is set (has been assigned a value) and false otherwise */
  public boolean isSetTimeout_ms() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __TIMEOUT_MS_ISSET_ID);
  }

  public void setTimeout_msIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __TIMEOUT_MS_ISSET_ID, value);
  }
  ...
  public TCreateTabletReq setGtid(long gtid) {
    this.gtid = gtid;
    setGtidIsSet(true);
    return this;
  }
  ...
  public TCreateTabletReq setFlat_json_config(@org.apache.thrift.annotation.Nullable TFlatJsonConfig flat_json_config) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ENABLE_TABLET_CREATION_OPTIMIZATION:
      if (value == null) {
        unsetEnable_tablet_creation_optimization();
      } else {
        setEnable_tablet_creation_optimization((java.lang.Boolean)value);
      }
      break;
    ...
    case TIMEOUT_MS:
      if (value == null) {
        ...
        setTimeout_ms((java.lang.Long)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case ENABLE_TABLET_CREATION_OPTIMIZATION:
      return isEnable_tablet_creation_optimization();
  ...
  public boolean isSet(_Fields field) {
    ...
    case ENABLE_TABLET_CREATION_OPTIMIZATION:
      return isSetEnable_tablet_creation_optimization();
    case TIMEOUT_MS:
  ...
  public boolean equals(TCreateTabletReq that) {
    ...
    boolean this_present_enable_tablet_creation_optimization = true && this.isSetEnable_tablet_creation_optimization();
    boolean that_present_enable_tablet_creation_optimization = true && that.isSetEnable_tablet_creation_optimization();
    if (this_present_enable_tablet_creation_optimization || that_present_enable_tablet_creation_optimization) {
      if (!(this_present_enable_tablet_creation_optimization && that_present_enable_tablet_creation_optimization))
        return false;
      if (this.enable_tablet_creation_optimization != that.enable_tablet_creation_optimization)
        return false;
    }

    boolean this_present_timeout_ms = true && this.isSetTimeout_ms();
    boolean that_present_timeout_ms = true && that.isSetTimeout_ms();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCompression_level()) ? 131071 : 524287);
    if (isSetCompression_level())
      hashCode = hashCode * 8191 + compression_level;

    hashCode = hashCode * 8191 + ((isSetEnable_tablet_creation_optimization()) ? 131071 : 524287);
    if (isSetEnable_tablet_creation_optimization())
      hashCode = hashCode * 8191 + ((enable_tablet_creation_optimization) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((isSetTimeout_ms()) ? 131071 : 524287);
    if (isSetTimeout_ms())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(timeout_ms);
  ...
  public int compareTo(TCreateTabletReq other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCompression_level(), other.isSetCompression_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompression_level()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEnable_tablet_creation_optimization(), other.isSetEnable_tablet_creation_optimization());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnable_tablet_creation_optimization()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.enable_tablet_creation_optimization, other.enable_tablet_creation_optimization);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.compare(isSetTimeout_ms(), other.isSetTimeout_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimeout_ms()) {
  ...
  public java.lang.String toString() {
    ...
    if (isSetEnable_tablet_creation_optimization()) {
      if (!first) sb.append(", ");
      sb.append("enable_tablet_creation_optimization:");
      sb.append(this.enable_tablet_creation_optimization);
      first = false;
    }
    if (isSetTimeout_ms()) {
      if (!first) sb.append(", ");
  ...
  private static class TCreateTabletReqStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCreateTabletReq> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCreateTabletReq struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 22: // ENABLE_TABLET_CREATION_OPTIMIZATION
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.enable_tablet_creation_optimization = iprot.readBool();
              struct.setEnable_tablet_creation_optimizationIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 23: // TIMEOUT_MS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.timeout_ms = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCreateTabletReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEnable_tablet_creation_optimization()) {
        oprot.writeFieldBegin(ENABLE_TABLET_CREATION_OPTIMIZATION_FIELD_DESC);
        oprot.writeBool(struct.enable_tablet_creation_optimization);
        oprot.writeFieldEnd();
      }
      if (struct.isSetTimeout_ms()) {
        oprot.writeFieldBegin(TIMEOUT_MS_FIELD_DESC);
        oprot.writeI64(struct.timeout_ms);
        oprot.writeFieldEnd();
      }
      if (struct.isSetGtid()) {
