...
public class TMergeJoinNode implements org.apache.thrift.TBase<TMergeJoinNode, TMergeJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TMergeJoinNode> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list440.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem441;
                for (int _i442 = 0; _i442 < _list440.size; ++_i442)
                {
                  _elem441 = new TEqJoinCondition();
                  _elem441.read(iprot);
                  struct.eq_join_conjuncts.add(_elem441);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list443.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem444;
                for (int _i445 = 0; _i445 < _list443.size; ++_i445)
                {
                  _elem444 = new com.starrocks.thrift.TExpr();
                  _elem444.read(iprot);
                  struct.other_join_conjuncts.add(_elem444);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list446.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem447;
                for (int _i448 = 0; _i448 < _list446.size; ++_i448)
                {
                  _elem447 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem447.read(iprot);
                  struct.build_runtime_filters.add(_elem447);
                }
                iprot.readListEnd();
              }
          ...
          case 53: // PARTITION_EXPRS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list449 = iprot.readListBegin();
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list449.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem450;
                for (int _i451 = 0; _i451 < _list449.size; ++_i451)
                {
                  _elem450 = new com.starrocks.thrift.TExpr();
                  _elem450.read(iprot);
                  struct.partition_exprs.add(_elem450);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list452.size);
                int _elem453;
                for (int _i454 = 0; _i454 < _list452.size; ++_i454)
                {
                  _elem453 = iprot.readI32();
                  struct.output_columns.add(_elem453);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.eq_join_conjuncts != null) {
        if (struct.isSetEq_join_conjuncts()) {
          oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (TEqJoinCondition _iter455 : struct.eq_join_conjuncts)
            {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter456 : struct.other_join_conjuncts)
            {
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter457 : struct.build_runtime_filters)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter458 : struct.partition_exprs)
            {
      ...
      if (struct.output_columns != null) {
        if (struct.isSetOutput_columns()) {
          oprot.writeFieldBegin(OUTPUT_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter459 : struct.output_columns)
            {
  ...
  private static class TMergeJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMergeJoinNode> {
      ...
      if (struct.isSetEq_join_conjuncts()) {
        {
          ...
          for (TEqJoinCondition _iter460 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter461 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter462 : struct.build_runtime_filters)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter463 : struct.partition_exprs)
          {
      ...
      if (struct.isSetOutput_columns()) {
        {
          ...
          for (int _iter464 : struct.output_columns)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMergeJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list465.size);
          @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem466;
          for (int _i467 = 0; _i467 < _list465.size; ++_i467)
          {
            _elem466 = new TEqJoinCondition();
            _elem466.read(iprot);
            struct.eq_join_conjuncts.add(_elem466);
          }
        }
        struct.setEq_join_conjunctsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list468 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list468.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem469;
          for (int _i470 = 0; _i470 < _list468.size; ++_i470)
          {
            _elem469 = new com.starrocks.thrift.TExpr();
            _elem469.read(iprot);
            struct.other_join_conjuncts.add(_elem469);
          }
        }
        struct.setOther_join_conjunctsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list471.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem472;
          for (int _i473 = 0; _i473 < _list471.size; ++_i473)
          {
            _elem472 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem472.read(iprot);
            struct.build_runtime_filters.add(_elem472);
          }
        }
        struct.setBuild_runtime_filtersIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list474.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem475;
          for (int _i476 = 0; _i476 < _list474.size; ++_i476)
          {
            _elem475 = new com.starrocks.thrift.TExpr();
            _elem475.read(iprot);
            struct.partition_exprs.add(_elem475);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list477 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list477.size);
          int _elem478;
          for (int _i479 = 0; _i479 < _list477.size; ++_i479)
          {
            _elem478 = iprot.readI32();
            struct.output_columns.add(_elem478);
          }
        }
        struct.setOutput_columnsIsSet(true);
      }
