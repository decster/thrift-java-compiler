...
public class TStruct extends TType {
    ...
    public boolean isMethodXcepts() {
        return isMethodXcepts;
    }

    public void setMethodXcepts(boolean methodXcepts) {
        isMethodXcepts = methodXcepts;
    }

    public List<TField> getMembers() {
        return members;
    }
