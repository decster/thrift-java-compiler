...
public class TType extends TDoc {
  ...
  public void setProgram(TProgram program) { this.program = program; }
  ...
  public boolean isUUID() { return false; }
  ...
  public boolean isXception() { return false; }

  public TType getTrueType() { return this; }
