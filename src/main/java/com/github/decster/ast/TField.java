...
public class TField extends TDoc {
    ...
    public void setStruct(TStruct struct) {
        this.struct = struct;
    }
    ...
    public boolean isXsdOptional() {
        return xsdOptional;
    }

    public void setXsdOptional(boolean xsdOptional) {
        this.xsdOptional = xsdOptional;
    }

    public boolean isXsdNillable() {
        return xsdNillable;
    }

    public void setXsdNillable(boolean xsdNillable) {
        this.xsdNillable = xsdNillable;
    }

    public TStruct getXsdAttrs() {
        return xsdAttrs;
    }

    public void setXsdAttrs(TStruct xsdAttrs) {
        this.xsdAttrs = xsdAttrs;
    }
    ...
    public boolean isRequired() {
        return req == Requirement.REQUIRED;
    }
