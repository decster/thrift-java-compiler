...
public class JavaGeneratorOptions {
    ...
    private String optionType = null;        // Wrap optional fields in Option class (null=none, "java.util.Optional", "org.apache.thrift.Option")
    ...
    public void setAndroidStyle(boolean androidStyle) {
    ...
    public boolean isFutureIface() {
        return futureIface;
    }

    public void setFutureIface(boolean futureIface) {
        this.futureIface = futureIface;
    }

    public boolean isUndatedGeneratedAnnotations() {
        return undatedGeneratedAnnotations;
    }
    ...
    public boolean isSuppressGeneratedAnnotations() {
        return suppressGeneratedAnnotations;
    }
    ...
    public boolean isRethrowUnhandledExceptions() {
        return rethrowUnhandledExceptions;
    }
    ...
    public boolean isUnsafeBinaries() {
        return unsafeBinaries;
    }

    public void setUnsafeBinaries(boolean unsafeBinaries) {
        this.unsafeBinaries = unsafeBinaries;
    }
    ...
    public boolean isJakartaAnnotations() {
        return jakartaAnnotations;
    }
    ...
    public boolean isAnnotationsAsMetadata() {
        return annotationsAsMetadata;
    }
