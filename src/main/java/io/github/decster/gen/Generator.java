...
import io.github.decster.ast.TType;
...
public class Generator {
  ...
  protected String autogen_summary() { return "Autogenerated by Thrift Compiler (" + THRIFT_VERSION + ")"; }
   ...
   */
  protected void indent_up() { indent_level++; }

  /**
   * Decreases the indentation level.
   */
  protected void indent_down() { indent_level--; }
  ...
  protected TType getTrueType(TType type) { return type.getTrueType(); }
}
